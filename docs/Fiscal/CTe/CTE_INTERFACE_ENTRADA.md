...
| `F07` | Redespacho intermediario | Remetente da operacao originaria | Transportador anterior ou intermediario que entrega a carga para o trecho documentado | Transportador intermediario, transportador seguinte ou recebedor fisico do trecho | Destinatario da operacao originaria | Transportador intermediario que contrata o trecho seguinte, conforme a cadeia documentada | Existe mais de uma camada de contratacao entre o transportador inicial e quem executa o trecho. Cada CT-e deve identificar o seu tomador, expedidor, recebedor e documentos anteriores sem substituir os participantes da operacao originaria. |
