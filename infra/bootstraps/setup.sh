...
NGINX_CONF_DIR="$APP_DIR/infra/Clinica/DockerCompose/nginx/conf.d"
...
alias ycd='cd ~/YeshuaCreator/infra/Clinica/DockerCompose'
alias yps='docker compose -f ~/YeshuaCreator/infra/Clinica/DockerCompose/docker-compose.yml ps'
alias ylogsfull='docker compose -f ~/YeshuaCreator/infra/Clinica/DockerCompose/docker-compose.yml logs -f'
alias ylogs='docker compose -f ~/YeshuaCreator/infra/Clinica/DockerCompose/docker-compose.yml logs --tail=100 -f --timestamps'

alias yup='docker compose -f ~/YeshuaCreator/infra/Clinica/DockerCompose/docker-compose.yml up -d'
alias ydown='docker compose -f ~/YeshuaCreator/infra/Clinica/DockerCompose/docker-compose.yml down'
