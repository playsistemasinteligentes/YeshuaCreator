...
namespace Yeshua.Clinica.CQRS.Tests.Integration.Api.Smoke.Migration.Clinica;

[SmokeTestOrder(1)]
public partial class ClinicaCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("Clinica", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("Clinica", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("Clinica", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("Clinica", out var deletePayload))
            return;
