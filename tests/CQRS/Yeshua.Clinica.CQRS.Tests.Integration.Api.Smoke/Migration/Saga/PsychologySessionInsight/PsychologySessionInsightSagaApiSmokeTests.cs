...
public partial class PsychologySessionInsightSagaApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string ExpectedSagaType = "PsychologySessionInsightSaga";
    private static readonly string[] ExpectedStepKeys =
    {
        "AudioTranscriptRequested",
        "ReportEndProntuaryRequested",
    };

    [IntegrationFact]
    public async Task PsychologySessionInsight_saga_should_run_with_real_api_and_infrastructure()
    {
