...
namespace Yeshua.Fiscal.CQRS.Tests.Integration.Api.Smoke.Migration.SefazEndpoint;

[SmokeTestOrder(19)]
public partial class SefazEndpointCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/SefazEndpoint/DeleteSefazEndpoint";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("SefazEndpoint", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("SefazEndpoint", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("SefazEndpoint", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("SefazEndpoint", out var deletePayload))
            return;
