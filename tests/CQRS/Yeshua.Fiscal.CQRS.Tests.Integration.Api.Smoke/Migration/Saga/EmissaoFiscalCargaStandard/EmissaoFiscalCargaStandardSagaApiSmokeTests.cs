...
public partial class EmissaoFiscalCargaStandardSagaApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string ExpectedSagaType = "EmissaoFiscalCargaStandardSaga";
    ...
    [IntegrationFact]
    public async Task EmissaoFiscalCargaStandard_saga_should_run_with_real_api_and_infrastructure()
    {
