...
public partial class TesteSyncSagaApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string ExpectedSagaType = "TesteSyncSaga";
    ...
    [IntegrationFact]
    public async Task TesteSync_saga_should_run_with_real_api_and_infrastructure()
    {
