...
public partial class ContingenciaFiscalStandardSagaApiSmokeTests : ApiIntegrationTestBase
{
    ...
    [IntegrationFact]
    public async Task ContingenciaFiscalStandard_saga_should_run_with_real_api_and_infrastructure()
    {
