...
namespace Yeshua.Fiscal.MDFe.CQRS.Tests.Integration.Api.Seed.Migration.yPerfilGrant;
...
public partial class yPerfilGrantCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("yPerfilGrant", createdId);
    ...
    private static JsonObject BuildCreatePayload()
    {
        ...
        {
            ["PerfilId"] = ApiSeedTestContext.GetRequiredCreatedId("yPerfil", "PerfilId"),
            ["GrantId"] = ApiSeedTestContext.GetRequiredCreatedId("yGrant", "GrantId"),
            ["CanGrant"] = false,
            ["CanCreate"] = false,
            ["CanRead"] = false,
            ["CanUpdate"] = false,
    ...
    private static JsonObject BuildUpdatePayload(JsonObject createPayload, JsonNode id)
    {
        ...
        payload["PerfilId"] = ApiSeedTestContext.GetRequiredCreatedId("yPerfil", "PerfilId");
        payload["GrantId"] = ApiSeedTestContext.GetRequiredCreatedId("yGrant", "GrantId");
