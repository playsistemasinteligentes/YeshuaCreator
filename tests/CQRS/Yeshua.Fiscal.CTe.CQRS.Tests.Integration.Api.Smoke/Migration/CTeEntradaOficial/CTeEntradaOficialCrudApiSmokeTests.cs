...
namespace Yeshua.Fiscal.CTe.CQRS.Tests.Integration.Api.Smoke.Migration.CTeEntradaOficial;

[SmokeTestOrder(1)]
public partial class CTeEntradaOficialCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/CTeEntradaOficial/DeleteCTeEntradaOficial";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("CTeEntradaOficial", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("CTeEntradaOficial", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("CTeEntradaOficial", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("CTeEntradaOficial", out var deletePayload))
            return;
