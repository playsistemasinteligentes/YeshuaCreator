...
namespace Yeshua.Fiscal.MDFe.CQRS.Tests.Integration.Api.Smoke.Migration.MDFe;

[SmokeTestOrder(1)]
public partial class MDFeCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/MDFe/DeleteMDFe";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("MDFe", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("MDFe", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("MDFe", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("MDFe", out var deletePayload))
            return;
