...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.FilaProducao;

[SmokeTestOrder(170)]
public partial class FilaProducaoCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/FilaProducao/DeleteFilaProducao";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("FilaProducao", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("FilaProducao", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("FilaProducao", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("FilaProducao", out var deletePayload))
            return;
