...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.MedidasTeste;

[SmokeTestOrder(47)]
public partial class MedidasTesteCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/MedidasTeste/DeleteMedidasTeste";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("MedidasTeste", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("MedidasTeste", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("MedidasTeste", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("MedidasTeste", out var deletePayload))
            return;
