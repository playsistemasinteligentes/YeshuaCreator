...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.Order;

[SmokeTestOrder(156)]
public partial class OrderCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/Order/DeleteOrder";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("Order", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("Order", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("Order", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("Order", out var deletePayload))
            return;

        using var client = await CreateAuthenticatedClientAsync();
        using var deleteResponse = await client.SendJsonAsync(HttpMethod.Delete, DeleteEndpoint, deletePayload, JsonOptions);
        var deleteState = await ApiResponseAssertions.ReadSuccessStateAsync(deleteResponse);
        var deletedId = ApiJson.GetRequiredProperty(deleteState, "data", "ord_id");
        var expectedId = ApiJson.GetRequiredProperty(deletePayload, "ORD_ID");
    ...
    private static JsonObject BuildCreatePayload()
    {
        return new JsonObject
        {
            ...
            ["ORD_REGIAO_ENTREGA"] = ApiSmokeTestContext.GetRequiredCreatedId("PontosMapa", "ORD_REGIAO_ENTREGA"),
            ["ORD_LARGURA"] = 10.5m,
            ...
            ["OCO_ID_CANCELAMENTO"] = ApiSmokeTestContext.GetRequiredCreatedId("Ocorrencia", "OCO_ID_CANCELAMENTO"),
    ...
    private static JsonObject BuildUpdatePayload(JsonObject createPayload, JsonNode id)
    {
        ...
        payload["ORD_REGIAO_ENTREGA"] = ApiSmokeTestContext.GetRequiredCreatedId("PontosMapa", "ORD_REGIAO_ENTREGA");
        ...
        payload["OCO_ID_CANCELAMENTO"] = ApiSmokeTestContext.GetRequiredCreatedId("Ocorrencia", "OCO_ID_CANCELAMENTO");
