...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.MovimentoEstoque;

[SmokeTestOrder(178)]
public partial class MovimentoEstoqueCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/MovimentoEstoque/DeleteMovimentoEstoque";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("MovimentoEstoque", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("MovimentoEstoque", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("MovimentoEstoque", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("MovimentoEstoque", out var deletePayload))
            return;
    ...
    private static JsonObject BuildCreatePayload()
    {
        return new JsonObject
        {
            ...
            ["OrderId"] = ApiSmokeTestContext.GetRequiredCreatedId("Order", "OrderId"),
            ["Tipo"] = ApiSmokeTestContext.GetRequiredCreatedId("TipoMovimentoEstoque", "Tipo"),
    ...
    private static JsonObject BuildUpdatePayload(JsonObject createPayload, JsonNode id)
    {
        ...
        payload["OrderId"] = ApiSmokeTestContext.GetRequiredCreatedId("Order", "OrderId");
        payload["Tipo"] = ApiSmokeTestContext.GetRequiredCreatedId("TipoMovimentoEstoque", "Tipo");
