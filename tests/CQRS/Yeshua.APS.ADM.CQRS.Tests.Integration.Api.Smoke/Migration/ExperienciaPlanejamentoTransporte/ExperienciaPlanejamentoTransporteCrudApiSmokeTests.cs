...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.ExperienciaPlanejamentoTransporte;

[SmokeTestOrder(121)]
public partial class ExperienciaPlanejamentoTransporteCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/ExperienciaPlanejamentoTransporte/DeleteExperienciaPlanejamentoTransporte";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("ExperienciaPlanejamentoTransporte", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("ExperienciaPlanejamentoTransporte", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("ExperienciaPlanejamentoTransporte", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("ExperienciaPlanejamentoTransporte", out var deletePayload))
            return;
