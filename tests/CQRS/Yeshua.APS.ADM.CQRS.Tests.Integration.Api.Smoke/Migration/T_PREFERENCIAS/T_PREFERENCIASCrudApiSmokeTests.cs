...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.T_PREFERENCIAS;

[SmokeTestOrder(66)]
public partial class T_PREFERENCIASCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/T_PREFERENCIAS/DeleteT_PREFERENCIAS";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("T_PREFERENCIAS", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("T_PREFERENCIAS", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("T_PREFERENCIAS", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("T_PREFERENCIAS", out var deletePayload))
            return;
