...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.FilaProducaoPrevista;

[SmokeTestOrder(27)]
public partial class FilaProducaoPrevistaCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/FilaProducaoPrevista/DeleteFilaProducaoPrevista";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("FilaProducaoPrevista", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("FilaProducaoPrevista", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("FilaProducaoPrevista", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("FilaProducaoPrevista", out var deletePayload))
            return;
