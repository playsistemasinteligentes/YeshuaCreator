...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.RestricoesDeRodagem;

[SmokeTestOrder(72)]
public partial class RestricoesDeRodagemCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/RestricoesDeRodagem/DeleteRestricoesDeRodagem";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("RestricoesDeRodagem", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("RestricoesDeRodagem", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("RestricoesDeRodagem", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("RestricoesDeRodagem", out var deletePayload))
            return;
