...
public partial class ItenCargaCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/ItenCarga/DeleteItenCarga";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("ItenCarga", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("ItenCarga", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("ItenCarga", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("ItenCarga", out var deletePayload))
            return;
