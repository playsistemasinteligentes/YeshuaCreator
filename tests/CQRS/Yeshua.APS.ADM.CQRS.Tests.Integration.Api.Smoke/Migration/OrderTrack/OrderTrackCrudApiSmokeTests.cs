...
public partial class OrderTrackCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/OrderTrack/DeleteOrderTrack";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("OrderTrack", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("OrderTrack", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("OrderTrack", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("OrderTrack", out var deletePayload))
            return;
