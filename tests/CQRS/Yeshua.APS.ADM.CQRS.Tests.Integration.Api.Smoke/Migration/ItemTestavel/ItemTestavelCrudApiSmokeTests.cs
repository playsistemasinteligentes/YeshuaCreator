...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.ItemTestavel;

[SmokeTestOrder(34)]
public partial class ItemTestavelCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/ItemTestavel/DeleteItemTestavel";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("ItemTestavel", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("ItemTestavel", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("ItemTestavel", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("ItemTestavel", out var deletePayload))
            return;
