...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.CondicaoPagamento;

[SmokeTestOrder(12)]
public partial class CondicaoPagamentoCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/CondicaoPagamento/DeleteCondicaoPagamento";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("CondicaoPagamento", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("CondicaoPagamento", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("CondicaoPagamento", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("CondicaoPagamento", out var deletePayload))
            return;
