...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.RotaPontosMapa;

[SmokeTestOrder(77)]
public partial class RotaPontosMapaCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/RotaPontosMapa/DeleteRotaPontosMapa";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("RotaPontosMapa", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("RotaPontosMapa", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("RotaPontosMapa", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("RotaPontosMapa", out var deletePayload))
            return;
    ...
    private static JsonObject BuildCreatePayload()
    {
        return new JsonObject
        {
            ...
            ["PON_ID_DESTINO"] = ApiSmokeTestContext.GetRequiredCreatedId("PontosMapa", "PON_ID_DESTINO"),
    ...
    private static JsonObject BuildUpdatePayload(JsonObject createPayload, JsonNode id)
    {
        ...
        payload["PON_ID_DESTINO"] = ApiSmokeTestContext.GetRequiredCreatedId("PontosMapa", "PON_ID_DESTINO");
