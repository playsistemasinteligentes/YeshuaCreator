...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.CorridasOnduladeiraEstudo;

[SmokeTestOrder(19)]
public partial class CorridasOnduladeiraEstudoCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/CorridasOnduladeiraEstudo/DeleteCorridasOnduladeiraEstudo";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("CorridasOnduladeiraEstudo", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("CorridasOnduladeiraEstudo", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("CorridasOnduladeiraEstudo", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("CorridasOnduladeiraEstudo", out var deletePayload))
            return;
