...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.CorConfiguracaoGrafico;

[SmokeTestOrder(17)]
public partial class CorConfiguracaoGraficoCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/CorConfiguracaoGrafico/DeleteCorConfiguracaoGrafico";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("CorConfiguracaoGrafico", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("CorConfiguracaoGrafico", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("CorConfiguracaoGrafico", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("CorConfiguracaoGrafico", out var deletePayload))
            return;
