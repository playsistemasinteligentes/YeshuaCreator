...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.T_MAQUINAS_EQUIPES;

[SmokeTestOrder(44)]
public partial class T_MAQUINAS_EQUIPESCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/T_MAQUINAS_EQUIPES/DeleteT_MAQUINAS_EQUIPES";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("T_MAQUINAS_EQUIPES", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("T_MAQUINAS_EQUIPES", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("T_MAQUINAS_EQUIPES", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("T_MAQUINAS_EQUIPES", out var deletePayload))
            return;
