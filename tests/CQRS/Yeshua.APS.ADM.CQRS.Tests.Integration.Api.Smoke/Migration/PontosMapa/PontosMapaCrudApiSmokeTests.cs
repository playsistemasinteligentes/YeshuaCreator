...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.PontosMapa;

[SmokeTestOrder(65)]
public partial class PontosMapaCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/PontosMapa/DeletePontosMapa";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("PontosMapa", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("PontosMapa", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("PontosMapa", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("PontosMapa", out var deletePayload))
            return;

        using var client = await CreateAuthenticatedClientAsync();
        using var deleteResponse = await client.SendJsonAsync(HttpMethod.Delete, DeleteEndpoint, deletePayload, JsonOptions);
        var deleteState = await ApiResponseAssertions.ReadSuccessStateAsync(deleteResponse);
        var deletedId = ApiJson.GetRequiredProperty(deleteState, "data", "pon_id");
        var expectedId = ApiJson.GetRequiredProperty(deletePayload, "PON_ID");
    ...
    private static JsonObject BuildCreatePayload()
    {
        return new JsonObject
        {
            ...
            ["MUN_ID"] = ApiSmokeTestContext.GetRequiredCreatedId("Municipio", "MUN_ID"),
        };
    }
    ...
    private static JsonObject BuildUpdatePayload(JsonObject createPayload, JsonNode id)
    {
        ...
        payload["MUN_ID"] = ApiSmokeTestContext.GetRequiredCreatedId("Municipio", "MUN_ID");
        return payload;
    }
