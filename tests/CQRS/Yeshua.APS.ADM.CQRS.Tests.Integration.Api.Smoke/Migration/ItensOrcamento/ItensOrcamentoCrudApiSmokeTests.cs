...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.ItensOrcamento;

[SmokeTestOrder(176)]
public partial class ItensOrcamentoCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/ItensOrcamento/DeleteItensOrcamento";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("ItensOrcamento", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("ItensOrcamento", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("ItensOrcamento", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("ItensOrcamento", out var deletePayload))
            return;
    ...
    private static JsonObject BuildCreatePayload()
    {
        return new JsonObject
        {
            ...
            ["GRP_ID_COMPOSICAO"] = ApiSmokeTestContext.GetRequiredCreatedId("GrupoProdutoAbstrato", "GRP_ID_COMPOSICAO"),
            ["ITO_LARGURA"] = 10.5m,
    ...
    private static JsonObject BuildUpdatePayload(JsonObject createPayload, JsonNode id)
    {
        ...
        payload["GRP_ID_COMPOSICAO"] = ApiSmokeTestContext.GetRequiredCreatedId("GrupoProdutoAbstrato", "GRP_ID_COMPOSICAO");
