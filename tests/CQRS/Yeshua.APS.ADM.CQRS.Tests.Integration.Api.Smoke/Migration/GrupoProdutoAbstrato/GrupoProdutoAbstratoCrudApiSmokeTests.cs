...
public partial class GrupoProdutoAbstratoCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/GrupoProdutoAbstrato/DeleteGrupoProdutoAbstrato";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("GrupoProdutoAbstrato", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("GrupoProdutoAbstrato", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("GrupoProdutoAbstrato", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("GrupoProdutoAbstrato", out var deletePayload))
            return;

        using var client = await CreateAuthenticatedClientAsync();
        using var deleteResponse = await client.SendJsonAsync(HttpMethod.Delete, DeleteEndpoint, deletePayload, JsonOptions);
        var deleteState = await ApiResponseAssertions.ReadSuccessStateAsync(deleteResponse);
        var deletedId = ApiJson.GetRequiredProperty(deleteState, "data", "grp_id");
        var expectedId = ApiJson.GetRequiredProperty(deletePayload, "GRP_ID");
    ...
    private static JsonObject BuildCreatePayload()
    {
        return new JsonObject
        {
            ...
            ["TEM_ID"] = 1,
            ["GRP_TIPO"] = 10.5m,
            ["GRP_PAP_ONDA"] = ApiSmokeTestContext.GetRequiredCreatedId("Onda", "GRP_PAP_ONDA"),
            ...
            ["VIN_ID"] = ApiSmokeTestContext.GetRequiredCreatedId("Vinco", "VIN_ID"),
            ["GRP_COLUNA_DE"] = 10.5m,
    ...
    private static JsonObject BuildUpdatePayload(JsonObject createPayload, JsonNode id)
    {
        ...
        payload["GRP_PAP_ONDA"] = ApiSmokeTestContext.GetRequiredCreatedId("Onda", "GRP_PAP_ONDA");
        ...
        payload["VIN_ID"] = ApiSmokeTestContext.GetRequiredCreatedId("Vinco", "VIN_ID");
