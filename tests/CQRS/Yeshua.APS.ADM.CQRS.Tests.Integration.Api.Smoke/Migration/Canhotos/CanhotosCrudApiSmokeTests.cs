...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.Canhotos;

[SmokeTestOrder(7)]
public partial class CanhotosCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/Canhotos/DeleteCanhotos";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("Canhotos", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("Canhotos", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("Canhotos", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("Canhotos", out var deletePayload))
            return;
