...
public partial class TargetProdutoCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/TargetProduto/DeleteTargetProduto";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("TargetProduto", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("TargetProduto", initialDeletePayload);
        ...
        if (!readAssertionHandled)
            ApiResponseAssertions.AssertReadContainsId(readState, createdId, "tar_id");
        ...
        ApiSmokeTestContext.RegisterDeletePayload("TargetProduto", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("TargetProduto", out var deletePayload))
            return;

        using var client = await CreateAuthenticatedClientAsync();
        using var deleteResponse = await client.SendJsonAsync(HttpMethod.Delete, DeleteEndpoint, deletePayload, JsonOptions);
        var deleteState = await ApiResponseAssertions.ReadSuccessStateAsync(deleteResponse);
        var deletedId = ApiJson.GetRequiredProperty(deleteState, "data", "tar_id");
        var expectedId = ApiJson.GetRequiredProperty(deletePayload, "TAR_ID");
    ...
    private static JsonObject BuildCreatePayload()
    {
        ...
        {
            ["MOV_ID"] = ApiSmokeTestContext.GetRequiredCreatedId("MovimentoEstoque", "MOV_ID"),
            ...
            ["UNI_ID"] = ApiSmokeTestContext.GetRequiredCreatedId("UnidadeMedida", "UNI_ID"),
            ...
            ["OCO_ID_PERFORMANCE"] = ApiSmokeTestContext.GetRequiredCreatedId("Ocorrencia", "OCO_ID_PERFORMANCE"),
    ...
    private static JsonObject BuildUpdatePayload(JsonObject createPayload, JsonNode id)
    {
        ...
        payload["MOV_ID"] = ApiSmokeTestContext.GetRequiredCreatedId("MovimentoEstoque", "MOV_ID");
        ...
        payload["UNI_ID"] = ApiSmokeTestContext.GetRequiredCreatedId("UnidadeMedida", "UNI_ID");
        ...
        payload["OCO_ID_PERFORMANCE"] = ApiSmokeTestContext.GetRequiredCreatedId("Ocorrencia", "OCO_ID_PERFORMANCE");
