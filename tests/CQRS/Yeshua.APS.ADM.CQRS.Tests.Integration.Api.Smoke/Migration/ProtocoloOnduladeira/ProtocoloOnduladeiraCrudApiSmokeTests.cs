...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.ProtocoloOnduladeira;

[SmokeTestOrder(67)]
public partial class ProtocoloOnduladeiraCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/ProtocoloOnduladeira/DeleteProtocoloOnduladeira";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("ProtocoloOnduladeira", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("ProtocoloOnduladeira", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("ProtocoloOnduladeira", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("ProtocoloOnduladeira", out var deletePayload))
            return;
