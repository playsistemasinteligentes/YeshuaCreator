...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Smoke.Migration.Turma;

[SmokeTestOrder(100)]
public partial class TurmaCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/Turma/DeleteTurma";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("Turma", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("Turma", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("Turma", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("Turma", out var deletePayload))
            return;
