...
public partial class CargaStandardSagaApiSmokeTests : ApiIntegrationTestBase
{
    ...
    [IntegrationFact]
    public async Task CargaStandard_saga_should_run_with_real_api_and_infrastructure()
    {
