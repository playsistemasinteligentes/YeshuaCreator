...
namespace Yeshua.Fiscal.CQRS.Tests.Integration.Api.Seed.Migration.MDFeTentativaEmissao;

[SeedTestOrder(17)]
public partial class MDFeTentativaEmissaoCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("MDFeTentativaEmissao", createdId);
