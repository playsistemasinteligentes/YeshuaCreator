...
namespace Yeshua.Fiscal.CQRS.Tests.Integration.Api.Seed.Migration.CTeTentativaEmissao;

[SeedTestOrder(9)]
public partial class CTeTentativaEmissaoCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("CTeTentativaEmissao", createdId);
