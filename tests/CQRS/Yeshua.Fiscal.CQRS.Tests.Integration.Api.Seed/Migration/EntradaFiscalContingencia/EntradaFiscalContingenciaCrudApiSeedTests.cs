...
namespace Yeshua.Fiscal.CQRS.Tests.Integration.Api.Seed.Migration.EntradaFiscalContingencia;

[SeedTestOrder(21)]
public partial class EntradaFiscalContingenciaCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("EntradaFiscalContingencia", createdId);
