...
namespace Yeshua.Fiscal.CQRS.Tests.Integration.Api.Seed.Migration.NFeProdutoSnapshot;

[SeedTestOrder(3)]
public partial class NFeProdutoSnapshotCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("NFeProdutoSnapshot", createdId);
