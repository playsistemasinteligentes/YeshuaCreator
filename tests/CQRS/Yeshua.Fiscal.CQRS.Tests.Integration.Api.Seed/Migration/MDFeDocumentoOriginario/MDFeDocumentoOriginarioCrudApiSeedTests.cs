...
namespace Yeshua.Fiscal.CQRS.Tests.Integration.Api.Seed.Migration.MDFeDocumentoOriginario;

[SeedTestOrder(13)]
public partial class MDFeDocumentoOriginarioCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("MDFeDocumentoOriginario", createdId);
