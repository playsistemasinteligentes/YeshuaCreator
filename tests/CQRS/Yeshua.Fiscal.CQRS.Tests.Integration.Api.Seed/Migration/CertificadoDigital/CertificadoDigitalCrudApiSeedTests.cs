...
namespace Yeshua.Fiscal.CQRS.Tests.Integration.Api.Seed.Migration.CertificadoDigital;

[SeedTestOrder(20)]
public partial class CertificadoDigitalCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("CertificadoDigital", createdId);
