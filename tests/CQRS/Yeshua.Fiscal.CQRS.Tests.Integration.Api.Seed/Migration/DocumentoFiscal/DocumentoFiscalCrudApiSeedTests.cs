...
namespace Yeshua.Fiscal.CQRS.Tests.Integration.Api.Seed.Migration.DocumentoFiscal;

[SeedTestOrder(1)]
public partial class DocumentoFiscalCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("DocumentoFiscal", createdId);
