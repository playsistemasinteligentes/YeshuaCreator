...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.CargaPrevista;

[SeedTestOrder(8)]
public partial class CargaPrevistaCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("CargaPrevista", createdId);
