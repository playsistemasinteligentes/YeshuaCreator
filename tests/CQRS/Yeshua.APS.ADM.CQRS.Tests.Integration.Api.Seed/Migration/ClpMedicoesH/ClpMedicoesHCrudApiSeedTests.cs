...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.ClpMedicoesH;

[SeedTestOrder(11)]
public partial class ClpMedicoesHCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("ClpMedicoesH", createdId);
