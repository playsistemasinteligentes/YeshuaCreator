...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.Municipio;

[SeedTestOrder(51)]
public partial class MunicipioCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("Municipio", createdId);
