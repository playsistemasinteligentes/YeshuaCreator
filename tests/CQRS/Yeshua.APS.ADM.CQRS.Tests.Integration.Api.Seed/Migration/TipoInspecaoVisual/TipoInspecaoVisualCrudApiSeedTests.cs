...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.TipoInspecaoVisual;

[SeedTestOrder(91)]
public partial class TipoInspecaoVisualCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("TipoInspecaoVisual", createdId);
