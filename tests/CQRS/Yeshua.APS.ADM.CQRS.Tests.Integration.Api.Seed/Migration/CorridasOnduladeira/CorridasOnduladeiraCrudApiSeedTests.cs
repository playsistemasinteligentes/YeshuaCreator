...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.CorridasOnduladeira;

[SeedTestOrder(18)]
public partial class CorridasOnduladeiraCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("CorridasOnduladeira", createdId);
