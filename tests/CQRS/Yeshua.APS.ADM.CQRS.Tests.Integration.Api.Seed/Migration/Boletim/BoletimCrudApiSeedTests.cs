...
public partial class BoletimCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("Boletim", createdId);
    ...
    private static JsonObject BuildCreatePayload()
    {
        return new JsonObject
        {
            ...
            ["GRP_ID_PROGRAMADO"] = ApiSeedTestContext.GetRequiredCreatedId("GrupoProdutoAbstrato", "GRP_ID_PROGRAMADO"),
    ...
    private static JsonObject BuildUpdatePayload(JsonObject createPayload, JsonNode id)
    {
        ...
        payload["GRP_ID_PROGRAMADO"] = ApiSeedTestContext.GetRequiredCreatedId("GrupoProdutoAbstrato", "GRP_ID_PROGRAMADO");
