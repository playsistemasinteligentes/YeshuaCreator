...
public partial class T_USER_GRUPOCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("T_USER_GRUPO", createdId);
    ...
    private static JsonObject BuildCreatePayload()
    {
        return new JsonObject
        {
            ...
            ["ID_USUARIO"] = ApiSeedTestContext.GetRequiredCreatedId("Usuario", "ID_USUARIO"),
        };
    }
    ...
    private static JsonObject BuildUpdatePayload(JsonObject createPayload, JsonNode id)
    {
        ...
        payload["ID_USUARIO"] = ApiSeedTestContext.GetRequiredCreatedId("Usuario", "ID_USUARIO");
        return payload;
    }
