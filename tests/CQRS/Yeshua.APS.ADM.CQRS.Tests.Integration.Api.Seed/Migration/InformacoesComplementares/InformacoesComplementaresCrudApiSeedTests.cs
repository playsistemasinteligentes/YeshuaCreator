...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.InformacoesComplementares;

[SeedTestOrder(174)]
public partial class InformacoesComplementaresCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("InformacoesComplementares", createdId);
