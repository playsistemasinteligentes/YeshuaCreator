...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.CalendarioDisponibilidadeVeiculos;

[SeedTestOrder(6)]
public partial class CalendarioDisponibilidadeVeiculosCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("CalendarioDisponibilidadeVeiculos", createdId);
