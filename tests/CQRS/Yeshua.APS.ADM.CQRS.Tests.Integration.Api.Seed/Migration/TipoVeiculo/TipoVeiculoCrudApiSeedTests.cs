...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.TipoVeiculo;

[SeedTestOrder(94)]
public partial class TipoVeiculoCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("TipoVeiculo", createdId);
