...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.RespInspVisual;

[SeedTestOrder(71)]
public partial class RespInspVisualCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("RespInspVisual", createdId);
