...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.T_Grupo;

[SeedTestOrder(28)]
public partial class T_GrupoCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("T_Grupo", createdId);
        ...
        if (!readAssertionHandled)
            ApiResponseAssertions.AssertReadContainsId(readState, createdId, "gru_id");
