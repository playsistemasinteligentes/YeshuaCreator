...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.Planocontas;

[SeedTestOrder(114)]
public partial class PlanocontasCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("Planocontas", createdId);
