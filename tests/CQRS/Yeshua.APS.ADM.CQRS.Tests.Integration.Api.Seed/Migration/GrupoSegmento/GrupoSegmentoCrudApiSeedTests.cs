...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.GrupoSegmento;

[SeedTestOrder(30)]
public partial class GrupoSegmentoCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("GrupoSegmento", createdId);
