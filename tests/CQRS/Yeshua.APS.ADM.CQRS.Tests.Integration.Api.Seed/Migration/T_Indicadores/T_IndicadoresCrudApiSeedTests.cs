...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.T_Indicadores;

[SeedTestOrder(144)]
public partial class T_IndicadoresCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("T_Indicadores", createdId);
    ...
    private static JsonObject BuildCreatePayload()
    {
        return new JsonObject
        {
            ...
            ["NEG_ID"] = ApiSeedTestContext.GetRequiredCreatedId("T_Negocio", "NEG_ID"),
    ...
    private static JsonObject BuildUpdatePayload(JsonObject createPayload, JsonNode id)
    {
        ...
        payload["NEG_ID"] = ApiSeedTestContext.GetRequiredCreatedId("T_Negocio", "NEG_ID");
