...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.PendenciasInterface;

[SeedTestOrder(58)]
public partial class PendenciasInterfaceCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("PendenciasInterface", createdId);
