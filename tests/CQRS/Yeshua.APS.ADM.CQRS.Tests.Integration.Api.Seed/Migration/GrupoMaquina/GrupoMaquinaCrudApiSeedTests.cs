...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.GrupoMaquina;

[SeedTestOrder(1)]
public partial class GrupoMaquinaCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("GrupoMaquina", createdId);
