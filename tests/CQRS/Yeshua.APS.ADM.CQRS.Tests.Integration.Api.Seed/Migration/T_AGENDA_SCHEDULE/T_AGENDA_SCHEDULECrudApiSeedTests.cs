...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.T_AGENDA_SCHEDULE;

[SeedTestOrder(3)]
public partial class T_AGENDA_SCHEDULECrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("T_AGENDA_SCHEDULE", createdId);
