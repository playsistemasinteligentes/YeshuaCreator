...
namespace Yeshua.APS.ADM.CQRS.Tests.Integration.Api.Seed.Migration.Mensagem;

[SeedTestOrder(49)]
public partial class MensagemCrudApiSeedTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSeedTestContext.RegisterCreatedId("Mensagem", createdId);
