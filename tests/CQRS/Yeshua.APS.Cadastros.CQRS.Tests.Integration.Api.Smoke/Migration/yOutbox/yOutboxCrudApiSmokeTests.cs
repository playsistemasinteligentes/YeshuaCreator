...
namespace Yeshua.APS.Cadastros.CQRS.Tests.Integration.Api.Smoke.Migration.yOutbox;
...
public partial class yOutboxCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("yOutbox", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("yOutbox", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("yOutbox", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("yOutbox", out var deletePayload))
            return;
