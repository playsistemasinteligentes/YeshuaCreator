...
namespace Yeshua.APS.Cadastros.CQRS.Tests.Integration.Api.Smoke.Migration.yUser;
...
public partial class yUserCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    private const string DeleteEndpoint = "yapi/yUser/DeleteyUser";
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("yUser", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("yUser", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("yUser", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("yUser", out var deletePayload))
            return;
