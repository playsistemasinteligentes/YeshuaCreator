...
namespace Yeshua.APS.Cadastros.CQRS.Tests.Integration.Api.Smoke.Migration.ySagaStep;
...
public partial class ySagaStepCrudApiSmokeTests : ApiIntegrationTestBase
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        ApiSmokeTestContext.RegisterCreatedId("ySagaStep", createdId);

        var initialDeletePayload = BuildDeletePayload(createPayload, createdId);
        CustomizeDeletePayload(initialDeletePayload);
        ApiSmokeTestContext.RegisterDeletePayload("ySagaStep", initialDeletePayload);
        ...
        ApiSmokeTestContext.RegisterDeletePayload("ySagaStep", deletePayload);
    }

    public async Task DeleteAsync()
    {
        if (!ApiSmokeTestContext.TryGetDeletePayload("ySagaStep", out var deletePayload))
            return;
