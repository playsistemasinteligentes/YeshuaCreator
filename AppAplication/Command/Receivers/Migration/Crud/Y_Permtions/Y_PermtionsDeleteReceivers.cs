...
{
    public class DeleteY_PermtionsReceiver : ReciverBase <IY_PermtionsEntity>
    {
        private readonly IY_PermtionsWriteRepository _repository;
        private readonly ILogger _logger;

        public DeleteY_PermtionsReceiver(IY_PermtionsWriteRepository repository,ILogger logger)
        {
