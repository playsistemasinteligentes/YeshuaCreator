...
{
    public class DeleteYperfilPermitionsReceiver : ReciverBase <IYperfilPermitionsEntity>
    {
        private readonly IYperfilPermitionsWriteRepository _repository;
        private readonly ILogger _logger;

        public DeleteYperfilPermitionsReceiver(IYperfilPermitionsWriteRepository repository,ILogger logger)
        {
        ...
        protected override State<IYperfilPermitionsEntity> Action(ICommand comand)
        {
             ...
             {    
                 ...
                 if (!yperfilpermitions.isValidDelete())
                     return ValidationError(yperfilpermitions.getErroMensagens(), comand);

                 try
                 {
                     _repository.Delete(yperfilpermitions);
