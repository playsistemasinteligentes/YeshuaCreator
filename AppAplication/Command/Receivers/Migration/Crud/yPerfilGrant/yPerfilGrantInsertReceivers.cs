...
{
    public class InsertyPerfilGrantReceiver : ReciverBase<ICommand, IyPerfilGrantEntity>
    {
        private readonly IyPerfilGrantWriteRepository _repository;
        private readonly ILogger _logger;

        public InsertyPerfilGrantReceiver(IyPerfilGrantWriteRepository repository,ILogger logger)
        {
        ...
        protected override State<IyPerfilGrantEntity> Action(ICommand comand)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Insert(yperfilgrant);
