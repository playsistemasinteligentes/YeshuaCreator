...
{
    public class UpdateY_UserPermitionsReceiver : ReciverBase <IY_UserPermitionsEntity>
    {
        private readonly IY_UserPermitionsWriteRepository _repository;
        private readonly ILogger _logger;

        public UpdateY_UserPermitionsReceiver(IY_UserPermitionsWriteRepository repository,ILogger logger)
        {
