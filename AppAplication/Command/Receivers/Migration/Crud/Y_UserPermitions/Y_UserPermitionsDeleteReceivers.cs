...
{
    public class DeleteY_UserPermitionsReceiver : ReciverBase
    {
        private readonly IY_UserPermitionsWriteRepository _repository;

        public DeleteY_UserPermitionsReceiver(IY_UserPermitionsWriteRepository repository)
        {
        ...
        protected override State Action(ICommand comand)
        {
             ...
             {    
                 ...
                 try
                 {
                     ...
                     return new State(200, "OK", y_userpermitions);
                 }
                 catch (Exception e)
                 {
