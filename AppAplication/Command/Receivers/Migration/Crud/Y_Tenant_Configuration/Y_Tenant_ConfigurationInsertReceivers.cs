...
{
    public class InsertY_Tenant_ConfigurationReceiver : ReciverBase <IY_Tenant_ConfigurationEntity>
    {
        private readonly IY_Tenant_ConfigurationWriteRepository _repository;
        private readonly ILogger _logger;

        public InsertY_Tenant_ConfigurationReceiver(IY_Tenant_ConfigurationWriteRepository repository,ILogger logger)
        {
