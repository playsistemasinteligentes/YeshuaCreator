...
{
    public class DeleteY_Tenant_ConfigurationReceiver : ReciverBase <IY_Tenant_ConfigurationEntity>
    {
        private readonly IY_Tenant_ConfigurationWriteRepository _repository;
        private readonly ILogger _logger;

        public DeleteY_Tenant_ConfigurationReceiver(IY_Tenant_ConfigurationWriteRepository repository,ILogger logger)
        {
        ...
        protected override State<IY_Tenant_ConfigurationEntity> Action(ICommand comand)
        {
             ...
             {    
                 ...
                 if (!y_tenant_configuration.isValidDelete())
                     return ValidationError(y_tenant_configuration.getErroMensagens(), comand);

                 try
                 {
                     _repository.Delete(y_tenant_configuration);
