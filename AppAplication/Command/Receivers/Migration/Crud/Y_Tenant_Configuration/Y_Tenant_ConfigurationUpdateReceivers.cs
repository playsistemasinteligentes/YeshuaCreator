...
{
    public class UpdateY_Tenant_ConfigurationReceiver : ReciverBase <Y_Tenant_ConfigurationEntity>
    {
        private readonly IY_Tenant_ConfigurationWriteRepository _repository;

        public UpdateY_Tenant_ConfigurationReceiver(IY_Tenant_ConfigurationWriteRepository repository)
        {
