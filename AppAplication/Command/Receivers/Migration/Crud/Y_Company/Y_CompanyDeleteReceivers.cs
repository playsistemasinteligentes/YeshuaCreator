...
{
    public class DeleteY_CompanyReceiver : ReciverBase <Y_CompanyEntity>
    {
        private readonly IY_CompanyWriteRepository _repository;

        public DeleteY_CompanyReceiver(IY_CompanyWriteRepository repository)
        {
