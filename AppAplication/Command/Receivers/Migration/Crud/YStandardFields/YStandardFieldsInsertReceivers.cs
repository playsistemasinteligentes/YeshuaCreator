...
{
    public class InsertYStandardFieldsReceiver : ReciverBase <IYStandardFieldsEntity>
    {
        private readonly IYStandardFieldsWriteRepository _repository;
        private readonly ILogger _logger;

        public InsertYStandardFieldsReceiver(IYStandardFieldsWriteRepository repository,ILogger logger)
        {
        ...
        protected override State<IYStandardFieldsEntity> Action(ICommand comand)
        {
             ...
             {    
                 ...
                 if (!ystandardfields.isValidInsert())
                     return ValidationError(ystandardfields.getErroMensagens(), comand);

                 try
                 {
                     _repository.Insert(ystandardfields);
