...
{
    public class UpdateYtenant_ConfigurationReceiver : ReciverBase <IYtenant_ConfigurationEntity>
    {
        private readonly IYtenant_ConfigurationWriteRepository _repository;
        private readonly ILogger _logger;

        public UpdateYtenant_ConfigurationReceiver(IYtenant_ConfigurationWriteRepository repository,ILogger logger)
        {
        ...
        protected override State<IYtenant_ConfigurationEntity> Action(ICommand comand)
        {
             ...
             {    
                 ...
                 if (!ytenant_configuration.isValidUpdate())
                     return ValidationError(ytenant_configuration.getErroMensagens(), comand);

                 try
                 {
                     _repository.Update(ytenant_configuration);
