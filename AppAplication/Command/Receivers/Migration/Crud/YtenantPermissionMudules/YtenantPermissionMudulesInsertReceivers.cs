...
{
    public class InsertYtenantPermissionMudulesReceiver : ReciverBase <IYtenantPermissionMudulesEntity>
    {
        private readonly IYtenantPermissionMudulesWriteRepository _repository;
        private readonly ILogger _logger;

        public InsertYtenantPermissionMudulesReceiver(IYtenantPermissionMudulesWriteRepository repository,ILogger logger)
        {
        ...
        protected override State<IYtenantPermissionMudulesEntity> Action(ICommand comand)
        {
             ...
             {    
                 ...
                 if (!ytenantpermissionmudules.isValidInsert())
                     return ValidationError(ytenantpermissionmudules.getErroMensagens(), comand);

                 try
                 {
                     _repository.Insert(ytenantpermissionmudules);
