...
{
    public class DeleteYtenantPermissionMudulesReceiver : ReciverBase <IYtenantPermissionMudulesEntity>
    {
        private readonly IYtenantPermissionMudulesWriteRepository _repository;
        private readonly ILogger _logger;

        public DeleteYtenantPermissionMudulesReceiver(IYtenantPermissionMudulesWriteRepository repository,ILogger logger)
        {
        ...
        protected override State<IYtenantPermissionMudulesEntity> Action(ICommand comand)
        {
             ...
             {    
                 ...
                 if (!ytenantpermissionmudules.isValidDelete())
                     return ValidationError(ytenantpermissionmudules.getErroMensagens(), comand);

                 try
                 {
                     _repository.Delete(ytenantpermissionmudules);
