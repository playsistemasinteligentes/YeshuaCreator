...
{
    public class UpdateYuserPermissionActionsReceiver : ReciverBase <IYuserPermissionActionsEntity>
    {
        private readonly IYuserPermissionActionsWriteRepository _repository;
        private readonly ILogger _logger;

        public UpdateYuserPermissionActionsReceiver(IYuserPermissionActionsWriteRepository repository,ILogger logger)
        {
        ...
        protected override State<IYuserPermissionActionsEntity> Action(ICommand comand)
        {
             ...
             {    
                 ...
                 if (!yuserpermissionactions.isValidUpdate())
                     return ValidationError(yuserpermissionactions.getErroMensagens(), comand);

                 try
                 {
                     _repository.Update(yuserpermissionactions);
