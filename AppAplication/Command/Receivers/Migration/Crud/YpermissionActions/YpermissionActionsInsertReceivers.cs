...
{
    public class InsertYpermissionActionsReceiver : ReciverBase <IYpermissionActionsEntity>
    {
        private readonly IYpermissionActionsWriteRepository _repository;
        private readonly ILogger _logger;

        public InsertYpermissionActionsReceiver(IYpermissionActionsWriteRepository repository,ILogger logger)
        {
        ...
        protected override State<IYpermissionActionsEntity> Action(ICommand comand)
        {
             ...
             {    
                 ...
                 if (!ypermissionactions.isValidInsert())
                     return ValidationError(ypermissionactions.getErroMensagens(), comand);

                 try
                 {
                     _repository.Insert(ypermissionactions);
