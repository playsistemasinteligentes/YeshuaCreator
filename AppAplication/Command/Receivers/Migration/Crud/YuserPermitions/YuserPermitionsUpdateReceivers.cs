...
{
    public class UpdateYuserPermitionsReceiver : ReciverBase <IYuserPermitionsEntity>
    {
        private readonly IYuserPermitionsWriteRepository _repository;
        private readonly ILogger _logger;

        public UpdateYuserPermitionsReceiver(IYuserPermitionsWriteRepository repository,ILogger logger)
        {
        ...
        protected override State<IYuserPermitionsEntity> Action(ICommand comand)
        {
             ...
             {    
                 ...
                 if (!yuserpermitions.isValidUpdate())
                     return ValidationError(yuserpermitions.getErroMensagens(), comand);

                 try
                 {
                     _repository.Update(yuserpermitions);
