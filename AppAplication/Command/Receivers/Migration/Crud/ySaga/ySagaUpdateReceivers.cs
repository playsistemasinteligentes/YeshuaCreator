...
namespace Command.Receivers.Write
{
    public class UpdateySagaReceiver : ReciverBase<ICommand, IySagaEntity>
    {
        ...
        public UpdateySagaReceiver(IySagaWriteRepository repository,ILogger logger)
        {
        ...
        protected override State<IySagaEntity> Action(ICommand comand)
        {
             ...
             {    
                 var ysaga = new ySagaFactory(_logger).Create(c.Id, c.SagaId, c.Type, c.Status, c.KeyCurrentStep, c.CreatedAt, c.CompletedAt, c.EntityType, c.EntityId);
