...
{
    public class UpdateAgendamentosReceiver : ReciverBase
    {
        private readonly IAgendamentosWriteRepository _repository;

        public UpdateAgendamentosReceiver(IAgendamentosWriteRepository repository)
        {
        ...
        protected override State Action(ICommand comand)
        {
            ...
            try
            {
                _repository.Update(agendamentos);
