...
{
    public class DeleteAgendamentosReceiver : ReciverBase
    {
        private readonly IAgendamentosWriteRepository _repository;

        public DeleteAgendamentosReceiver(IAgendamentosWriteRepository repository)
        {
        ...
        protected override State Action(ICommand comand)
        {
            ...
            try
            {
                _repository.Delete(agendamentos);
