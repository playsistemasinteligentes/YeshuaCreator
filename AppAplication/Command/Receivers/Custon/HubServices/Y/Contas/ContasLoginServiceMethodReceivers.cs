...
{
    public partial class ContasLoginServiceMethodReceiver
    {
        ...
        partial void CustomActionHook(ref State state, Command.Commands.ContasLoginServiceMethodCommand command)
        {
            try
            {
