...
{
    public partial class OutBoxHandler
    {
        ...
        public OutBoxHandler(IUnitOfWork unitOfWork, ILogger logger, IyOutboxReadRepository repReadyOutbox, IyOutboxWriteRepository repWriteyOutbox, IQueuePublisher queuePublisher, IyFileUploadReadRepository repReadyUpload, IFileStorage fileStorage)
        {
