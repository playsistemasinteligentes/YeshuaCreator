...
{
    public class MovimentacaoFinanceiraReadFKReceiver : ReciverBase
    {
        private readonly IMovimentacaoFinanceiraReadRepository _repository;

        public MovimentacaoFinanceiraReadFKReceiver(IMovimentacaoFinanceiraReadRepository repository)
        {
