...
{
    public class DisponibilidadeAgendaReadFKReceiver : ReciverBase
    {
        private readonly IDisponibilidadeAgendaReadRepository _repository;

        public DisponibilidadeAgendaReadFKReceiver(IDisponibilidadeAgendaReadRepository repository)
        {
