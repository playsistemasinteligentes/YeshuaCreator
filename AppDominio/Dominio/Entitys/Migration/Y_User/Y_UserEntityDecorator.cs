                ...
                {
                    public partial class Y_UserDecorator : IY_UserEntity
{

                        private readonly IY_UserEntity _inner;
                        private readonly Dominio.Interfaces.ILogger _logger;
                        public Y_UserDecorator(IY_UserEntity inner, Dominio.Interfaces.ILogger logger)
                        {
                            _inner = inner;
                            _logger = logger;
                        }
