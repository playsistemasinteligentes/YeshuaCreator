                ...
                {
                    public partial class YpermtionsDecorator : IYpermtionsEntity
{

                        private readonly IYpermtionsEntity _inner;
                        private readonly Dominio.Interfaces.ILogger _logger;
                        public YpermtionsDecorator(IYpermtionsEntity inner, Dominio.Interfaces.ILogger logger)
                        {
                            _inner = inner;
                            _logger = logger;
                        }
