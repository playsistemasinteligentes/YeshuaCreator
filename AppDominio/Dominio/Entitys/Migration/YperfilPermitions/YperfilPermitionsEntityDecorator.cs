                ...
                {
                    public partial class YperfilPermitionsDecorator : IYperfilPermitionsEntity
{

                        private readonly IYperfilPermitionsEntity _inner;
                        private readonly Dominio.Interfaces.ILogger _logger;
                        public YperfilPermitionsDecorator(IYperfilPermitionsEntity inner, Dominio.Interfaces.ILogger logger)
                        {
                            _inner = inner;
                            _logger = logger;
                        }
