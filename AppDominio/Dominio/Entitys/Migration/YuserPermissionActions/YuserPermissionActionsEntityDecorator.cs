                ...
                {
                    public partial class YuserPermissionActionsDecorator : IYuserPermissionActionsEntity
{

                        private readonly IYuserPermissionActionsEntity _inner;
                        private readonly Dominio.Interfaces.ILogger _logger;
                        public YuserPermissionActionsDecorator(IYuserPermissionActionsEntity inner, Dominio.Interfaces.ILogger logger)
                        {
                            _inner = inner;
                            _logger = logger;
                        }
