                ...
                {
                    public partial class YpserPermitionsDecorator : IYpserPermitionsEntity
{

                        private readonly IYpserPermitionsEntity _inner;
                        private readonly Dominio.Interfaces.ILogger _logger;
                        public YpserPermitionsDecorator(IYpserPermitionsEntity inner, Dominio.Interfaces.ILogger logger)
                        {
                            _inner = inner;
                            _logger = logger;
                        }
