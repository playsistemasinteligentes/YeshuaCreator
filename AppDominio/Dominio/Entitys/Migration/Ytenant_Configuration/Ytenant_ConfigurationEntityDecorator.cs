                ...
                {
                    public partial class Ytenant_ConfigurationDecorator : IYtenant_ConfigurationEntity
{

                        private readonly IYtenant_ConfigurationEntity _inner;
                        private readonly Dominio.Interfaces.ILogger _logger;
                        public Ytenant_ConfigurationDecorator(IYtenant_ConfigurationEntity inner, Dominio.Interfaces.ILogger logger)
                        {
                            _inner = inner;
                            _logger = logger;
                        }
