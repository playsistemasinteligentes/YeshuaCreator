                ...
                {
                    public partial class Y_PerfilDecorator : IY_PerfilEntity
{

                        private readonly IY_PerfilEntity _inner;
                        private readonly Dominio.Interfaces.ILogger _logger;
                        public Y_PerfilDecorator(IY_PerfilEntity inner, Dominio.Interfaces.ILogger logger)
                        {
                            _inner = inner;
                            _logger = logger;
                        }
