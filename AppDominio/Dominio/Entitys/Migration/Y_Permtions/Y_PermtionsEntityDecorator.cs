                ...
                {
                    public partial class Y_PermtionsDecorator : IY_PermtionsEntity
{

                        private readonly IY_PermtionsEntity _inner;
                        private readonly Dominio.Interfaces.ILogger _logger;
                        public Y_PermtionsDecorator(IY_PermtionsEntity inner, Dominio.Interfaces.ILogger logger)
                        {
                            _inner = inner;
                            _logger = logger;
                        }
