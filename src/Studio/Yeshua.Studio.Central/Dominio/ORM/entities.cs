...
namespace Yeshua.Studio.Central.Domain.Entities
{
    public class TenantCatalogo
    {
        ...
        public static MyApp.QueryBuilder.Query<TenantCatalogo> Query() => new MyApp.QueryBuilder.Query<TenantCatalogo>();
    }
