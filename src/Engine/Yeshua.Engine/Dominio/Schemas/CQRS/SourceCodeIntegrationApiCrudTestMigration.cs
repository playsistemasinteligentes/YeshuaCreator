...
{
    public class SourceCodeIntegrationApiCrudTestMigration : SourceCodeBase
    {
        private readonly Entity _entity;

        public SourceCodeIntegrationApiCrudTestMigration(Entity entity)
            : base()
        {
            _entity = entity;
        }
        ...
        protected override StringBuilder GenerateCode()
        {
            ...
            sb.AppendLine();
            sb.AppendLine($"namespace Yeshua.CQRS.Tests.Integration.Api.Migration.{_entity.EntityName};");
            sb.AppendLine();
            ...
            sb.AppendLine("    public async Task Crud_should_create_read_update_and_delete_through_api()");
            sb.AppendLine("    {");
            ...
            sb.AppendLine("        ApiResponseAssertions.AssertSameJsonValue(createdId, deletedId, \"deleted id\");");
            sb.AppendLine("    }");
            sb.AppendLine();
        ...
        private string GetClassName() => $"{_entity.EntityName}CrudApiIntegrationTests";
