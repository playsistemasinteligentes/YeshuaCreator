...
{
    public class SourceCodeAplicationCommandWorkerUseCase : SourceCodeBase
    {
        ...
        public SourceCodeAplicationCommandWorkerUseCase(UseCaseGroup hub)
            : base()
        {
            _useCaseGroup = hub;
        ...
        public SourceCodeAplicationCommandWorkerUseCase(UseCaseCommand useCase)
            : base()
        {
        ...
        public SourceCodeAplicationCommandWorkerUseCase(UseCaseCommand useCase, Strategy strategy, ExportPathsSourceCodeAplicationCommandReceiversUseCase exportPath, ref List<CodigoGerado> CodigoGerado)
            : base()
        {
            _strategy = strategy;
            _type = strategy.Type;
