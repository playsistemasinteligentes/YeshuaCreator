...
{
    public partial class CriarCargaHandler
    {
        private readonly IyInboxWriteRepository _inboxWriteRepository;
        private readonly ILogger _logger;

        public CriarCargaHandler(IyInboxWriteRepository inboxWriteRepository, ILogger logger)
        {
        ...
        {
            _logger.Info($"Carga {saga.EntityId}: criacao aplicada na saga standard.");
        }
    }
}
