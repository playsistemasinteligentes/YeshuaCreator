...
namespace Command.Receivers.Read
{
    public class CalendarioDisponibilidadeVeiculosReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<CalendarioDisponibilidadeVeiculosUserIdDTO>>
    {
        ...
        protected override Task<State<IEnumerable<CalendarioDisponibilidadeVeiculosUserIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
