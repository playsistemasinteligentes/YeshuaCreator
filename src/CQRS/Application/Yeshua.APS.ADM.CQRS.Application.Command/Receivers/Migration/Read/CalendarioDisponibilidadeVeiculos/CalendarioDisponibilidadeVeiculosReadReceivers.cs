...
{
    public class CalendarioDisponibilidadeVeiculosReadReceiver : ReciverBase<ICommand, DataPagination<CalendarioDisponibilidadeVeiculosDTO>>
    {
        private readonly ICalendarioDisponibilidadeVeiculosReadRepository _repository;
        private readonly ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public CalendarioDisponibilidadeVeiculosReadReceiver(
