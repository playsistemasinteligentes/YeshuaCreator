...
{
    public class ItenCalendarioDisponibilidadeVeiculosReadFKTenantIDReceiver : ReciverBase<ICommand, IEnumerable<ItenCalendarioDisponibilidadeVeiculosTenantIDDTO>>
    {
        private readonly IItenCalendarioDisponibilidadeVeiculosReadRepository _repository;
		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public ItenCalendarioDisponibilidadeVeiculosReadFKTenantIDReceiver(
