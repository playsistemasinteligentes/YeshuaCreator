...
namespace Command.Receivers.Read
{
    public class ItenCalendarioDisponibilidadeVeiculosReadReceiver : ReciverBase<ICommand, DataPagination<ItenCalendarioDisponibilidadeVeiculosDTO>>
    {
        ...
        protected override Task<State<DataPagination<ItenCalendarioDisponibilidadeVeiculosDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
