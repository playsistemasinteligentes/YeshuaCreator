...
{
    public class T_HORARIO_RECEBIMENTOReadFKCLI_IDReceiver : ReciverBase<ICommand, IEnumerable<T_HORARIO_RECEBIMENTOCLI_IDDTO>>
    {
        private readonly IT_HORARIO_RECEBIMENTOReadRepository _repository;
		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public T_HORARIO_RECEBIMENTOReadFKCLI_IDReceiver(
