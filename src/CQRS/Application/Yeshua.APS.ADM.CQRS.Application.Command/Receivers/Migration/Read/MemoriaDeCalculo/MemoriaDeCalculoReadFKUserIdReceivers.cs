...
{
    public class MemoriaDeCalculoReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<MemoriaDeCalculoUserIdDTO>>
    {
        private readonly IMemoriaDeCalculoReadRepository _repository;
		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public MemoriaDeCalculoReadFKUserIdReceiver(
