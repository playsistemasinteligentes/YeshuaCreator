...
{
    public class T_AGENDA_SCHEDULEReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<T_AGENDA_SCHEDULEUserIdDTO>>
    {
        private readonly IT_AGENDA_SCHEDULEReadRepository _repository;
		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public T_AGENDA_SCHEDULEReadFKUserIdReceiver(
