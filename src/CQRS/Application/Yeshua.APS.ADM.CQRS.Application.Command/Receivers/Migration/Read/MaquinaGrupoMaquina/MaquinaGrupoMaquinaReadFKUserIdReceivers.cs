...
{
    public class MaquinaGrupoMaquinaReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<MaquinaGrupoMaquinaUserIdDTO>>
    {
        private readonly IMaquinaGrupoMaquinaReadRepository _repository;
		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public MaquinaGrupoMaquinaReadFKUserIdReceiver(
