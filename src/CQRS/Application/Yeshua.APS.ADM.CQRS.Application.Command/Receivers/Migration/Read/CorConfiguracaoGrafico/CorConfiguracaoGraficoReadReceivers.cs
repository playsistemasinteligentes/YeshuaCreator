...
{
    public class CorConfiguracaoGraficoReadReceiver : ReciverBase<ICommand, DataPagination<CorConfiguracaoGraficoDTO>>
    {
        private readonly ICorConfiguracaoGraficoReadRepository _repository;
        private readonly ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public CorConfiguracaoGraficoReadReceiver(
