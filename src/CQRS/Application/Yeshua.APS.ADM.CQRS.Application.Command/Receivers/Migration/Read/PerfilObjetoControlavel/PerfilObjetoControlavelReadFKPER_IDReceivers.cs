...
{
    public class PerfilObjetoControlavelReadFKPER_IDReceiver : ReciverBase<ICommand, IEnumerable<PerfilObjetoControlavelPER_IDDTO>>
    {
        private readonly IPerfilObjetoControlavelReadRepository _repository;
		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public PerfilObjetoControlavelReadFKPER_IDReceiver(
