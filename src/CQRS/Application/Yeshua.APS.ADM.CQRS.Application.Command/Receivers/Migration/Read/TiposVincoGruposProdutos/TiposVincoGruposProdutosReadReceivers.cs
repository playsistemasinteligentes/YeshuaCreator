...
{
    public class TiposVincoGruposProdutosReadReceiver : ReciverBase<ICommand, DataPagination<TiposVincoGruposProdutosDTO>>
    {
        private readonly ITiposVincoGruposProdutosReadRepository _repository;
        private readonly ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public TiposVincoGruposProdutosReadReceiver(
