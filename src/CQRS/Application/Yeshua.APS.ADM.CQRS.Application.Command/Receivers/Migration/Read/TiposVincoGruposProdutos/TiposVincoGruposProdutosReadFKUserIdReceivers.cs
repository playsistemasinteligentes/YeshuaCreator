...
{
    public class TiposVincoGruposProdutosReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<TiposVincoGruposProdutosUserIdDTO>>
    {
        private readonly ITiposVincoGruposProdutosReadRepository _repository;
		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public TiposVincoGruposProdutosReadFKUserIdReceiver(
