...
{
    public class TemplateTipoInspecaoVisualReadFKTenantIDReceiver : ReciverBase<ICommand, IEnumerable<TemplateTipoInspecaoVisualTenantIDDTO>>
    {
        private readonly ITemplateTipoInspecaoVisualReadRepository _repository;
		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public TemplateTipoInspecaoVisualReadFKTenantIDReceiver(
