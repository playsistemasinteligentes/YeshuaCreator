...
{
    public class BoletimReadFKGRP_ID_PROGRAMADOReceiver : ReciverBase<ICommand, IEnumerable<BoletimGRP_ID_PROGRAMADODTO>>
    {
        private readonly IBoletimReadRepository _repository;
		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public BoletimReadFKGRP_ID_PROGRAMADOReceiver(
