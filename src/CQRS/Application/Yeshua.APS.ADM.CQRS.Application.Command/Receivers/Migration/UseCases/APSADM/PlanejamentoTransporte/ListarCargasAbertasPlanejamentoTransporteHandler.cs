...
// Escopo: apsadm.planejamento-transporte.cargas-abertas.listar
using Command.Write;
...
{
    public partial class ListarCargasAbertasPlanejamentoTransporteHandler : ReciverBase< ListarCargasAbertasPlanejamentoTransporteInputCommand, ListarCargasAbertasPlanejamentoTransporteOutputCommand>
    {
        ...
        protected override async Task<State<ListarCargasAbertasPlanejamentoTransporteOutputCommand>> ActionAsync(ListarCargasAbertasPlanejamentoTransporteInputCommand comand, CancellationToken cancellationToken = default)
        {
            try
            {
