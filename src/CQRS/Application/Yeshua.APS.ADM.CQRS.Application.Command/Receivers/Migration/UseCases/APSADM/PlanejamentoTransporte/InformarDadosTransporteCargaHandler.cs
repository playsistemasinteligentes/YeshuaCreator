...
// Escopo: apsadm.carga.dados-transporte.informar
using Command.Write;
...
{
    public partial class InformarDadosTransporteCargaHandler : ReciverBase< InformarDadosTransporteCargaInputCommand, InformarDadosTransporteCargaOutputCommand>
    {
        ...
        protected override async Task<State<InformarDadosTransporteCargaOutputCommand>> ActionAsync(InformarDadosTransporteCargaInputCommand comand, CancellationToken cancellationToken = default)
        {
            try
            {
            ...
            catch (ReceiverException<InformarDadosTransporteCargaOutputCommand> e)
            {
                return e.State;
            }
            catch (Exception e)
