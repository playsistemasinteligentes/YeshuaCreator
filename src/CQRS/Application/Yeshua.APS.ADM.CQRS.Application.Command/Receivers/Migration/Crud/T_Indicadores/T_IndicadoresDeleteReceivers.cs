...
{
    public class DeleteT_IndicadoresReceiver : ReciverBase<ICommand, IT_IndicadoresEntity>
    {
        ...
        public DeleteT_IndicadoresReceiver(
        ...
        protected override async Task<State<IT_IndicadoresEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteT_Indicadores", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteT_IndicadoresReceiver), commandName: "Command.Write.T_IndicadoresCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(t_indicadores);
