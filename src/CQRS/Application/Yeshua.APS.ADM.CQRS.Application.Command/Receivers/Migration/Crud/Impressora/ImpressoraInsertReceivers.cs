...
{
    public class InsertImpressoraReceiver : ReciverBase<ICommand, IImpressoraEntity>
    {
        ...
        public InsertImpressoraReceiver(
        ...
        protected override async Task<State<IImpressoraEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertImpressora", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertImpressoraReceiver), commandName: "Command.Write.ImpressoraCrudCommand");
