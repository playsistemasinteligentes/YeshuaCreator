...
{
    public class UpdateRelatoriosReceiver : ReciverBase<ICommand, IRelatoriosEntity>
    {
        ...
        public UpdateRelatoriosReceiver(
        ...
        protected override async Task<State<IRelatoriosEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateRelatorios", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateRelatoriosReceiver), commandName: "Command.Write.RelatoriosCrudCommand");
