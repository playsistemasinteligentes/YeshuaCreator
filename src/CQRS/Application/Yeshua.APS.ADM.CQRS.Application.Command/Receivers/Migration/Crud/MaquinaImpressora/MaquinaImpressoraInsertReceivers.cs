...
{
    public class InsertMaquinaImpressoraReceiver : ReciverBase<ICommand, IMaquinaImpressoraEntity>
    {
        ...
        public InsertMaquinaImpressoraReceiver(
        ...
        protected override async Task<State<IMaquinaImpressoraEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Insert(maquinaimpressora);
