...
{
    public class InsertObservacoesReceiver : ReciverBase<ICommand, IObservacoesEntity>
    {
        ...
        public InsertObservacoesReceiver(
        ...
        protected override async Task<State<IObservacoesEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertObservacoes", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertObservacoesReceiver), commandName: "Command.Write.ObservacoesCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(observacoes);
