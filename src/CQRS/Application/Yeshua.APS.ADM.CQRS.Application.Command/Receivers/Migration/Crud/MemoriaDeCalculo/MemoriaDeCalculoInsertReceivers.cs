...
{
    public class InsertMemoriaDeCalculoReceiver : ReciverBase<ICommand, IMemoriaDeCalculoEntity>
    {
        ...
        public InsertMemoriaDeCalculoReceiver(
        ...
        protected override async Task<State<IMemoriaDeCalculoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertMemoriaDeCalculo", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertMemoriaDeCalculoReceiver), commandName: "Command.Write.MemoriaDeCalculoCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(memoriadecalculo);
