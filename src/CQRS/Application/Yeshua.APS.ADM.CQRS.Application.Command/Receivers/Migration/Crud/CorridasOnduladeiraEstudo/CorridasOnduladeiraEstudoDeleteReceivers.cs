...
{
    public class DeleteCorridasOnduladeiraEstudoReceiver : ReciverBase<ICommand, ICorridasOnduladeiraEstudoEntity>
    {
        ...
        public DeleteCorridasOnduladeiraEstudoReceiver(
        ...
        protected override async Task<State<ICorridasOnduladeiraEstudoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteCorridasOnduladeiraEstudo", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteCorridasOnduladeiraEstudoReceiver), commandName: "Command.Write.CorridasOnduladeiraEstudoCrudCommand");
