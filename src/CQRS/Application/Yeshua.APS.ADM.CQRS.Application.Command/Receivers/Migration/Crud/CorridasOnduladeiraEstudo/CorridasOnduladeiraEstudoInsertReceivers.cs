...
{
    public class InsertCorridasOnduladeiraEstudoReceiver : ReciverBase<ICommand, ICorridasOnduladeiraEstudoEntity>
    {
        ...
        public InsertCorridasOnduladeiraEstudoReceiver(
        ...
        protected override async Task<State<ICorridasOnduladeiraEstudoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Insert(corridasonduladeiraestudo);
