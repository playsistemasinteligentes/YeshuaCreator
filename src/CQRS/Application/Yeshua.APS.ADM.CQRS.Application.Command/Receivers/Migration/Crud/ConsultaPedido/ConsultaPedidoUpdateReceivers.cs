...
{
    public class UpdateConsultaPedidoReceiver : ReciverBase<ICommand, IConsultaPedidoEntity>
    {
        ...
        public UpdateConsultaPedidoReceiver(
        ...
        protected override async Task<State<IConsultaPedidoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateConsultaPedido", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateConsultaPedidoReceiver), commandName: "Command.Write.ConsultaPedidoCrudCommand");
