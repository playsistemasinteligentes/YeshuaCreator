...
{
    public class InsertPoliticaOnduladeiraReceiver : ReciverBase<ICommand, IPoliticaOnduladeiraEntity>
    {
        ...
        public InsertPoliticaOnduladeiraReceiver(
        ...
        protected override async Task<State<IPoliticaOnduladeiraEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertPoliticaOnduladeira", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertPoliticaOnduladeiraReceiver), commandName: "Command.Write.PoliticaOnduladeiraCrudCommand");
