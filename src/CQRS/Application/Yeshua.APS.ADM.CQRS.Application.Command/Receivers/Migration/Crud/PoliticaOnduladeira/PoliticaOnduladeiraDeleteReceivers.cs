...
{
    public class DeletePoliticaOnduladeiraReceiver : ReciverBase<ICommand, IPoliticaOnduladeiraEntity>
    {
        ...
        public DeletePoliticaOnduladeiraReceiver(
        ...
        protected override async Task<State<IPoliticaOnduladeiraEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Delete(politicaonduladeira);
