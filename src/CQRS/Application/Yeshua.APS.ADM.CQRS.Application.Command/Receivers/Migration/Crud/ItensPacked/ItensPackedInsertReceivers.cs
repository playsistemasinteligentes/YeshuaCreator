...
{
    public class InsertItensPackedReceiver : ReciverBase<ICommand, IItensPackedEntity>
    {
        ...
        public InsertItensPackedReceiver(
        ...
        protected override async Task<State<IItensPackedEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertItensPacked", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertItensPackedReceiver), commandName: "Command.Write.ItensPackedCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(itenspacked);
