...
{
    public class DeleteItemInspecaoReceiver : ReciverBase<ICommand, IItemInspecaoEntity>
    {
        ...
        public DeleteItemInspecaoReceiver(
        ...
        protected override async Task<State<IItemInspecaoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteItemInspecao", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteItemInspecaoReceiver), commandName: "Command.Write.ItemInspecaoCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(iteminspecao);
