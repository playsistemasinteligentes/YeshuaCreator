...
{
    public class InsertObjetoControlavelReceiver : ReciverBase<ICommand, IObjetoControlavelEntity>
    {
        ...
        public InsertObjetoControlavelReceiver(
        ...
        protected override Task<State<IObjetoControlavelEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertObjetoControlavel", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertObjetoControlavelReceiver), commandName: "Command.Write.ObjetoControlavelCrudCommand");
                 ...
                 System.Diagnostics.Activity.Current?.SetTag("yeshua.operational_entity_id", objetocontrolavel.OperationalEntityId);
                 ...
                 try
                 {
                     _repository.Insert(objetocontrolavel);
