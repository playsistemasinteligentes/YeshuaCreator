...
{
    public class UpdateT_MedicoesReceiver : ReciverBase<ICommand, IT_MedicoesEntity>
    {
        ...
        public UpdateT_MedicoesReceiver(
        ...
        protected override async Task<State<IT_MedicoesEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateT_Medicoes", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateT_MedicoesReceiver), commandName: "Command.Write.T_MedicoesCrudCommand");
