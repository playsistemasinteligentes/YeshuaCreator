...
{
    public class DeleteCorridasOnduladeiraReceiver : ReciverBase<ICommand, ICorridasOnduladeiraEntity>
    {
        ...
        public DeleteCorridasOnduladeiraReceiver(
        ...
        protected override Task<State<ICorridasOnduladeiraEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteCorridasOnduladeira", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteCorridasOnduladeiraReceiver), commandName: "Command.Write.CorridasOnduladeiraCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(corridasonduladeira);
