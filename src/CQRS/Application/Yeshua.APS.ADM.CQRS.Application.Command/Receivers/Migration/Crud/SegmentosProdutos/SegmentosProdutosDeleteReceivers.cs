...
{
    public class DeleteSegmentosProdutosReceiver : ReciverBase<ICommand, ISegmentosProdutosEntity>
    {
        ...
        public DeleteSegmentosProdutosReceiver(
        ...
        protected override Task<State<ISegmentosProdutosEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteSegmentosProdutos", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteSegmentosProdutosReceiver), commandName: "Command.Write.SegmentosProdutosCrudCommand");
                 ...
                 System.Diagnostics.Activity.Current?.SetTag("yeshua.operational_entity_id", segmentosprodutos.OperationalEntityId);
                 ...
                 try
                 {
                     _repository.Delete(segmentosprodutos);
