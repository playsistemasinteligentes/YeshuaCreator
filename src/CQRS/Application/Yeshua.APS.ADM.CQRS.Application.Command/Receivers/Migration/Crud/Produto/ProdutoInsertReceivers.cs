...
{
    public class InsertProdutoReceiver : ReciverBase<ICommand, IProdutoEntity>
    {
        ...
        protected override Task<State<IProdutoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertProduto", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertProdutoReceiver), commandName: "Command.Write.ProdutoCrudCommand");
