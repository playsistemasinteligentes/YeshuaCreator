...
{
    public class InsertT_AGENDA_SCHEDULEReceiver : ReciverBase<ICommand, IT_AGENDA_SCHEDULEEntity>
    {
        ...
        public InsertT_AGENDA_SCHEDULEReceiver(
        ...
        protected override async Task<State<IT_AGENDA_SCHEDULEEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertT_AGENDA_SCHEDULE", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertT_AGENDA_SCHEDULEReceiver), commandName: "Command.Write.T_AGENDA_SCHEDULECrudCommand");
