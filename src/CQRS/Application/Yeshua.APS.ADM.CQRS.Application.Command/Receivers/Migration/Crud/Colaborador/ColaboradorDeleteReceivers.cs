...
{
    public class DeleteColaboradorReceiver : ReciverBase<ICommand, IColaboradorEntity>
    {
        ...
        public DeleteColaboradorReceiver(
        ...
        protected override async Task<State<IColaboradorEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteColaborador", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteColaboradorReceiver), commandName: "Command.Write.ColaboradorCrudCommand");
