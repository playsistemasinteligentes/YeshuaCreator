...
{
    public class UpdateEquipeReceiver : ReciverBase<ICommand, IEquipeEntity>
    {
        ...
        protected override Task<State<IEquipeEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateEquipe", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateEquipeReceiver), commandName: "Command.Write.EquipeCrudCommand");
