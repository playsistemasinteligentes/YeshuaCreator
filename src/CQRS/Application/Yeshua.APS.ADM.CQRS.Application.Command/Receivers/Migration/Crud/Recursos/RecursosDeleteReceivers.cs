...
{
    public class DeleteRecursosReceiver : ReciverBase<ICommand, IRecursosEntity>
    {
        ...
        protected override async Task<State<IRecursosEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteRecursos", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteRecursosReceiver), commandName: "Command.Write.RecursosCrudCommand");
