...
{
    public class UpdateRecursosReceiver : ReciverBase<ICommand, IRecursosEntity>
    {
        ...
        protected override async Task<State<IRecursosEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateRecursos", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateRecursosReceiver), commandName: "Command.Write.RecursosCrudCommand");
