...
{
    public class InsertPlanoacaoReceiver : ReciverBase<ICommand, IPlanoacaoEntity>
    {
        ...
        public InsertPlanoacaoReceiver(
        ...
        protected override async Task<State<IPlanoacaoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertPlanoacao", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertPlanoacaoReceiver), commandName: "Command.Write.PlanoacaoCrudCommand");
