...
{
    public class UpdatePendenciasInterfaceReceiver : ReciverBase<ICommand, IPendenciasInterfaceEntity>
    {
        ...
        public UpdatePendenciasInterfaceReceiver(
        ...
        protected override async Task<State<IPendenciasInterfaceEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdatePendenciasInterface", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdatePendenciasInterfaceReceiver), commandName: "Command.Write.PendenciasInterfaceCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(pendenciasinterface);
