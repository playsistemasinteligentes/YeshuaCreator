...
{
    public class UpdateCorConfiguracaoGraficoReceiver : ReciverBase<ICommand, ICorConfiguracaoGraficoEntity>
    {
        ...
        public UpdateCorConfiguracaoGraficoReceiver(
        ...
        protected override async Task<State<ICorConfiguracaoGraficoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateCorConfiguracaoGrafico", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateCorConfiguracaoGraficoReceiver), commandName: "Command.Write.CorConfiguracaoGraficoCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(corconfiguracaografico);
