...
{
    public class UpdateCondicaoPagamentoReceiver : ReciverBase<ICommand, ICondicaoPagamentoEntity>
    {
        ...
        public UpdateCondicaoPagamentoReceiver(
        ...
        protected override async Task<State<ICondicaoPagamentoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Update(condicaopagamento);
