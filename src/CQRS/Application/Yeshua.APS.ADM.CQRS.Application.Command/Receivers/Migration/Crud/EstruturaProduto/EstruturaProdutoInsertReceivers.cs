...
{
    public class InsertEstruturaProdutoReceiver : ReciverBase<ICommand, IEstruturaProdutoEntity>
    {
        ...
        public InsertEstruturaProdutoReceiver(
        ...
        protected override async Task<State<IEstruturaProdutoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Insert(estruturaproduto);
