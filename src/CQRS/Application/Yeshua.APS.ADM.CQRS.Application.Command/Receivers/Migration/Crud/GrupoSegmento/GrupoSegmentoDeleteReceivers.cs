...
{
    public class DeleteGrupoSegmentoReceiver : ReciverBase<ICommand, IGrupoSegmentoEntity>
    {
        ...
        public DeleteGrupoSegmentoReceiver(
        ...
        protected override Task<State<IGrupoSegmentoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteGrupoSegmento", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteGrupoSegmentoReceiver), commandName: "Command.Write.GrupoSegmentoCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(gruposegmento);
