...
{
    public class UpdateTesteFisicoReceiver : ReciverBase<ICommand, ITesteFisicoEntity>
    {
        ...
        public UpdateTesteFisicoReceiver(
        ...
        protected override async Task<State<ITesteFisicoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateTesteFisico", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateTesteFisicoReceiver), commandName: "Command.Write.TesteFisicoCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(testefisico);
