...
{
    public class InsertOpcaoPlanejamentoTransporteReceiver : ReciverBase<ICommand, IOpcaoPlanejamentoTransporteEntity>
    {
        ...
        public InsertOpcaoPlanejamentoTransporteReceiver(
        ...
        protected override async Task<State<IOpcaoPlanejamentoTransporteEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertOpcaoPlanejamentoTransporte", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertOpcaoPlanejamentoTransporteReceiver), commandName: "Command.Write.OpcaoPlanejamentoTransporteCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(opcaoplanejamentotransporte);
