...
{
    public class UpdateLaudoTesteFisicoReceiver : ReciverBase<ICommand, ILaudoTesteFisicoEntity>
    {
        ...
        public UpdateLaudoTesteFisicoReceiver(
        ...
        protected override async Task<State<ILaudoTesteFisicoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateLaudoTesteFisico", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateLaudoTesteFisicoReceiver), commandName: "Command.Write.LaudoTesteFisicoCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(laudotestefisico);
