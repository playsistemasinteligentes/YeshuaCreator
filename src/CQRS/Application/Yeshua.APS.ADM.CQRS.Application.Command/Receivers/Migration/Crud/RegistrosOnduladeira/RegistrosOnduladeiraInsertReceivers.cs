...
{
    public class InsertRegistrosOnduladeiraReceiver : ReciverBase<ICommand, IRegistrosOnduladeiraEntity>
    {
        ...
        public InsertRegistrosOnduladeiraReceiver(
        ...
        protected override async Task<State<IRegistrosOnduladeiraEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertRegistrosOnduladeira", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertRegistrosOnduladeiraReceiver), commandName: "Command.Write.RegistrosOnduladeiraCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(registrosonduladeira);
