...
{
    public class InsertPlanoAmostralTesteReceiver : ReciverBase<ICommand, IPlanoAmostralTesteEntity>
    {
        ...
        public InsertPlanoAmostralTesteReceiver(
        ...
        protected override async Task<State<IPlanoAmostralTesteEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertPlanoAmostralTeste", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertPlanoAmostralTesteReceiver), commandName: "Command.Write.PlanoAmostralTesteCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(planoamostralteste);
