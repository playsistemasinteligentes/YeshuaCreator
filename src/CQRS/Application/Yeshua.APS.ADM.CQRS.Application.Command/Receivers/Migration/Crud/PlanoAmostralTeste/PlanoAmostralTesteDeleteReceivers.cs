...
{
    public class DeletePlanoAmostralTesteReceiver : ReciverBase<ICommand, IPlanoAmostralTesteEntity>
    {
        ...
        public DeletePlanoAmostralTesteReceiver(
        ...
        protected override async Task<State<IPlanoAmostralTesteEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeletePlanoAmostralTeste", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeletePlanoAmostralTesteReceiver), commandName: "Command.Write.PlanoAmostralTesteCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(planoamostralteste);
