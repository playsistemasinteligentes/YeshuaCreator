...
{
    public class InsertTemplatesMaquinasReceiver : ReciverBase<ICommand, ITemplatesMaquinasEntity>
    {
        ...
        public InsertTemplatesMaquinasReceiver(
        ...
        protected override async Task<State<ITemplatesMaquinasEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Insert(templatesmaquinas);
