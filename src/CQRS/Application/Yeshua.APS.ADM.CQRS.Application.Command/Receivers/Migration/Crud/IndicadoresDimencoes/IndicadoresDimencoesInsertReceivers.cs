...
{
    public class InsertIndicadoresDimencoesReceiver : ReciverBase<ICommand, IIndicadoresDimencoesEntity>
    {
        ...
        public InsertIndicadoresDimencoesReceiver(
        ...
        protected override async Task<State<IIndicadoresDimencoesEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertIndicadoresDimencoes", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertIndicadoresDimencoesReceiver), commandName: "Command.Write.IndicadoresDimencoesCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(indicadoresdimencoes);
