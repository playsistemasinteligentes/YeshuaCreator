...
{
    public class DeleteIndicadoresDimencoesReceiver : ReciverBase<ICommand, IIndicadoresDimencoesEntity>
    {
        ...
        public DeleteIndicadoresDimencoesReceiver(
        ...
        protected override async Task<State<IIndicadoresDimencoesEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Delete(indicadoresdimencoes);
