...
{
    public class UpdateTemposLogisticosReceiver : ReciverBase<ICommand, ITemposLogisticosEntity>
    {
        ...
        public UpdateTemposLogisticosReceiver(
        ...
        protected override async Task<State<ITemposLogisticosEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Update(temposlogisticos);
