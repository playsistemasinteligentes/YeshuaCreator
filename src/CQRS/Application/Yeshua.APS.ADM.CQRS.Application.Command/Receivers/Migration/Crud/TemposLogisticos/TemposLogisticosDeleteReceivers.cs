...
{
    public class DeleteTemposLogisticosReceiver : ReciverBase<ICommand, ITemposLogisticosEntity>
    {
        ...
        public DeleteTemposLogisticosReceiver(
        ...
        protected override async Task<State<ITemposLogisticosEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteTemposLogisticos", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteTemposLogisticosReceiver), commandName: "Command.Write.TemposLogisticosCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(temposlogisticos);
