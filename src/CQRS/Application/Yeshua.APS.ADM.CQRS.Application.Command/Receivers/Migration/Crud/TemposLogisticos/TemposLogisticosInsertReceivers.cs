...
{
    public class InsertTemposLogisticosReceiver : ReciverBase<ICommand, ITemposLogisticosEntity>
    {
        private readonly ITemposLogisticosWriteRepository _repository;
        private readonly ILogger _logger;
        private readonly IDomainTrackingPolicy _domainTrackingPolicy;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public InsertTemposLogisticosReceiver(
            ITemposLogisticosWriteRepository repository,
        ...
        protected override async Task<State<ITemposLogisticosEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertTemposLogisticos", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertTemposLogisticosReceiver), commandName: "Command.Write.TemposLogisticosCrudCommand");
