...
{
    public class DeleteInspecaoVisualReceiver : ReciverBase<ICommand, IInspecaoVisualEntity>
    {
        ...
        public DeleteInspecaoVisualReceiver(
        ...
        protected override async Task<State<IInspecaoVisualEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteInspecaoVisual", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteInspecaoVisualReceiver), commandName: "Command.Write.InspecaoVisualCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(inspecaovisual);
