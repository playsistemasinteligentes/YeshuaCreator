...
{
    public class InsertInspecaoVisualReceiver : ReciverBase<ICommand, IInspecaoVisualEntity>
    {
        ...
        public InsertInspecaoVisualReceiver(
        ...
        protected override async Task<State<IInspecaoVisualEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertInspecaoVisual", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertInspecaoVisualReceiver), commandName: "Command.Write.InspecaoVisualCrudCommand");
