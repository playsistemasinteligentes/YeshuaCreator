...
{
    public class InsertFilaProducaoReceiver : ReciverBase<ICommand, IFilaProducaoEntity>
    {
        ...
        public InsertFilaProducaoReceiver(
        ...
        protected override Task<State<IFilaProducaoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertFilaProducao", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertFilaProducaoReceiver), commandName: "Command.Write.FilaProducaoCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(filaproducao);
