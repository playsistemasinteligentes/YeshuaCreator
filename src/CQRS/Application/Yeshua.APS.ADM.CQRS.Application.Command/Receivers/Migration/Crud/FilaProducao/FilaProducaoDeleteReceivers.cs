...
{
    public class DeleteFilaProducaoReceiver : ReciverBase<ICommand, IFilaProducaoEntity>
    {
        ...
        public DeleteFilaProducaoReceiver(
        ...
        protected override Task<State<IFilaProducaoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteFilaProducao", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteFilaProducaoReceiver), commandName: "Command.Write.FilaProducaoCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(filaproducao);
