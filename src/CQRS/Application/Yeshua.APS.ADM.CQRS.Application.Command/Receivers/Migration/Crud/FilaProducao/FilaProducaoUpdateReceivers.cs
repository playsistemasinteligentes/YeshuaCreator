...
{
    public class UpdateFilaProducaoReceiver : ReciverBase<ICommand, IFilaProducaoEntity>
    {
        private readonly IFilaProducaoWriteRepository _repository;
        private readonly ILogger _logger;
        private readonly IDomainTrackingPolicy _domainTrackingPolicy;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public UpdateFilaProducaoReceiver(
            IFilaProducaoWriteRepository repository,
