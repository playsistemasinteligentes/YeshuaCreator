...
namespace Command.Receivers.Write
{
    public class UpdateFilaProducaoReceiver : ReciverBase<ICommand, IFilaProducaoEntity>
    {
        ...
        protected override async Task<State<IFilaProducaoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     ...
                     return Success("OK", filaproducao);
                 }
                 catch (Exception e)
                 {
                    return Error(e, filaproducao);
                 }
            }
            else 
            {
