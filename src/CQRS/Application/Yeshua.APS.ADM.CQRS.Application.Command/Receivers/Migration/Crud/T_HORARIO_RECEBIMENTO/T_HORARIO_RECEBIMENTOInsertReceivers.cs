...
{
    public class InsertT_HORARIO_RECEBIMENTOReceiver : ReciverBase<ICommand, IT_HORARIO_RECEBIMENTOEntity>
    {
        ...
        public InsertT_HORARIO_RECEBIMENTOReceiver(
        ...
        protected override async Task<State<IT_HORARIO_RECEBIMENTOEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertT_HORARIO_RECEBIMENTO", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertT_HORARIO_RECEBIMENTOReceiver), commandName: "Command.Write.T_HORARIO_RECEBIMENTOCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(t_horario_recebimento);
