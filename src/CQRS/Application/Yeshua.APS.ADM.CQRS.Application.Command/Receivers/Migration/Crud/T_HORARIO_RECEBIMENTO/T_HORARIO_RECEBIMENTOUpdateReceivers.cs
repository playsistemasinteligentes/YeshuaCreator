...
{
    public class UpdateT_HORARIO_RECEBIMENTOReceiver : ReciverBase<ICommand, IT_HORARIO_RECEBIMENTOEntity>
    {
        ...
        public UpdateT_HORARIO_RECEBIMENTOReceiver(
        ...
        protected override async Task<State<IT_HORARIO_RECEBIMENTOEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateT_HORARIO_RECEBIMENTO", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateT_HORARIO_RECEBIMENTOReceiver), commandName: "Command.Write.T_HORARIO_RECEBIMENTOCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(t_horario_recebimento);
