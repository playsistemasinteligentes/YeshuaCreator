...
{
    public class InsertProtocoloOnduladeiraReceiver : ReciverBase<ICommand, IProtocoloOnduladeiraEntity>
    {
        ...
        public InsertProtocoloOnduladeiraReceiver(
        ...
        protected override async Task<State<IProtocoloOnduladeiraEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertProtocoloOnduladeira", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertProtocoloOnduladeiraReceiver), commandName: "Command.Write.ProtocoloOnduladeiraCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(protocoloonduladeira);
