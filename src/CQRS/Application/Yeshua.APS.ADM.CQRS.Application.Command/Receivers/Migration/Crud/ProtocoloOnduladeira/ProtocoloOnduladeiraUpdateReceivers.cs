...
{
    public class UpdateProtocoloOnduladeiraReceiver : ReciverBase<ICommand, IProtocoloOnduladeiraEntity>
    {
        ...
        public UpdateProtocoloOnduladeiraReceiver(
        ...
        protected override async Task<State<IProtocoloOnduladeiraEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Update(protocoloonduladeira);
