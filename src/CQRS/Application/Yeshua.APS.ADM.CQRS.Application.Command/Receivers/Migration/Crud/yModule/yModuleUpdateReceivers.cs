...
namespace Command.Receivers.Write
{
    public class UpdateyModuleReceiver : ReciverBase<ICommand, IyModuleEntity>
    {
        ...
        protected override Task<State<IyModuleEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateyModule", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateyModuleReceiver), commandName: "Command.Write.yModuleCrudCommand");
