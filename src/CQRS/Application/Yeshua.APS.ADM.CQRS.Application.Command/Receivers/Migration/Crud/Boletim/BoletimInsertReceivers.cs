...
{
    public class InsertBoletimReceiver : ReciverBase<ICommand, IBoletimEntity>
    {
        ...
        protected override Task<State<IBoletimEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertBoletim", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertBoletimReceiver), commandName: "Command.Write.BoletimCrudCommand");
