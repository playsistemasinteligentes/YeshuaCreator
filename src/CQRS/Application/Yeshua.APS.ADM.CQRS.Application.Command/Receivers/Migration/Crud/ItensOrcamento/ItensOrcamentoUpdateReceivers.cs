...
{
    public class UpdateItensOrcamentoReceiver : ReciverBase<ICommand, IItensOrcamentoEntity>
    {
        ...
        public UpdateItensOrcamentoReceiver(
        ...
        protected override async Task<State<IItensOrcamentoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Update(itensorcamento);
