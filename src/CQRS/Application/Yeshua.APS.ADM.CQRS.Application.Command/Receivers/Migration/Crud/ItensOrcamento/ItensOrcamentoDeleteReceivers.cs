...
{
    public class DeleteItensOrcamentoReceiver : ReciverBase<ICommand, IItensOrcamentoEntity>
    {
        ...
        public DeleteItensOrcamentoReceiver(
        ...
        protected override async Task<State<IItensOrcamentoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteItensOrcamento", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteItensOrcamentoReceiver), commandName: "Command.Write.ItensOrcamentoCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(itensorcamento);
