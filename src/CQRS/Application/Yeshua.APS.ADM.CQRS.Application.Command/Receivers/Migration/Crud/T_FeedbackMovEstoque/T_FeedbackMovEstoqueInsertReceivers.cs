...
{
    public class InsertT_FeedbackMovEstoqueReceiver : ReciverBase<ICommand, IT_FeedbackMovEstoqueEntity>
    {
        ...
        public InsertT_FeedbackMovEstoqueReceiver(
        ...
        protected override async Task<State<IT_FeedbackMovEstoqueEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Insert(t_feedbackmovestoque);
