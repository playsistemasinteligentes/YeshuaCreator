...
{
    public class DeleteCompensacaoReceiver : ReciverBase<ICommand, ICompensacaoEntity>
    {
        ...
        public DeleteCompensacaoReceiver(
        ...
        protected override async Task<State<ICompensacaoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteCompensacao", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteCompensacaoReceiver), commandName: "Command.Write.CompensacaoCrudCommand");
