...
{
    public class DeleteTipoTesteReceiver : ReciverBase<ICommand, ITipoTesteEntity>
    {
        ...
        public DeleteTipoTesteReceiver(
        ...
        protected override async Task<State<ITipoTesteEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteTipoTeste", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteTipoTesteReceiver), commandName: "Command.Write.TipoTesteCrudCommand");
