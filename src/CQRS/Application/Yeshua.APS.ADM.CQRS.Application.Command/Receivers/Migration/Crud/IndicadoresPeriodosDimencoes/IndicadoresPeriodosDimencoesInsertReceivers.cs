...
{
    public class InsertIndicadoresPeriodosDimencoesReceiver : ReciverBase<ICommand, IIndicadoresPeriodosDimencoesEntity>
    {
        ...
        public InsertIndicadoresPeriodosDimencoesReceiver(
        ...
        protected override async Task<State<IIndicadoresPeriodosDimencoesEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertIndicadoresPeriodosDimencoes", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertIndicadoresPeriodosDimencoesReceiver), commandName: "Command.Write.IndicadoresPeriodosDimencoesCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(indicadoresperiodosdimencoes);
