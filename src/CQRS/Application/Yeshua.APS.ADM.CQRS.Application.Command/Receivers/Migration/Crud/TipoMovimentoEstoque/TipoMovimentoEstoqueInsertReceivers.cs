...
{
    public class InsertTipoMovimentoEstoqueReceiver : ReciverBase<ICommand, ITipoMovimentoEstoqueEntity>
    {
        ...
        public InsertTipoMovimentoEstoqueReceiver(
        ...
        protected override Task<State<ITipoMovimentoEstoqueEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertTipoMovimentoEstoque", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertTipoMovimentoEstoqueReceiver), commandName: "Command.Write.TipoMovimentoEstoqueCrudCommand");
                 ...
                 System.Diagnostics.Activity.Current?.SetTag("yeshua.operational_entity_id", tipomovimentoestoque.OperationalEntityId);
                 ...
                 try
                 {
                     _repository.Insert(tipomovimentoestoque);
