...
{
    public class InsertT_PREFERENCIASReceiver : ReciverBase<ICommand, IT_PREFERENCIASEntity>
    {
        ...
        public InsertT_PREFERENCIASReceiver(
        ...
        protected override async Task<State<IT_PREFERENCIASEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertT_PREFERENCIAS", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertT_PREFERENCIASReceiver), commandName: "Command.Write.T_PREFERENCIASCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(t_preferencias);
