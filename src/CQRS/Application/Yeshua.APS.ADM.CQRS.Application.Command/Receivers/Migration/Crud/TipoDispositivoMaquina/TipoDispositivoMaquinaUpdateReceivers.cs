...
{
    public class UpdateTipoDispositivoMaquinaReceiver : ReciverBase<ICommand, ITipoDispositivoMaquinaEntity>
    {
        ...
        public UpdateTipoDispositivoMaquinaReceiver(
        ...
        protected override Task<State<ITipoDispositivoMaquinaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateTipoDispositivoMaquina", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateTipoDispositivoMaquinaReceiver), commandName: "Command.Write.TipoDispositivoMaquinaCrudCommand");
                 ...
                 System.Diagnostics.Activity.Current?.SetTag("yeshua.operational_entity_id", tipodispositivomaquina.OperationalEntityId);
                 ...
                 try
                 {
                     _repository.Update(tipodispositivomaquina);
