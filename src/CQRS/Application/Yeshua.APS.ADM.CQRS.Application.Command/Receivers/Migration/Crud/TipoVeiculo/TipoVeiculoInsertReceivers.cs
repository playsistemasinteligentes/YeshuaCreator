...
{
    public class InsertTipoVeiculoReceiver : ReciverBase<ICommand, ITipoVeiculoEntity>
    {
        ...
        public InsertTipoVeiculoReceiver(
        ...
        protected override async Task<State<ITipoVeiculoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertTipoVeiculo", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertTipoVeiculoReceiver), commandName: "Command.Write.TipoVeiculoCrudCommand");
