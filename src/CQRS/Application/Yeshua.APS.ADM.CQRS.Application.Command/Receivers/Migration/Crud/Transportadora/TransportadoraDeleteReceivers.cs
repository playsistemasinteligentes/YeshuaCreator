...
{
    public class DeleteTransportadoraReceiver : ReciverBase<ICommand, ITransportadoraEntity>
    {
        ...
        public DeleteTransportadoraReceiver(
        ...
        protected override async Task<State<ITransportadoraEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Delete(transportadora);
