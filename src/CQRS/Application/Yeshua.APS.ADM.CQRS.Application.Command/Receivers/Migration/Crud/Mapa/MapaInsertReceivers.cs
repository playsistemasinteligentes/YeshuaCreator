...
{
    public class InsertMapaReceiver : ReciverBase<ICommand, IMapaEntity>
    {
        ...
        protected override async Task<State<IMapaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertMapa", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertMapaReceiver), commandName: "Command.Write.MapaCrudCommand");
