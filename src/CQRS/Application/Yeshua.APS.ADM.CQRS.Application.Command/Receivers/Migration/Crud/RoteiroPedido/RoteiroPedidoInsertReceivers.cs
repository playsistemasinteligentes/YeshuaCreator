...
{
    public class InsertRoteiroPedidoReceiver : ReciverBase<ICommand, IRoteiroPedidoEntity>
    {
        ...
        public InsertRoteiroPedidoReceiver(
        ...
        protected override Task<State<IRoteiroPedidoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertRoteiroPedido", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertRoteiroPedidoReceiver), commandName: "Command.Write.RoteiroPedidoCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(roteiropedido);
