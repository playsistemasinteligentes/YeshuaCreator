...
{
    public class UpdateTipoDispositivoReceiver : ReciverBase<ICommand, ITipoDispositivoEntity>
    {
        ...
        public UpdateTipoDispositivoReceiver(
        ...
        protected override Task<State<ITipoDispositivoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateTipoDispositivo", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateTipoDispositivoReceiver), commandName: "Command.Write.TipoDispositivoCrudCommand");
                 ...
                 System.Diagnostics.Activity.Current?.SetTag("yeshua.operational_entity_id", tipodispositivo.OperationalEntityId);
                 ...
                 try
                 {
                     _repository.Update(tipodispositivo);
