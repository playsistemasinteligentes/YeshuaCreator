...
{
    public class DeleteTempoSetupOnduladeiraReceiver : ReciverBase<ICommand, ITempoSetupOnduladeiraEntity>
    {
        ...
        public DeleteTempoSetupOnduladeiraReceiver(
        ...
        protected override async Task<State<ITempoSetupOnduladeiraEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteTempoSetupOnduladeira", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteTempoSetupOnduladeiraReceiver), commandName: "Command.Write.TempoSetupOnduladeiraCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(temposetuponduladeira);
