...
{
    public class UpdateTempoSetupOnduladeiraReceiver : ReciverBase<ICommand, ITempoSetupOnduladeiraEntity>
    {
        ...
        public UpdateTempoSetupOnduladeiraReceiver(
        ...
        protected override async Task<State<ITempoSetupOnduladeiraEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateTempoSetupOnduladeira", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateTempoSetupOnduladeiraReceiver), commandName: "Command.Write.TempoSetupOnduladeiraCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(temposetuponduladeira);
