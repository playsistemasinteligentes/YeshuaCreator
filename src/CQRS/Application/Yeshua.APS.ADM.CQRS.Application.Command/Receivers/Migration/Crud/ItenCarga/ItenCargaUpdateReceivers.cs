...
{
    public class UpdateItenCargaReceiver : ReciverBase<ICommand, IItenCargaEntity>
    {
        ...
        public UpdateItenCargaReceiver(
        ...
        protected override async Task<State<IItenCargaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateItenCarga", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateItenCargaReceiver), commandName: "Command.Write.ItenCargaCrudCommand");
