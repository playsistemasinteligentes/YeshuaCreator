...
{
    public class InsertCargaPrevistaReceiver : ReciverBase<ICommand, ICargaPrevistaEntity>
    {
        ...
        public InsertCargaPrevistaReceiver(
        ...
        protected override Task<State<ICargaPrevistaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertCargaPrevista", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertCargaPrevistaReceiver), commandName: "Command.Write.CargaPrevistaCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(cargaprevista);
