...
{
    public class InsertItemTestavelReceiver : ReciverBase<ICommand, IItemTestavelEntity>
    {
        ...
        public InsertItemTestavelReceiver(
        ...
        protected override async Task<State<IItemTestavelEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertItemTestavel", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertItemTestavelReceiver), commandName: "Command.Write.ItemTestavelCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(itemtestavel);
