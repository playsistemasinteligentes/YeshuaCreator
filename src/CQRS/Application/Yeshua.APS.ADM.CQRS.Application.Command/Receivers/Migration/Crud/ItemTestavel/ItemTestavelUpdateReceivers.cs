...
{
    public class UpdateItemTestavelReceiver : ReciverBase<ICommand, IItemTestavelEntity>
    {
        private readonly IItemTestavelWriteRepository _repository;
        private readonly ILogger _logger;
        private readonly IDomainTrackingPolicy _domainTrackingPolicy;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public UpdateItemTestavelReceiver(
            IItemTestavelWriteRepository repository,
        ...
        protected override async Task<State<IItemTestavelEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateItemTestavel", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateItemTestavelReceiver), commandName: "Command.Write.ItemTestavelCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(itemtestavel);
