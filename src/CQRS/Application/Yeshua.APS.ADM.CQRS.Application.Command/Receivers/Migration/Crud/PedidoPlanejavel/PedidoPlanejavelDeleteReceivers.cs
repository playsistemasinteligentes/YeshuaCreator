...
{
    public class DeletePedidoPlanejavelReceiver : ReciverBase<ICommand, IPedidoPlanejavelEntity>
    {
        ...
        public DeletePedidoPlanejavelReceiver(
        ...
        protected override async Task<State<IPedidoPlanejavelEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeletePedidoPlanejavel", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeletePedidoPlanejavelReceiver), commandName: "Command.Write.PedidoPlanejavelCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(pedidoplanejavel);
