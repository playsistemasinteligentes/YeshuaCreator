...
{
    public class DeletePerfilObjetoControlavelReceiver : ReciverBase<ICommand, IPerfilObjetoControlavelEntity>
    {
        ...
        public DeletePerfilObjetoControlavelReceiver(
        ...
        protected override Task<State<IPerfilObjetoControlavelEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Delete(perfilobjetocontrolavel);
