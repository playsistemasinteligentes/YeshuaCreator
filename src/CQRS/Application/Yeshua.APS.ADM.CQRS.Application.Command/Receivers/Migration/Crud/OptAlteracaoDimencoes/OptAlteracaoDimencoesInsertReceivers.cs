...
{
    public class InsertOptAlteracaoDimencoesReceiver : ReciverBase<ICommand, IOptAlteracaoDimencoesEntity>
    {
        ...
        public InsertOptAlteracaoDimencoesReceiver(
        ...
        protected override Task<State<IOptAlteracaoDimencoesEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Insert(optalteracaodimencoes);
                     return Task.FromResult(Success("OK", optalteracaodimencoes));
                 }
                 catch (Exception e)
                 {
                    return Task.FromResult(Error(e, optalteracaodimencoes));
                 }
            }
            else 
            {
