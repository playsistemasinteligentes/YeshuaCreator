...
{
    public class UpdateConsultasIndicadoresReceiver : ReciverBase<ICommand, IConsultasIndicadoresEntity>
    {
        ...
        public UpdateConsultasIndicadoresReceiver(
        ...
        protected override async Task<State<IConsultasIndicadoresEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Update(consultasindicadores);
