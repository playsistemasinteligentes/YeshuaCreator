...
{
    public class InsertItensEstruturaImpressaoReceiver : ReciverBase<ICommand, IItensEstruturaImpressaoEntity>
    {
        ...
        public InsertItensEstruturaImpressaoReceiver(
        ...
        protected override async Task<State<IItensEstruturaImpressaoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertItensEstruturaImpressao", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertItensEstruturaImpressaoReceiver), commandName: "Command.Write.ItensEstruturaImpressaoCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(itensestruturaimpressao);
