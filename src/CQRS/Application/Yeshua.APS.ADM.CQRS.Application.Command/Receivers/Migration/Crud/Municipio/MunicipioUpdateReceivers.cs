...
{
    public class UpdateMunicipioReceiver : ReciverBase<ICommand, IMunicipioEntity>
    {
        ...
        public UpdateMunicipioReceiver(
        ...
        protected override async Task<State<IMunicipioEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateMunicipio", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateMunicipioReceiver), commandName: "Command.Write.MunicipioCrudCommand");
