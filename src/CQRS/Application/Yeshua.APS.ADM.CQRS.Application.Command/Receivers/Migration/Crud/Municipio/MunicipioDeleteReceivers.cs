...
{
    public class DeleteMunicipioReceiver : ReciverBase<ICommand, IMunicipioEntity>
    {
        ...
        public DeleteMunicipioReceiver(
        ...
        protected override async Task<State<IMunicipioEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteMunicipio", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteMunicipioReceiver), commandName: "Command.Write.MunicipioCrudCommand");
