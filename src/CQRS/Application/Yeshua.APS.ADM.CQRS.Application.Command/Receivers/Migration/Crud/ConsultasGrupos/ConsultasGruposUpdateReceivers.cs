...
{
    public class UpdateConsultasGruposReceiver : ReciverBase<ICommand, IConsultasGruposEntity>
    {
        ...
        public UpdateConsultasGruposReceiver(
        ...
        protected override async Task<State<IConsultasGruposEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateConsultasGrupos", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateConsultasGruposReceiver), commandName: "Command.Write.ConsultasGruposCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(consultasgrupos);
