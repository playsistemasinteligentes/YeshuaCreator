...
{
    public class DeleteItenCalendarioDisponibilidadeVeiculosReceiver : ReciverBase<ICommand, IItenCalendarioDisponibilidadeVeiculosEntity>
    {
        ...
        public DeleteItenCalendarioDisponibilidadeVeiculosReceiver(
        ...
        protected override async Task<State<IItenCalendarioDisponibilidadeVeiculosEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteItenCalendarioDisponibilidadeVeiculos", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteItenCalendarioDisponibilidadeVeiculosReceiver), commandName: "Command.Write.ItenCalendarioDisponibilidadeVeiculosCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(itencalendariodisponibilidadeveiculos);
