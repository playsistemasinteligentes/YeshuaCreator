...
{
    public class UpdateItenCalendarioDisponibilidadeVeiculosReceiver : ReciverBase<ICommand, IItenCalendarioDisponibilidadeVeiculosEntity>
    {
        ...
        public UpdateItenCalendarioDisponibilidadeVeiculosReceiver(
        ...
        protected override async Task<State<IItenCalendarioDisponibilidadeVeiculosEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateItenCalendarioDisponibilidadeVeiculos", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateItenCalendarioDisponibilidadeVeiculosReceiver), commandName: "Command.Write.ItenCalendarioDisponibilidadeVeiculosCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(itencalendariodisponibilidadeveiculos);
