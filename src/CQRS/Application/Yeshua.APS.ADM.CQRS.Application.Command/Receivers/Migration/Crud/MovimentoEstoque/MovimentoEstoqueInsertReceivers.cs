...
{
    public class InsertMovimentoEstoqueReceiver : ReciverBase<ICommand, IMovimentoEstoqueEntity>
    {
        ...
        public InsertMovimentoEstoqueReceiver(
        ...
        protected override Task<State<IMovimentoEstoqueEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertMovimentoEstoque", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertMovimentoEstoqueReceiver), commandName: "Command.Write.MovimentoEstoqueCrudCommand");
                 ...
                 System.Diagnostics.Activity.Current?.SetTag("yeshua.operational_entity_id", movimentoestoque.OperationalEntityId);
