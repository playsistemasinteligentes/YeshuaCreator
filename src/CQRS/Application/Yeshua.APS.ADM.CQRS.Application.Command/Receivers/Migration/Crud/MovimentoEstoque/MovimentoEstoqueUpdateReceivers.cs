...
{
    public class UpdateMovimentoEstoqueReceiver : ReciverBase<ICommand, IMovimentoEstoqueEntity>
    {
        ...
        public UpdateMovimentoEstoqueReceiver(
        ...
        protected override Task<State<IMovimentoEstoqueEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateMovimentoEstoque", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateMovimentoEstoqueReceiver), commandName: "Command.Write.MovimentoEstoqueCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(movimentoestoque);
