...
{
    public class InsertEtiquetaReceiver : ReciverBase<ICommand, IEtiquetaEntity>
    {
        ...
        protected override async Task<State<IEtiquetaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertEtiqueta", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertEtiquetaReceiver), commandName: "Command.Write.EtiquetaCrudCommand");
