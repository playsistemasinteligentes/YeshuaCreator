...
{
    public class UpdateEtiquetaReceiver : ReciverBase<ICommand, IEtiquetaEntity>
    {
        ...
        protected override async Task<State<IEtiquetaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateEtiqueta", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateEtiquetaReceiver), commandName: "Command.Write.EtiquetaCrudCommand");
