...
{
    public class DeleteTurmaReceiver : ReciverBase<ICommand, ITurmaEntity>
    {
        ...
        protected override async Task<State<ITurmaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteTurma", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteTurmaReceiver), commandName: "Command.Write.TurmaCrudCommand");
