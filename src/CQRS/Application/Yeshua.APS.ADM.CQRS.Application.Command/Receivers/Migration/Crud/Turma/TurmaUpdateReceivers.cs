...
{
    public class UpdateTurmaReceiver : ReciverBase<ICommand, ITurmaEntity>
    {
        ...
        protected override async Task<State<ITurmaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateTurma", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateTurmaReceiver), commandName: "Command.Write.TurmaCrudCommand");
