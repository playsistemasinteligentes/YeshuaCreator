...
{
    public class DeleteExperienciaPlanejamentoTransporteReceiver : ReciverBase<ICommand, IExperienciaPlanejamentoTransporteEntity>
    {
        ...
        public DeleteExperienciaPlanejamentoTransporteReceiver(
        ...
        protected override async Task<State<IExperienciaPlanejamentoTransporteEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Delete(experienciaplanejamentotransporte);
