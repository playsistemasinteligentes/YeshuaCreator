...
{
    public class UpdateCalendarioReceiver : ReciverBase<ICommand, ICalendarioEntity>
    {
        ...
        public UpdateCalendarioReceiver(
        ...
        protected override async Task<State<ICalendarioEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateCalendario", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateCalendarioReceiver), commandName: "Command.Write.CalendarioCrudCommand");
