...
{
    public class InsertAuditoriaReceiver : ReciverBase<ICommand, IAuditoriaEntity>
    {
        ...
        public InsertAuditoriaReceiver(
        ...
        protected override async Task<State<IAuditoriaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertAuditoria", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertAuditoriaReceiver), commandName: "Command.Write.AuditoriaCrudCommand");
