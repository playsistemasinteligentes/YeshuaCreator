...
{
    public class DeleteAuditoriaReceiver : ReciverBase<ICommand, IAuditoriaEntity>
    {
        ...
        public DeleteAuditoriaReceiver(
        ...
        protected override async Task<State<IAuditoriaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteAuditoria", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteAuditoriaReceiver), commandName: "Command.Write.AuditoriaCrudCommand");
