...
{
    public class UpdateTipoInspecaoVisualReceiver : ReciverBase<ICommand, ITipoInspecaoVisualEntity>
    {
        ...
        public UpdateTipoInspecaoVisualReceiver(
        ...
        protected override async Task<State<ITipoInspecaoVisualEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Update(tipoinspecaovisual);
