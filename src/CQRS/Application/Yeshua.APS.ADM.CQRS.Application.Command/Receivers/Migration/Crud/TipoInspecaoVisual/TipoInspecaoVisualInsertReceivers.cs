...
{
    public class InsertTipoInspecaoVisualReceiver : ReciverBase<ICommand, ITipoInspecaoVisualEntity>
    {
        ...
        public InsertTipoInspecaoVisualReceiver(
        ...
        protected override async Task<State<ITipoInspecaoVisualEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertTipoInspecaoVisual", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertTipoInspecaoVisualReceiver), commandName: "Command.Write.TipoInspecaoVisualCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(tipoinspecaovisual);
