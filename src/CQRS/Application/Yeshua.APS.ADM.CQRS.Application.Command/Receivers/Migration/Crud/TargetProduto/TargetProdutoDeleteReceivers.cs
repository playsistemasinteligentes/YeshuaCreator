...
{
    public class DeleteTargetProdutoReceiver : ReciverBase<ICommand, ITargetProdutoEntity>
    {
        ...
        public DeleteTargetProdutoReceiver(
        ...
        protected override Task<State<ITargetProdutoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteTargetProduto", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteTargetProdutoReceiver), commandName: "Command.Write.TargetProdutoCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(targetproduto);
