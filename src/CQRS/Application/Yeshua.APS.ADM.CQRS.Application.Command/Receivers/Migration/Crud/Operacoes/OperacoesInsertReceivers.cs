...
{
    public class InsertOperacoesReceiver : ReciverBase<ICommand, IOperacoesEntity>
    {
        ...
        public InsertOperacoesReceiver(
        ...
        protected override async Task<State<IOperacoesEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertOperacoes", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertOperacoesReceiver), commandName: "Command.Write.OperacoesCrudCommand");
