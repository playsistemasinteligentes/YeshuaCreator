...
{
    public class InsertLoockReceiver : ReciverBase<ICommand, ILoockEntity>
    {
        ...
        protected override async Task<State<ILoockEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertLoock", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertLoockReceiver), commandName: "Command.Write.LoockCrudCommand");
