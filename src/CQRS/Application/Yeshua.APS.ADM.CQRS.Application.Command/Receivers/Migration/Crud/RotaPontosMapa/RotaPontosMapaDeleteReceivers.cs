...
{
    public class DeleteRotaPontosMapaReceiver : ReciverBase<ICommand, IRotaPontosMapaEntity>
    {
        ...
        public DeleteRotaPontosMapaReceiver(
        ...
        protected override async Task<State<IRotaPontosMapaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Delete(rotapontosmapa);
