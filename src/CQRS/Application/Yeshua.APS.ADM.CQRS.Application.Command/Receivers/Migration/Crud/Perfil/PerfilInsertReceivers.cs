...
{
    public class InsertPerfilReceiver : ReciverBase<ICommand, IPerfilEntity>
    {
        ...
        protected override async Task<State<IPerfilEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertPerfil", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertPerfilReceiver), commandName: "Command.Write.PerfilCrudCommand");
