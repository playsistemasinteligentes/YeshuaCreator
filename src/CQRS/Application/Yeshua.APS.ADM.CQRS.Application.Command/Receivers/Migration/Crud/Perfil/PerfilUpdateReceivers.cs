...
{
    public class UpdatePerfilReceiver : ReciverBase<ICommand, IPerfilEntity>
    {
        ...
        protected override async Task<State<IPerfilEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdatePerfil", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdatePerfilReceiver), commandName: "Command.Write.PerfilCrudCommand");
