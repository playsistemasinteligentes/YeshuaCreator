...
{
    public class UpdateRestricoesDeRodagemReceiver : ReciverBase<ICommand, IRestricoesDeRodagemEntity>
    {
        ...
        public UpdateRestricoesDeRodagemReceiver(
        ...
        protected override async Task<State<IRestricoesDeRodagemEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateRestricoesDeRodagem", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateRestricoesDeRodagemReceiver), commandName: "Command.Write.RestricoesDeRodagemCrudCommand");
