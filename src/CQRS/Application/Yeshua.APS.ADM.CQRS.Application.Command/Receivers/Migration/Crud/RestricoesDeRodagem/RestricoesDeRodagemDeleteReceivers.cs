...
{
    public class DeleteRestricoesDeRodagemReceiver : ReciverBase<ICommand, IRestricoesDeRodagemEntity>
    {
        ...
        public DeleteRestricoesDeRodagemReceiver(
        ...
        protected override async Task<State<IRestricoesDeRodagemEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Delete(restricoesderodagem);
