...
{
    public class InsertFilaProducaoPrevistaReceiver : ReciverBase<ICommand, IFilaProducaoPrevistaEntity>
    {
        ...
        public InsertFilaProducaoPrevistaReceiver(
        ...
        protected override Task<State<IFilaProducaoPrevistaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             if(comand is Command.Write.FilaProducaoPrevistaCrudCommand c) 
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertFilaProducaoPrevista", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertFilaProducaoPrevistaReceiver), commandName: "Command.Write.FilaProducaoPrevistaCrudCommand");
                 ...
                 System.Diagnostics.Activity.Current?.SetTag("yeshua.operational_entity_id", filaproducaoprevista.OperationalEntityId);
                 ...
                 try
                 {
                     _repository.Insert(filaproducaoprevista);
                     return Task.FromResult(Success("OK", filaproducaoprevista));
                 }
                 catch (Exception e)
                 {
                    return Task.FromResult(Error(e, filaproducaoprevista));
                 }
            }
            else 
            {
