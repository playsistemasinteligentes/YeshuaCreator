...
{
    public class DeleteFilaProducaoPrevistaReceiver : ReciverBase<ICommand, IFilaProducaoPrevistaEntity>
    {
        ...
        public DeleteFilaProducaoPrevistaReceiver(
        ...
        protected override Task<State<IFilaProducaoPrevistaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteFilaProducaoPrevista", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteFilaProducaoPrevistaReceiver), commandName: "Command.Write.FilaProducaoPrevistaCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(filaproducaoprevista);
