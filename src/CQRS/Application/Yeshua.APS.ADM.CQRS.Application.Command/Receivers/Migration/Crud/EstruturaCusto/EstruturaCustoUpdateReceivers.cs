...
{
    public class UpdateEstruturaCustoReceiver : ReciverBase<ICommand, IEstruturaCustoEntity>
    {
        ...
        public UpdateEstruturaCustoReceiver(
        ...
        protected override Task<State<IEstruturaCustoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateEstruturaCusto", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateEstruturaCustoReceiver), commandName: "Command.Write.EstruturaCustoCrudCommand");
