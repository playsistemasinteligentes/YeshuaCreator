...
{
    public class UpdateInformacoesComplementaresReceiver : ReciverBase<ICommand, IInformacoesComplementaresEntity>
    {
        ...
        public UpdateInformacoesComplementaresReceiver(
        ...
        protected override async Task<State<IInformacoesComplementaresEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateInformacoesComplementares", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateInformacoesComplementaresReceiver), commandName: "Command.Write.InformacoesComplementaresCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(informacoescomplementares);
