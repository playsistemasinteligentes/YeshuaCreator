...
{
    public class DeleteInformacoesComplementaresReceiver : ReciverBase<ICommand, IInformacoesComplementaresEntity>
    {
        ...
        public DeleteInformacoesComplementaresReceiver(
