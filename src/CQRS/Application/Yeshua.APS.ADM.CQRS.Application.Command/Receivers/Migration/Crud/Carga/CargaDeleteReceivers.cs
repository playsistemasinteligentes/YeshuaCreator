...
{
    public class DeleteCargaReceiver : ReciverBase<ICommand, ICargaEntity>
    {
        ...
        protected override Task<State<ICargaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteCarga", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteCargaReceiver), commandName: "Command.Write.CargaCrudCommand");
