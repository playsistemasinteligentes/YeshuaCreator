...
{
    public class InsertEstruturaImpressaoReceiver : ReciverBase<ICommand, IEstruturaImpressaoEntity>
    {
        ...
        public InsertEstruturaImpressaoReceiver(
        ...
        protected override async Task<State<IEstruturaImpressaoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertEstruturaImpressao", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertEstruturaImpressaoReceiver), commandName: "Command.Write.EstruturaImpressaoCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(estruturaimpressao);
