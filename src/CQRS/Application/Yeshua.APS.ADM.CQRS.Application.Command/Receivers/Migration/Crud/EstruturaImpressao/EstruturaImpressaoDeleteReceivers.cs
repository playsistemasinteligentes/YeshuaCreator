...
{
    public class DeleteEstruturaImpressaoReceiver : ReciverBase<ICommand, IEstruturaImpressaoEntity>
    {
        ...
        public DeleteEstruturaImpressaoReceiver(
        ...
        protected override async Task<State<IEstruturaImpressaoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteEstruturaImpressao", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteEstruturaImpressaoReceiver), commandName: "Command.Write.EstruturaImpressaoCrudCommand");
