...
{
    public class UpdatePontosMapaReceiver : ReciverBase<ICommand, IPontosMapaEntity>
    {
        private readonly IPontosMapaWriteRepository _repository;
        private readonly ILogger _logger;
        private readonly IDomainTrackingPolicy _domainTrackingPolicy;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public UpdatePontosMapaReceiver(
            IPontosMapaWriteRepository repository,
        ...
        protected override async Task<State<IPontosMapaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdatePontosMapa", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdatePontosMapaReceiver), commandName: "Command.Write.PontosMapaCrudCommand");
