...
{
    public class UpdateClpMedicoesHReceiver : ReciverBase<ICommand, IClpMedicoesHEntity>
    {
        ...
        public UpdateClpMedicoesHReceiver(
        ...
        protected override async Task<State<IClpMedicoesHEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateClpMedicoesH", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateClpMedicoesHReceiver), commandName: "Command.Write.ClpMedicoesHCrudCommand");
