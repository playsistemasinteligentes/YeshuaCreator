...
{
    public class InsertParametrosDeCustoReceiver : ReciverBase<ICommand, IParametrosDeCustoEntity>
    {
        ...
        public InsertParametrosDeCustoReceiver(
        ...
        protected override async Task<State<IParametrosDeCustoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Insert(parametrosdecusto);
