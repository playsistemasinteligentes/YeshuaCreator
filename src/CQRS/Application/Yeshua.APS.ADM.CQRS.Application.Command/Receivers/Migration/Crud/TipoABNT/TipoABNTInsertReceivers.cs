...
{
    public class InsertTipoABNTReceiver : ReciverBase<ICommand, ITipoABNTEntity>
    {
        ...
        protected override async Task<State<ITipoABNTEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertTipoABNT", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertTipoABNTReceiver), commandName: "Command.Write.TipoABNTCrudCommand");
