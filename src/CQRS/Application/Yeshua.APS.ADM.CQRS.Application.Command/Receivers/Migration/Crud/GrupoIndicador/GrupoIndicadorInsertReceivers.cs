...
{
    public class InsertGrupoIndicadorReceiver : ReciverBase<ICommand, IGrupoIndicadorEntity>
    {
        ...
        public InsertGrupoIndicadorReceiver(
        ...
        protected override async Task<State<IGrupoIndicadorEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Insert(grupoindicador);
