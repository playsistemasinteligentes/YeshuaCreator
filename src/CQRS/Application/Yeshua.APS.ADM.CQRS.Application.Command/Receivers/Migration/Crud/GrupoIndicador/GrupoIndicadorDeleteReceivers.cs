...
{
    public class DeleteGrupoIndicadorReceiver : ReciverBase<ICommand, IGrupoIndicadorEntity>
    {
        ...
        public DeleteGrupoIndicadorReceiver(
        ...
        protected override async Task<State<IGrupoIndicadorEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteGrupoIndicador", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteGrupoIndicadorReceiver), commandName: "Command.Write.GrupoIndicadorCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(grupoindicador);
