...
{
    public class DeleteGrupoProdutoAbstratoReceiver : ReciverBase<ICommand, IGrupoProdutoAbstratoEntity>
    {
        ...
        public DeleteGrupoProdutoAbstratoReceiver(
        ...
        protected override Task<State<IGrupoProdutoAbstratoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteGrupoProdutoAbstrato", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteGrupoProdutoAbstratoReceiver), commandName: "Command.Write.GrupoProdutoAbstratoCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(grupoprodutoabstrato);
