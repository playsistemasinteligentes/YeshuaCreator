...
{
    public class DeleteFechamentoTesteReceiver : ReciverBase<ICommand, IFechamentoTesteEntity>
    {
        ...
        public DeleteFechamentoTesteReceiver(
        ...
        protected override Task<State<IFechamentoTesteEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteFechamentoTeste", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteFechamentoTesteReceiver), commandName: "Command.Write.FechamentoTesteCrudCommand");
