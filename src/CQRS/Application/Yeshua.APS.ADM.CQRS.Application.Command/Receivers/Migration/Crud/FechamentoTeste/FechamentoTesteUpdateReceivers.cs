...
{
    public class UpdateFechamentoTesteReceiver : ReciverBase<ICommand, IFechamentoTesteEntity>
    {
        ...
        public UpdateFechamentoTesteReceiver(
        ...
        protected override Task<State<IFechamentoTesteEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateFechamentoTeste", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateFechamentoTesteReceiver), commandName: "Command.Write.FechamentoTesteCrudCommand");
                 ...
                 System.Diagnostics.Activity.Current?.SetTag("yeshua.operational_entity_id", fechamentoteste.OperationalEntityId);
                 ...
                 try
                 {
                     _repository.Update(fechamentoteste);
