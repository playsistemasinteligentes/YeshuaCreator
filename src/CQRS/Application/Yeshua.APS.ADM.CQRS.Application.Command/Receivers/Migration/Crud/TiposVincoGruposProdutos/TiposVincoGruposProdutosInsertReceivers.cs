...
{
    public class InsertTiposVincoGruposProdutosReceiver : ReciverBase<ICommand, ITiposVincoGruposProdutosEntity>
    {
        ...
        public InsertTiposVincoGruposProdutosReceiver(
        ...
        protected override async Task<State<ITiposVincoGruposProdutosEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Insert(tiposvincogruposprodutos);
