...
{
    public class InsertT_MetasReceiver : ReciverBase<ICommand, IT_MetasEntity>
    {
        ...
        protected override async Task<State<IT_MetasEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertT_Metas", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertT_MetasReceiver), commandName: "Command.Write.T_MetasCrudCommand");
