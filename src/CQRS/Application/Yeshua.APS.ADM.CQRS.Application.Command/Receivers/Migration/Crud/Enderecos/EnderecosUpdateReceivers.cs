...
{
    public class UpdateEnderecosReceiver : ReciverBase<ICommand, IEnderecosEntity>
    {
        ...
        public UpdateEnderecosReceiver(
        ...
        protected override async Task<State<IEnderecosEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateEnderecos", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateEnderecosReceiver), commandName: "Command.Write.EnderecosCrudCommand");
