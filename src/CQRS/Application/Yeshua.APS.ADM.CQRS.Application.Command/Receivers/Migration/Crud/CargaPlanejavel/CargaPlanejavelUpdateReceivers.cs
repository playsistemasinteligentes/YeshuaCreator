...
{
    public class UpdateCargaPlanejavelReceiver : ReciverBase<ICommand, ICargaPlanejavelEntity>
    {
        private readonly ICargaPlanejavelWriteRepository _repository;
        private readonly ILogger _logger;
        private readonly IDomainTrackingPolicy _domainTrackingPolicy;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public UpdateCargaPlanejavelReceiver(
            ICargaPlanejavelWriteRepository repository,
        ...
        protected override async Task<State<ICargaPlanejavelEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateCargaPlanejavel", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateCargaPlanejavelReceiver), commandName: "Command.Write.CargaPlanejavelCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(cargaplanejavel);
