...
{
    public class InsertCargaPlanejavelReceiver : ReciverBase<ICommand, ICargaPlanejavelEntity>
    {
        ...
        public InsertCargaPlanejavelReceiver(
        ...
        protected override async Task<State<ICargaPlanejavelEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertCargaPlanejavel", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertCargaPlanejavelReceiver), commandName: "Command.Write.CargaPlanejavelCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(cargaplanejavel);
