...
{
    public class InsertOrderReceiver : ReciverBase<ICommand, IOrderEntity>
    {
        ...
        protected override Task<State<IOrderEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertOrder", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertOrderReceiver), commandName: "Command.Write.OrderCrudCommand");
