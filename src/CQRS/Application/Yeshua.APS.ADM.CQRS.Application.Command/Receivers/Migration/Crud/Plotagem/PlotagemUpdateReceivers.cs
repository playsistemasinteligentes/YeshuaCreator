...
{
    public class UpdatePlotagemReceiver : ReciverBase<ICommand, IPlotagemEntity>
    {
        ...
        protected override async Task<State<IPlotagemEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdatePlotagem", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdatePlotagemReceiver), commandName: "Command.Write.PlotagemCrudCommand");
