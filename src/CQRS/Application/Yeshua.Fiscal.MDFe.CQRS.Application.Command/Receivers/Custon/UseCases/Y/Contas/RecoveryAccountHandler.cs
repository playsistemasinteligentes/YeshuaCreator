...
namespace Command.Receivers.UseCase
{
    public partial class RecoveryAccountHandler
    {
        ...
        // Injete a f�brica no construtor
        ...
        partial void CustomActionHook(ref State<RecoveryAccountOutputCommand> state, RecoveryAccountInputCommand comand)
        {
            ...
            _messege.Subject = "Recupera��o de email";
            _messege.Body = $@"
                                <!DOCTYPE html>
                                <html>
                                <body style='font-family: Arial, sans-serif; color: #333; line-height: 1.6;'>
                                  <div style='max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;'>
                                    <h2 style='color: #2E86C1;'>Recupera��o de Senha</h2>
                                    <p>Ol�,</p>
                                    <p>Recebemos uma solicita��o para redefinir sua senha. Use a senha tempor�ria abaixo para acessar sua conta:</p>
                                    ...
                                    <p>Recomendamos que voc� altere essa senha assim que acessar sua conta.</p>

                                    <p>Se voc� n�o solicitou essa recupera��o, ignore este e-mail.</p>
