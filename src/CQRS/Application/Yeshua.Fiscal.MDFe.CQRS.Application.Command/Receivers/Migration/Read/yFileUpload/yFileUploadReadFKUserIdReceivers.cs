...
namespace Command.Receivers.Read
{
    public class yFileUploadReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<yFileUploadUserIdDTO>>
    {
        ...
        public yFileUploadReadFKUserIdReceiver(
        ...
        protected override async Task<State<IEnumerable<yFileUploadUserIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
