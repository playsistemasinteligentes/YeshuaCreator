...
namespace Repositorio.Outputs
{
    ...
    public string pro_grupo_paletizacao { get; set; } = string.Empty;
    public Decimal pro_pecas_por_fardo { get; set; }
    public string pro_id_integracao { get; set; } = string.Empty;
    public string pro_id_integracao_erp { get; set; } = string.Empty;
    ...
    public string pro_frente { get; set; } = string.Empty;
    public string pro_rotaciona_comprimento { get; set; } = string.Empty;
    public string pro_rotaciona_largura { get; set; } = string.Empty;
    public string pro_rotaciona_altura { get; set; } = string.Empty;
    public string pro_escala_cor { get; set; } = string.Empty;
    public string pro_sub_escala_cor { get; set; } = string.Empty;
    ...
    public string pro_color_hexa { get; set; } = string.Empty;
    public string pro_vincos_largura { get; set; } = string.Empty;
    public string pro_vincos_comprimento { get; set; } = string.Empty;
    ...
    public string pro_cod_desenho { get; set; } = string.Empty;
    public string pro_fechamento { get; set; } = string.Empty;
    public string pro_tipo_lap { get; set; } = string.Empty;
    public Decimal pro_tamanho_lap { get; set; }
    public string pro_lap_prolongado { get; set; } = string.Empty;
    ...
    public string pro_img_lastro { get; set; } = string.Empty;
    public string abn_id { get; set; } = string.Empty;
    public int seg_id { get; set; }
    public string pro_resina { get; set; } = string.Empty;
    public string pro_endurecedor_miolo { get; set; } = string.Empty;
    public string pro_vincos_onduladeira { get; set; } = string.Empty;
    public int pro_adicional_aba_superior { get; set; }
    public int pro_adicional_aba_inferior { get; set; }
    public string pro_promove_resina { get; set; } = string.Empty;
    ...
    public string pro_promove_produto { get; set; } = string.Empty;
    public Decimal pro_tara { get; set; }
    public Decimal pro_compressao { get; set; }
    public string pro_cod_barras_caixa { get; set; } = string.Empty;
    public string cjn_id { get; set; } = string.Empty;
    public string prj_id { get; set; } = string.Empty;
    ...
    public string pro_divisao_montada { get; set; } = string.Empty;
    ...
    public string pro_orelha_invertida { get; set; } = string.Empty;
    public string pro_endereco { get; set; } = string.Empty;
    public string pro_id_vinculado { get; set; } = string.Empty;
    public int pro_batidas_proxima_manutencao { get; set; }
    public string pro_entrada_na_maquina { get; set; } = string.Empty;
    ...
    public string pro_classe_custo_01 { get; set; } = string.Empty;
    public string pro_obs_alteracao { get; set; } = string.Empty;
    ...
    public string pro_id_faca { get; set; } = string.Empty;
    public string pro_id_cliche { get; set; } = string.Empty;
    public string pro_id_tinta_01 { get; set; } = string.Empty;
    public string pro_id_tinta_02 { get; set; } = string.Empty;
    public string pro_id_tinta_03 { get; set; } = string.Empty;
    public string pro_id_tinta_04 { get; set; } = string.Empty;
    public string pro_id_tinta_05 { get; set; } = string.Empty;
    public string pro_id_forrosup { get; set; } = string.Empty;
    public string pro_id_cantoneira { get; set; } = string.Empty;
    public string pro_id_palete { get; set; } = string.Empty;
    public string pro_id_tampo { get; set; } = string.Empty;
    public string pro_id_forroinf { get; set; } = string.Empty;
    public string pro_id_chapa { get; set; } = string.Empty;
    public string pro_id_composicao { get; set; } = string.Empty;
