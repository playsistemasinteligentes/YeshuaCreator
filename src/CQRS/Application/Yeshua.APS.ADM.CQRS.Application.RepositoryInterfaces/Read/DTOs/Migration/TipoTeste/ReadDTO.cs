...
namespace Repositorio.Outputs
{
    ...
    public string tt_nome { get; set; } = string.Empty;
    public string tt_desc { get; set; } = string.Empty;
    public Decimal tt_tol_mais { get; set; }
    public Decimal tt_tol_menos { get; set; }
    public string tt_norma { get; set; } = string.Empty;
    public string tt_inicio_processo { get; set; } = string.Empty;
