...
namespace Repositorio.Outputs
{
    ...
    public string tar_dia_turma { get; set; } = string.Empty;
    ...
    public string oco_id_performance { get; set; } = string.Empty;
    public string tar_obs_performance { get; set; } = string.Empty;
    public string oco_id_setup { get; set; } = string.Empty;
    public string tar_obs_setup { get; set; } = string.Empty;
    public string oco_id_setupa { get; set; } = string.Empty;
    public string tar_obs_setupa { get; set; } = string.Empty;
    public string tar_tipo_feedback_performance { get; set; } = string.Empty;
    public string tar_tipo_feedback_setup { get; set; } = string.Empty;
    public string tar_tipo_feedback_setup_ajuste { get; set; } = string.Empty;
    ...
    public string tar_obs_op_parcial { get; set; } = string.Empty;
    public string tar_oco_id_op_parcial { get; set; } = string.Empty;
    public string tar_cor_performance { get; set; } = string.Empty;
    public string tar_cor_setup_geral { get; set; } = string.Empty;
    public string tar_cor_setup { get; set; } = string.Empty;
    public string tar_cor_setupa { get; set; } = string.Empty;
