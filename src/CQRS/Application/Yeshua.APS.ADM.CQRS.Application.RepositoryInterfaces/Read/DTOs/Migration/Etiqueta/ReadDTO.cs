...
namespace Repositorio.Outputs
{
    ...
    public string eti_codigo_barras { get; set; } = string.Empty;
    public int eti_sequencia { get; set; }
    public int eti_numero_copias { get; set; }
    public string eti_status { get; set; } = string.Empty;
    public DateTime eti_data_fabricacao { get; set; }
    public string eti_cod_barras_original { get; set; } = string.Empty;
    public string eti_op_original { get; set; } = string.Empty;
    ...
    public string eti_lote { get; set; } = string.Empty;
    public string eti_sub_lote { get; set; } = string.Empty;
