...
namespace Repositorio.Outputs
{
    ...
    public string maq_control_ip { get; set; } = string.Empty;
    ...
    public string maq_cor_semaforo { get; set; } = string.Empty;
    public string maq_id_maq_pai { get; set; } = string.Empty;
    public int maq_tipo_contador { get; set; }
    public string maq_tipo_planejamento { get; set; } = string.Empty;
    ...
    public string maq_id_integracao { get; set; } = string.Empty;
    public string maq_id_integracao_erp { get; set; } = string.Empty;
    ...
    public string maq_acompanha_lote_piloto { get; set; } = string.Empty;
    ...
    public string maq_ondas { get; set; } = string.Empty;
    public string maq_prolonga_lap { get; set; } = string.Empty;
    ...
    public string maq_tipo_lap { get; set; } = string.Empty;
