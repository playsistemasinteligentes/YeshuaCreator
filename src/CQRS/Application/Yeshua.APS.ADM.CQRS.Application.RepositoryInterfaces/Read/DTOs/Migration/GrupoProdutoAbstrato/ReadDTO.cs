...
namespace Repositorio.Outputs
{
    ...
    public string grp_descricao { get; set; } = string.Empty;
    public int tem_id { get; set; }
    public Decimal grp_tipo { get; set; }
    public string grp_pap_onda { get; set; } = string.Empty;
    public Decimal grp_pap_gramatura { get; set; }
    public Decimal grp_pap_altura { get; set; }
    public string grp_pap_nome_comercial { get; set; } = string.Empty;
    public string grp_ativo { get; set; } = string.Empty;
    public DateTime grp_dt_criacao { get; set; }
    public string grp_papel1 { get; set; } = string.Empty;
    public string grp_papel2 { get; set; } = string.Empty;
    public string grp_papel3 { get; set; } = string.Empty;
    public string grp_papel4 { get; set; } = string.Empty;
    public string grp_papel5 { get; set; } = string.Empty;
    public string grp_id_integracao { get; set; } = string.Empty;
    public string grp_id_integracao_erp { get; set; } = string.Empty;
    ...
    public string grp_resina { get; set; } = string.Empty;
    public string grp_endurecedor_miolo { get; set; } = string.Empty;
    ...
    public string grp_id_familia { get; set; } = string.Empty;
    public Decimal grp_refile_largura { get; set; }
    public Decimal grp_refile_comprimento { get; set; }
    public string grp_tipo_lap { get; set; } = string.Empty;
    public string grp_lap_prolongado { get; set; } = string.Empty;
