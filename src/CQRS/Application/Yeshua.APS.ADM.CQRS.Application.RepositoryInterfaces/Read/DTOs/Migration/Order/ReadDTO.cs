...
namespace Repositorio.Outputs
{
    ...
    public string ord_id_reserva { get; set; } = string.Empty;
    public string ord_id_conjunto { get; set; } = string.Empty;
    public string pro_id { get; set; } = string.Empty;
    public string pro_id_conjunto { get; set; } = string.Empty;
    ...
    public string hash_key { get; set; } = string.Empty;
    ...
    public string ord_mit { get; set; } = string.Empty;
    public string car_tipo_carregamento { get; set; } = string.Empty;
    public string ord_status { get; set; } = string.Empty;
    public string ord_tipo_frete { get; set; } = string.Empty;
    public string ord_endereco_entrega { get; set; } = string.Empty;
    public string ord_bairro_entrega { get; set; } = string.Empty;
    public string uf_id_entrega { get; set; } = string.Empty;
    public string ord_cep_entrega { get; set; } = string.Empty;
    public string mun_id_entrega { get; set; } = string.Empty;
    public string ord_regiao_entrega { get; set; } = string.Empty;
    ...
    public string ord_id_integracao { get; set; } = string.Empty;
    public string ord_observacao_otimizador { get; set; } = string.Empty;
    public string ord_cor_fila { get; set; } = string.Empty;
    public string ord_ped_cli { get; set; } = string.Empty;
    public string ord_op_integracao { get; set; } = string.Empty;
    public string ord_lote_piloto { get; set; } = string.Empty;
    public int ord_prioridade { get; set; }
    public DateTime ord_emissao { get; set; }
    public string rep_id { get; set; } = string.Empty;
    public string ord_resina { get; set; } = string.Empty;
    public string ord_endurecedor_miolo { get; set; } = string.Empty;
    public string pro_id_integracao_erp { get; set; } = string.Empty;
    public string ord_vincos_onduladeira { get; set; } = string.Empty;
    ...
    public string ord_status_planejamento { get; set; } = string.Empty;
    ...
    public string ord_trava_composicao { get; set; } = string.Empty;
    public string ord_trava_resina { get; set; } = string.Empty;
    public string ord_promove_resina { get; set; } = string.Empty;
    public Decimal ord_latitude_entrega { get; set; }
    public Decimal ord_longitude_entrega { get; set; }
    public string oco_id_cancelamento { get; set; } = string.Empty;
    ...
    public string ord_status_estatistica { get; set; } = string.Empty;
