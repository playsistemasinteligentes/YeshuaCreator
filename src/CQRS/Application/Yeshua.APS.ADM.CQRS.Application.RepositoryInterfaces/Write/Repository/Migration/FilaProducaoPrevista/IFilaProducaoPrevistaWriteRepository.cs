...
{
    public partial interface IFilaProducaoPrevistaWriteRepository
    {
        void Insert(IFilaProducaoPrevistaEntity filaproducaoprevista);
        void Update(IFilaProducaoPrevistaEntity filaproducaoprevista);
        void Delete(IFilaProducaoPrevistaEntity filaproducaoprevista);
