...
{
    public partial interface ICargaWriteRepository
    {
        void Insert(ICargaEntity carga);
        void Update(ICargaEntity carga);
        void Delete(ICargaEntity carga);
        ...
        void UpdateCAR_ID_INTEGRACAO_BALANCA(int id, string value);
        void UpdateCAR_PESAGEM_LIBERADA(int id, string value);
        void UpdateCAR_OBS_LIERACAO(int id, string value);
        void UpdateOCO_ID_LIERACAO(int id, string value);
        void UpdateCAR_DATA_ENTRADA_VEICULO(int id, DateTime value);
        void UpdateCAR_DATA_SAIDA_VEICULO(int id, DateTime value);
        void UpdateCAR_DATA_ROMANEIO_CONSOLIDADO(int id, DateTime value);
        void UpdateCAR_DIA_TURMA_ROMANEIO_CONSOLIDADO(int id, string value);
        void UpdateCAR_DIFERENCA_PESAGEM(int id, Decimal value);
        void UpdateCAR_DATA_AGENCIAMENTO(int id, DateTime value);
        void UpdateTURN_ID(int id, string value);
        void UpdateTURM_ID(int id, string value);
