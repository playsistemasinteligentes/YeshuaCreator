...
{
    public partial interface IBoletimEstudoWriteRepository
    {
        void Insert(IBoletimEstudoEntity boletimestudo);
        void Update(IBoletimEstudoEntity boletimestudo);
        void Delete(IBoletimEstudoEntity boletimestudo);
