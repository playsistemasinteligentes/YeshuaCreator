...
{
    public class DeleteTenantCatalogoReceiver : ReciverBase<ICommand, ITenantCatalogoEntity>
    {
        ...
        public DeleteTenantCatalogoReceiver(
        ...
        protected override Task<State<ITenantCatalogoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteTenantCatalogo", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteTenantCatalogoReceiver), commandName: "Command.Write.TenantCatalogoCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(tenantcatalogo);
