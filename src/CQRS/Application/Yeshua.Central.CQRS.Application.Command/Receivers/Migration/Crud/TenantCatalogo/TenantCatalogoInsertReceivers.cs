...
{
    public class InsertTenantCatalogoReceiver : ReciverBase<ICommand, ITenantCatalogoEntity>
    {
        ...
        public InsertTenantCatalogoReceiver(
        ...
        protected override Task<State<ITenantCatalogoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Insert(tenantcatalogo);
