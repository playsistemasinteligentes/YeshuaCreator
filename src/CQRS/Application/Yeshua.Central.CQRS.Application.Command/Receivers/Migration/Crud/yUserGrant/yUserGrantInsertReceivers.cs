...
namespace Command.Receivers.Write
{
    public class InsertyUserGrantReceiver : ReciverBase<ICommand, IyUserGrantEntity>
    {
        ...
        protected override Task<State<IyUserGrantEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertyUserGrant", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertyUserGrantReceiver), commandName: "Command.Write.yUserGrantCrudCommand");
