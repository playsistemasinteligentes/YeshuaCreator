...
namespace Command.Receivers.Write
{
    public class InsertSesoesReceiver : ReciverBase<ICommand, ISesoesEntity>
    {
        ...
        protected override Task<State<ISesoesEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertSesoes", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertSesoesReceiver), commandName: "Command.Write.SesoesCrudCommand");
