...
namespace Command.Receivers.Write
{
    public class UpdateyUserModuleReceiver : ReciverBase<ICommand, IyUserModuleEntity>
    {
        ...
        protected override Task<State<IyUserModuleEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateyUserModule", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateyUserModuleReceiver), commandName: "Command.Write.yUserModuleCrudCommand");
