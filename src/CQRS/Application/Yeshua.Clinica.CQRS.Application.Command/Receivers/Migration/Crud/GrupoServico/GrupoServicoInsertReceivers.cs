...
namespace Command.Receivers.Write
{
    public class InsertGrupoServicoReceiver : ReciverBase<ICommand, IGrupoServicoEntity>
    {
        ...
        public InsertGrupoServicoReceiver(
        ...
        protected override State<IGrupoServicoEntity> Action(ICommand comand)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertGrupoServico", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertGrupoServicoReceiver), commandName: "Command.Write.GrupoServicoCrudCommand");
