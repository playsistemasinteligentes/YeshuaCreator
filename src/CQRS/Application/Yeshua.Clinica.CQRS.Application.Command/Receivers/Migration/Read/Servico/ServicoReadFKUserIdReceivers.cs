...
namespace Command.Receivers.Read
{
    public class ServicoReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<ServicoUserIdDTO>>
    {
        ...
        public ServicoReadFKUserIdReceiver(
        ...
        protected override async Task<State<IEnumerable<ServicoUserIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
