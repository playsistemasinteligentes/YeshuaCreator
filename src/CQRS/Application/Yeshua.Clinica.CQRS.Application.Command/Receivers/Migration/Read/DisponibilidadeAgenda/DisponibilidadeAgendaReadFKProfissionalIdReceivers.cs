...
namespace Command.Receivers.Read
{
    public class DisponibilidadeAgendaReadFKProfissionalIdReceiver : ReciverBase<ICommand, IEnumerable<DisponibilidadeAgendaProfissionalIdDTO>>
    {
        ...
        protected override Task<State<IEnumerable<DisponibilidadeAgendaProfissionalIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
