...
namespace Command.Receivers.Read
{
    public class DisponibilidadeAgendaReadFKTenantIDReceiver : ReciverBase<ICommand, IEnumerable<DisponibilidadeAgendaTenantIDDTO>>
    {
        ...
        protected override async Task<State<IEnumerable<DisponibilidadeAgendaTenantIDDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
