...
namespace Command.Receivers.Read
{
    public class DisponibilidadeAgendaReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<DisponibilidadeAgendaUserIdDTO>>
    {
        ...
        public DisponibilidadeAgendaReadFKUserIdReceiver(
        ...
        protected override Task<State<IEnumerable<DisponibilidadeAgendaUserIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
            if(comand is SearchFKCommand c) 
             {    
                var DisponibilidadeAgendaReadRepository = _repository.getDisponibilidadeAgendaReadFKUserId(c);
                return Task.FromResult(Success("OK", DisponibilidadeAgendaReadRepository));
            }
            else 
            {
