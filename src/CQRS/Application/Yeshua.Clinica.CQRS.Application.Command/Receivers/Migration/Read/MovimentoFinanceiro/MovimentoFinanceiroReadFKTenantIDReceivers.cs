...
namespace Command.Receivers.Read
{
    public class MovimentoFinanceiroReadFKTenantIDReceiver : ReciverBase<ICommand, IEnumerable<MovimentoFinanceiroTenantIDDTO>>
    {
        ...
        protected override async Task<State<IEnumerable<MovimentoFinanceiroTenantIDDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
