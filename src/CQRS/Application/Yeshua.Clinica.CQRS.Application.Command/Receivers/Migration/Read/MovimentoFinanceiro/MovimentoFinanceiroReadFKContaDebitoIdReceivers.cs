...
namespace Command.Receivers.Read
{
    public class MovimentoFinanceiroReadFKContaDebitoIdReceiver : ReciverBase<ICommand, IEnumerable<MovimentoFinanceiroContaDebitoIdDTO>>
    {
        ...
        protected override async Task<State<IEnumerable<MovimentoFinanceiroContaDebitoIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
