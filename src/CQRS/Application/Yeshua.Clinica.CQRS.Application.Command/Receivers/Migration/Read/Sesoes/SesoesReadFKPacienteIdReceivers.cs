...
namespace Command.Receivers.Read
{
    public class SesoesReadFKPacienteIdReceiver : ReciverBase<ICommand, IEnumerable<SesoesPacienteIdDTO>>
    {
        ...
        public SesoesReadFKPacienteIdReceiver(
        ...
        protected override async Task<State<IEnumerable<SesoesPacienteIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
