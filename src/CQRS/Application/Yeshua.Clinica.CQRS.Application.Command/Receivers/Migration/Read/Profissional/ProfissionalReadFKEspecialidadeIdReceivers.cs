...
namespace Command.Receivers.Read
{
    public class ProfissionalReadFKEspecialidadeIdReceiver : ReciverBase<ICommand, IEnumerable<ProfissionalEspecialidadeIdDTO>>
    {
        ...
        protected override async Task<State<IEnumerable<ProfissionalEspecialidadeIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
