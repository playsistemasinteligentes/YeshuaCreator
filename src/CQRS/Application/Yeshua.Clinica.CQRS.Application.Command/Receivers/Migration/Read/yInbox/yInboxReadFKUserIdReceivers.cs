...
namespace Command.Receivers.Read
{
    public class yInboxReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<yInboxUserIdDTO>>
    {
        ...
        public yInboxReadFKUserIdReceiver(
        ...
        protected override async Task<State<IEnumerable<yInboxUserIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
