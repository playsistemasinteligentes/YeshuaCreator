...
namespace Command.Receivers.Read
{
    public class MovimentacaoFinanceiraReadFKPacienteIdReceiver : ReciverBase<ICommand, IEnumerable<MovimentacaoFinanceiraPacienteIdDTO>>
    {
        ...
        protected override async Task<State<IEnumerable<MovimentacaoFinanceiraPacienteIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
