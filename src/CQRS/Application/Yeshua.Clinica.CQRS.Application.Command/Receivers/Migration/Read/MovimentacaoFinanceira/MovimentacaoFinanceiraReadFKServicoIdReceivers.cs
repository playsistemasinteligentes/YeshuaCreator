...
namespace Command.Receivers.Read
{
    public class MovimentacaoFinanceiraReadFKServicoIdReceiver : ReciverBase<ICommand, IEnumerable<MovimentacaoFinanceiraServicoIdDTO>>
    {
        ...
        protected override async Task<State<IEnumerable<MovimentacaoFinanceiraServicoIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
