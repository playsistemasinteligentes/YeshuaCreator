...
namespace Command.Receivers.Read
{
    public class MovimentacaoFinanceiraReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<MovimentacaoFinanceiraUserIdDTO>>
    {
        ...
        protected override async Task<State<IEnumerable<MovimentacaoFinanceiraUserIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
