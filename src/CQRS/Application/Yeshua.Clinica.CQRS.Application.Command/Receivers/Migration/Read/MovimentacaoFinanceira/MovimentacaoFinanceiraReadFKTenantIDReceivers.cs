...
namespace Command.Receivers.Read
{
    public class MovimentacaoFinanceiraReadFKTenantIDReceiver : ReciverBase<ICommand, IEnumerable<MovimentacaoFinanceiraTenantIDDTO>>
    {
        ...
        protected override async Task<State<IEnumerable<MovimentacaoFinanceiraTenantIDDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
