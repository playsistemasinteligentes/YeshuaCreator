...
{
    public class MDFeEncerramentoReadQueryEmTransporteReceiver : ReciverBase<ICommand, DataPagination<MDFeEncerramentoAutorizadosParaEncerramentoDTO>>
    {
        private readonly IMDFeEncerramentoReadRepository _repository;
        private readonly ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public MDFeEncerramentoReadQueryEmTransporteReceiver(
