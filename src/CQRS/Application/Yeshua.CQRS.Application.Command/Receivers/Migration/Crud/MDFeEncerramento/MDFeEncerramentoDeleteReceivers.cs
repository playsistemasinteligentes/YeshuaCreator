...
{
    public class DeleteMDFeEncerramentoReceiver : ReciverBase<ICommand, IMDFeEncerramentoEntity>
    {
        private readonly IMDFeEncerramentoWriteRepository _repository;
        private readonly ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public DeleteMDFeEncerramentoReceiver(
        ...
        protected override State<IMDFeEncerramentoEntity> Action(ICommand comand)
        {
             ...
             {    
                 ...
                 if (!mdfeencerramento.isValidDelete())
                     return ValidationError(mdfeencerramento.getErroMensagens(), null);

                 try
                 {
                     _repository.Delete(mdfeencerramento);
