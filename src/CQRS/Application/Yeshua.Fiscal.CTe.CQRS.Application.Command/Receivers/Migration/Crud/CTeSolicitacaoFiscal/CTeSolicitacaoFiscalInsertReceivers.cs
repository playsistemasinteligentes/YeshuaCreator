...
{
    public class InsertCTeSolicitacaoFiscalReceiver : ReciverBase<ICommand, ICTeSolicitacaoFiscalEntity>
    {
        ...
        public InsertCTeSolicitacaoFiscalReceiver(
        ...
        protected override async Task<State<ICTeSolicitacaoFiscalEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertCTeSolicitacaoFiscal", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertCTeSolicitacaoFiscalReceiver), commandName: "Command.Write.CTeSolicitacaoFiscalCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(ctesolicitacaofiscal);
