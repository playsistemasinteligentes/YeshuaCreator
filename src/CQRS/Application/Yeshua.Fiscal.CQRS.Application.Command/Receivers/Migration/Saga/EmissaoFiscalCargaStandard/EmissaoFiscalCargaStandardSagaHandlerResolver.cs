...
namespace Command.Receivers
{
    public class EmissaoFiscalCargaStandardSagaHandlerResolver : ISagaHandlerResolver
    {
        ...
        private readonly NormalizarDocumentosOriginariosHandler _NormalizarDocumentosOriginariosHandler;
        ...
        public Dictionary<string, ISagaStepHandler> GetHandlers()
        {
            return new Dictionary<string, ISagaStepHandler>
            {
                ...
                { EmissaoFiscalCargaStandardSaga.STEP_2, _NormalizarDocumentosOriginariosHandler },
                { EmissaoFiscalCargaStandardSaga.STEP_3, _MontarSolicitacoesCTeHandler },
                { EmissaoFiscalCargaStandardSaga.STEP_4, _PrepararCTeHandler },
                { EmissaoFiscalCargaStandardSaga.STEP_5, _AutorizarCTeNaSefazHandler },
                { EmissaoFiscalCargaStandardSaga.STEP_6, _PublicarCTeAutorizadoParaMDFeHandler },
                { EmissaoFiscalCargaStandardSaga.STEP_7, _MontarSolicitacaoMDFeHandler },
                { EmissaoFiscalCargaStandardSaga.STEP_8, _PrepararMDFeHandler },
                { EmissaoFiscalCargaStandardSaga.STEP_9, _AutorizarMDFeNaSefazHandler },
                { EmissaoFiscalCargaStandardSaga.STEP_10, _PublicarDocumentosFiscaisDaCargaConcluidosHandler },
            };
        }
    }
}
