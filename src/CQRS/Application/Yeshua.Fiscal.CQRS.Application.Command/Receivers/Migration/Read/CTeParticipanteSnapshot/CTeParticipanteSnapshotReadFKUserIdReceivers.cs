...
namespace Command.Receivers.Read
{
    public class CTeParticipanteSnapshotReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<CTeParticipanteSnapshotUserIdDTO>>
    {
        ...
        protected override async Task<State<IEnumerable<CTeParticipanteSnapshotUserIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
