...
namespace Command.Receivers.Read
{
    public class CTeParticipanteSnapshotReadFKCTeSolicitacaoFiscalIdReceiver : ReciverBase<ICommand, IEnumerable<CTeParticipanteSnapshotCTeSolicitacaoFiscalIdDTO>>
    {
        ...
        protected override async Task<State<IEnumerable<CTeParticipanteSnapshotCTeSolicitacaoFiscalIdDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
