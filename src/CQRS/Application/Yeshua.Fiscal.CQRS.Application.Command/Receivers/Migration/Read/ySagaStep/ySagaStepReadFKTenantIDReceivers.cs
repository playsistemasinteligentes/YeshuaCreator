...
namespace Command.Receivers.Read
{
    public class ySagaStepReadFKTenantIDReceiver : ReciverBase<ICommand, IEnumerable<ySagaStepTenantIDDTO>>
    {
        ...
        public ySagaStepReadFKTenantIDReceiver(
        ...
        protected override async Task<State<IEnumerable<ySagaStepTenantIDDTO>>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
