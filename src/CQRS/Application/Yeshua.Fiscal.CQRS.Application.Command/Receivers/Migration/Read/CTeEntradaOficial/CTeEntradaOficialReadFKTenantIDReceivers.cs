...
{
    public class CTeEntradaOficialReadFKTenantIDReceiver : ReciverBase<ICommand, IEnumerable<CTeEntradaOficialTenantIDDTO>>
    {
        private readonly ICTeEntradaOficialReadRepository _repository;
		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public CTeEntradaOficialReadFKTenantIDReceiver(
