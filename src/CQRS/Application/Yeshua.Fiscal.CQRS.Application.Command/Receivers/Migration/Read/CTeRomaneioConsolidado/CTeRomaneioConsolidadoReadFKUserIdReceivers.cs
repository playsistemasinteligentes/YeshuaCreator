...
{
    public class CTeRomaneioConsolidadoReadFKUserIdReceiver : ReciverBase<ICommand, IEnumerable<CTeRomaneioConsolidadoUserIdDTO>>
    {
        private readonly ICTeRomaneioConsolidadoReadRepository _repository;
		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;

        public CTeRomaneioConsolidadoReadFKUserIdReceiver(
