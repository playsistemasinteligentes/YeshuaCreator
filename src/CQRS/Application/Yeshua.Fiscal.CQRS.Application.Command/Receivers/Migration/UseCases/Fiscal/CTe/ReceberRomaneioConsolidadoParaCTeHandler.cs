...
// Escopo: fiscal.cte.romaneio.receber
using Command.Write;
...
{
    public partial class ReceberRomaneioConsolidadoParaCTeHandler : ReciverBase< ReceberRomaneioConsolidadoParaCTeInputCommand, ReceberRomaneioConsolidadoParaCTeOutputCommand>
    {
        ...
        protected override async Task<State<ReceberRomaneioConsolidadoParaCTeOutputCommand>> ActionAsync(ReceberRomaneioConsolidadoParaCTeInputCommand comand, CancellationToken cancellationToken = default)
        {
            try
            {
