...
// Escopo: fiscal.contingencia.agrupamento.informar
using Command.Write;
...
{
    public partial class EscolherModeloAgrupamentoCTeContingenciaHandler : ReciverBase< EscolherModeloAgrupamentoCTeContingenciaInputCommand, EscolherModeloAgrupamentoCTeContingenciaOutputCommand>
    {

		   private readonly Dominio.Interfaces.ILogger _logger;
        private readonly Aplication.Interfaces.Services.IExecutionContext _executionContext;
        private readonly Command.Interfaces.ISagaStepInvoker _sagaStepInvoker;
        public EscolherModeloAgrupamentoCTeContingenciaHandler(
        ...
        protected override async Task<State<EscolherModeloAgrupamentoCTeContingenciaOutputCommand>> ActionAsync(EscolherModeloAgrupamentoCTeContingenciaInputCommand comand, CancellationToken cancellationToken = default)
        {
            try
            {
            ...
            catch (ReceiverException<EscolherModeloAgrupamentoCTeContingenciaOutputCommand> e)
            {
                return e.State;
            }
            catch (Exception e)
