...
// Escopo: fiscal.teste.saga-sync.iniciar
using Command.Write;
...
{
    public partial class IniciarSagaTesteSyncHandler : ReciverBase< IniciarSagaTesteSyncInputCommand, IniciarSagaTesteSyncOutputCommand>
    {
        ...
        protected override async Task<State<IniciarSagaTesteSyncOutputCommand>> ActionAsync(IniciarSagaTesteSyncInputCommand comand, CancellationToken cancellationToken = default)
        {
            try
            {
