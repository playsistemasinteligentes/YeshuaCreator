...
{
    public class DeleteCTeParticipanteSnapshotReceiver : ReciverBase<ICommand, ICTeParticipanteSnapshotEntity>
    {
        ...
        public DeleteCTeParticipanteSnapshotReceiver(
        ...
        protected override Task<State<ICTeParticipanteSnapshotEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteCTeParticipanteSnapshot", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteCTeParticipanteSnapshotReceiver), commandName: "Command.Write.CTeParticipanteSnapshotCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(cteparticipantesnapshot);
