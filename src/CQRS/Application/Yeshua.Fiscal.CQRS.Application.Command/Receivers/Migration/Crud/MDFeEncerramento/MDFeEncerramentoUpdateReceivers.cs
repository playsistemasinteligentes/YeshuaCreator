...
namespace Command.Receivers.Write
{
    public class UpdateMDFeEncerramentoReceiver : ReciverBase<ICommand, IMDFeEncerramentoEntity>
    {
        ...
        protected override async Task<State<IMDFeEncerramentoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateMDFeEncerramento", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateMDFeEncerramentoReceiver), commandName: "Command.Write.MDFeEncerramentoCrudCommand");
