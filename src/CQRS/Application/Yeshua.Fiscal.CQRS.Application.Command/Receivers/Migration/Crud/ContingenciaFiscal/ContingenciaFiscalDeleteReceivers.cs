...
{
    public class DeleteContingenciaFiscalReceiver : ReciverBase<ICommand, IContingenciaFiscalEntity>
    {
        ...
        public DeleteContingenciaFiscalReceiver(
        ...
        protected override Task<State<IContingenciaFiscalEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Delete(contingenciafiscal);
