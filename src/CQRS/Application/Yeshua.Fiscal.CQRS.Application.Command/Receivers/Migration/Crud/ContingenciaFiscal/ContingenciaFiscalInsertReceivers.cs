...
{
    public class InsertContingenciaFiscalReceiver : ReciverBase<ICommand, IContingenciaFiscalEntity>
    {
        ...
        public InsertContingenciaFiscalReceiver(
        ...
        protected override Task<State<IContingenciaFiscalEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertContingenciaFiscal", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertContingenciaFiscalReceiver), commandName: "Command.Write.ContingenciaFiscalCrudCommand");
                 ...
                 try
                 {
                     _repository.Insert(contingenciafiscal);
