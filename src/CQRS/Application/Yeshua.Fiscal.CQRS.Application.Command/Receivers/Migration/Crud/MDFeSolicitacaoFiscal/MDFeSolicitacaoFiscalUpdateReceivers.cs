...
{
    public class UpdateMDFeSolicitacaoFiscalReceiver : ReciverBase<ICommand, IMDFeSolicitacaoFiscalEntity>
    {
        ...
        public UpdateMDFeSolicitacaoFiscalReceiver(
        ...
        protected override async Task<State<IMDFeSolicitacaoFiscalEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateMDFeSolicitacaoFiscal", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateMDFeSolicitacaoFiscalReceiver), commandName: "Command.Write.MDFeSolicitacaoFiscalCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(mdfesolicitacaofiscal);
