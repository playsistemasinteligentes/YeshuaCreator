...
{
    public class DeleteMDFeSolicitacaoFiscalReceiver : ReciverBase<ICommand, IMDFeSolicitacaoFiscalEntity>
    {
        ...
        public DeleteMDFeSolicitacaoFiscalReceiver(
        ...
        protected override async Task<State<IMDFeSolicitacaoFiscalEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteMDFeSolicitacaoFiscal", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteMDFeSolicitacaoFiscalReceiver), commandName: "Command.Write.MDFeSolicitacaoFiscalCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(mdfesolicitacaofiscal);
