...
{
    public class UpdateMDFeTentativaEmissaoReceiver : ReciverBase<ICommand, IMDFeTentativaEmissaoEntity>
    {
        ...
        public UpdateMDFeTentativaEmissaoReceiver(
        ...
        protected override Task<State<IMDFeTentativaEmissaoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateMDFeTentativaEmissao", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateMDFeTentativaEmissaoReceiver), commandName: "Command.Write.MDFeTentativaEmissaoCrudCommand");
                 ...
                 System.Diagnostics.Activity.Current?.SetTag("yeshua.operational_entity_id", mdfetentativaemissao.OperationalEntityId);
                 ...
                 try
                 {
                     _repository.Update(mdfetentativaemissao);
