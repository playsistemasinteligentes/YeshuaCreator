...
{
    public class UpdateCTeRomaneioConsolidadoReceiver : ReciverBase<ICommand, ICTeRomaneioConsolidadoEntity>
    {
        ...
        public UpdateCTeRomaneioConsolidadoReceiver(
        ...
        protected override Task<State<ICTeRomaneioConsolidadoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateCTeRomaneioConsolidado", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateCTeRomaneioConsolidadoReceiver), commandName: "Command.Write.CTeRomaneioConsolidadoCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(cteromaneioconsolidado);
