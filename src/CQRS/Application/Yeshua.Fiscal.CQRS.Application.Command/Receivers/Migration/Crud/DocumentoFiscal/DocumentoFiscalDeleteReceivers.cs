...
{
    public class DeleteDocumentoFiscalReceiver : ReciverBase<ICommand, IDocumentoFiscalEntity>
    {
        ...
        public DeleteDocumentoFiscalReceiver(
        ...
        protected override Task<State<IDocumentoFiscalEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteDocumentoFiscal", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteDocumentoFiscalReceiver), commandName: "Command.Write.DocumentoFiscalCrudCommand");
