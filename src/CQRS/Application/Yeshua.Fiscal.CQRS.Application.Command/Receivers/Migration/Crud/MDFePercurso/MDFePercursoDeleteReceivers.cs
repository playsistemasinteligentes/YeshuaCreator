...
{
    public class DeleteMDFePercursoReceiver : ReciverBase<ICommand, IMDFePercursoEntity>
    {
        ...
        public DeleteMDFePercursoReceiver(
        ...
        protected override Task<State<IMDFePercursoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteMDFePercurso", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteMDFePercursoReceiver), commandName: "Command.Write.MDFePercursoCrudCommand");
