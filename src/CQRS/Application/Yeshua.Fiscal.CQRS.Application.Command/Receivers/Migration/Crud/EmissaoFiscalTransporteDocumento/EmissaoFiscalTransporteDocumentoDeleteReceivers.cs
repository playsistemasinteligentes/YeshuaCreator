...
{
    public class DeleteEmissaoFiscalTransporteDocumentoReceiver : ReciverBase<ICommand, IEmissaoFiscalTransporteDocumentoEntity>
    {
        ...
        public DeleteEmissaoFiscalTransporteDocumentoReceiver(
        ...
        protected override Task<State<IEmissaoFiscalTransporteDocumentoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteEmissaoFiscalTransporteDocumento", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteEmissaoFiscalTransporteDocumentoReceiver), commandName: "Command.Write.EmissaoFiscalTransporteDocumentoCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(emissaofiscaltransportedocumento);
