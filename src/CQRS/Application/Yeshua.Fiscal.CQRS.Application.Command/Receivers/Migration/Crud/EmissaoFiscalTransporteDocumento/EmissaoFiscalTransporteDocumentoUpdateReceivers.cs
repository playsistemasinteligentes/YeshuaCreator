...
{
    public class UpdateEmissaoFiscalTransporteDocumentoReceiver : ReciverBase<ICommand, IEmissaoFiscalTransporteDocumentoEntity>
    {
        ...
        public UpdateEmissaoFiscalTransporteDocumentoReceiver(
        ...
        protected override Task<State<IEmissaoFiscalTransporteDocumentoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 ...
                 try
                 {
                     _repository.Update(emissaofiscaltransportedocumento);
