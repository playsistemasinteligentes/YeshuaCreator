...
{
    public class UpdateNFeProdutoSnapshotReceiver : ReciverBase<ICommand, INFeProdutoSnapshotEntity>
    {
        ...
        public UpdateNFeProdutoSnapshotReceiver(
        ...
        protected override async Task<State<INFeProdutoSnapshotEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateNFeProdutoSnapshot", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateNFeProdutoSnapshotReceiver), commandName: "Command.Write.NFeProdutoSnapshotCrudCommand");
                 ...
                 try
                 {
                     _repository.Update(nfeprodutosnapshot);
