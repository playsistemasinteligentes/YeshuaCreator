...
{
    public class DeleteEntradaFiscalContingenciaReceiver : ReciverBase<ICommand, IEntradaFiscalContingenciaEntity>
    {
        ...
        public DeleteEntradaFiscalContingenciaReceiver(
        ...
        protected override Task<State<IEntradaFiscalContingenciaEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteEntradaFiscalContingencia", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteEntradaFiscalContingenciaReceiver), commandName: "Command.Write.EntradaFiscalContingenciaCrudCommand");
                 var entradafiscalcontingencia = new EntradaFiscalContingenciaFactory(_logger, _domainTrackingPolicy).Create(context, c.Id, c.CorrelationId, c.CargaId, c.TipoSolicitante, c.Ambiente, c.SourceApplication, c.SourceModule, c.SourceMessageId, c.EmitenteFiscalDocumento, c.TomadorDocumento, c.TransportadorDocumento, c.RemetenteDocumento, c.DestinatarioDocumento, c.UFInicio, c.UFFim, c.MunicipioInicioCodigoIbge, c.MunicipioFimCodigoIbge, c.RNTRC, c.PlacaVeiculo, c.UFVeiculo, c.CondutorDocumento, c.CondutorNome, c.QuantidadeDocumentos, c.ValorCarga, c.PesoBruto, c.Volume, c.PendenciasJson, c.SnapshotJson, c.EmissaoFiscalCorrelationId, c.EmissaoFiscalSagaId, c.CriadoEmUtc, c.AtualizadoEmUtc, c.Status, c.CertificadoDigitalId);
                 System.Diagnostics.Activity.Current?.SetTag("yeshua.operational_entity_id", entradafiscalcontingencia.OperationalEntityId);
                 ...
                 try
                 {
                     _repository.Delete(entradafiscalcontingencia);
