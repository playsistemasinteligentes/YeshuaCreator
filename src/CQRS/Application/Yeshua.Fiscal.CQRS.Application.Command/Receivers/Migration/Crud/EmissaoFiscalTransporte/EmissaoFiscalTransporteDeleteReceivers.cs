...
{
    public class DeleteEmissaoFiscalTransporteReceiver : ReciverBase<ICommand, IEmissaoFiscalTransporteEntity>
    {
        ...
        public DeleteEmissaoFiscalTransporteReceiver(
        ...
        protected override Task<State<IEmissaoFiscalTransporteEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Remocao, DomainEntryPoint.Crud, "DeleteEmissaoFiscalTransporte", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(DeleteEmissaoFiscalTransporteReceiver), commandName: "Command.Write.EmissaoFiscalTransporteCrudCommand");
                 ...
                 try
                 {
                     _repository.Delete(emissaofiscaltransporte);
