...
{
    public class InsertDocumentoFiscalOriginarioReceiver : ReciverBase<ICommand, IDocumentoFiscalOriginarioEntity>
    {
        ...
        public InsertDocumentoFiscalOriginarioReceiver(
        ...
        protected override Task<State<IDocumentoFiscalOriginarioEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertDocumentoFiscalOriginario", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertDocumentoFiscalOriginarioReceiver), commandName: "Command.Write.DocumentoFiscalOriginarioCrudCommand");
                 ...
                 System.Diagnostics.Activity.Current?.SetTag("yeshua.operational_entity_id", documentofiscaloriginario.OperationalEntityId);
                 ...
                 try
                 {
                     _repository.Insert(documentofiscaloriginario);
