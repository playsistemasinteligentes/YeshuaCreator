...
{
    public class UpdateMDFeVeiculoReceiver : ReciverBase<ICommand, IMDFeVeiculoEntity>
    {
        ...
        public UpdateMDFeVeiculoReceiver(
        ...
        protected override Task<State<IMDFeVeiculoEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateMDFeVeiculo", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateMDFeVeiculoReceiver), commandName: "Command.Write.MDFeVeiculoCrudCommand");
