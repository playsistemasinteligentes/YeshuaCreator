...
{
    public partial class AnalisarNotasFiscaisDaContingenciaHandler
    {
        ...
        public AnalisarNotasFiscaisDaContingenciaHandler(
        ...
        partial void CustomExecute(SagaBase saga, SagaStepBase step)
        {
            ...
            if (documentos.Count == 0)
                throw new InvalidOperationException($"Contingencia fiscal {entrada.cargaid}: nenhum documento originario encontrado para analise.");
            ...
            {
                type = "fiscal.contingencia.notas-analisadas",
        ...
        {
            _logger.Info($"Contingencia fiscal {saga.EntityId}: notas fiscais analisadas.");
        }
