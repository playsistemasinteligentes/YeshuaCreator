...
{
    public partial class InformarFreteERateioHandler
    {
        ...
        public InformarFreteERateioHandler(
        ...
        partial void CustomExecute(SagaBase saga, SagaStepBase step)
        {
            ...
            {
                type = "fiscal.contingencia.aguardando-frete-rateio",
        ...
        {
            var entrada = FiscalContingenciaState.LoadEntrada(_entradaReadRepository, saga, step);
            FiscalContingenciaState.ApplyComplemento(_entradaWriteRepository, entrada, payload, ContingenciaFiscalStandardSaga.STEP_5);
            _logger.Info($"Contingencia fiscal {saga.EntityId}: frete e rateio recebidos pela tela.");
        }
    }
}
