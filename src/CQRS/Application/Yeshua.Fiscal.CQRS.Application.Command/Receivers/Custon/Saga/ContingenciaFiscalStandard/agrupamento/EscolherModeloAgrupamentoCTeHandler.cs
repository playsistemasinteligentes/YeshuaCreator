...
{
    public partial class EscolherModeloAgrupamentoCTeHandler
    {
        ...
        public EscolherModeloAgrupamentoCTeHandler(
        ...
        partial void CustomExecute(SagaBase saga, SagaStepBase step)
        {
            ...
            {
                type = "fiscal.contingencia.aguardando-agrupamento-cte",
        ...
        {
            var entrada = FiscalContingenciaState.LoadEntrada(_entradaReadRepository, saga, step);
            FiscalContingenciaState.ApplyComplemento(_entradaWriteRepository, entrada, payload, ContingenciaFiscalStandardSaga.STEP_3);
            _logger.Info($"Contingencia fiscal {saga.EntityId}: modelo de agrupamento CT-e recebido pela tela.");
        }
    }
}
