...
{
    public partial class InformarDadosTransporteHandler
    {
        ...
        public InformarDadosTransporteHandler(
        ...
        partial void CustomExecute(SagaBase saga, SagaStepBase step)
        {
            ...
            {
                type = "fiscal.contingencia.aguardando-dados-transporte",
        ...
        {
            var entrada = FiscalContingenciaState.LoadEntrada(_entradaReadRepository, saga, step);
            FiscalContingenciaState.ApplyComplemento(_entradaWriteRepository, entrada, payload, ContingenciaFiscalStandardSaga.STEP_7);
            _logger.Info($"Contingencia fiscal {saga.EntityId}: dados de transporte recebidos pela tela.");
        }
    }
}
