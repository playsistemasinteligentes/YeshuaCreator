...
{
    public partial class SimularAgrupamentoCTeHandler
    {
        ...
        public SimularAgrupamentoCTeHandler(
        ...
        partial void CustomExecute(SagaBase saga, SagaStepBase step)
        {
            ...
            {
                type = "fiscal.contingencia.agrupamento-simulado",
        ...
        {
            _logger.Info($"Contingencia fiscal {saga.EntityId}: agrupamento CT-e simulado.");
        }
    }
}
