...
{
    public partial class InformarResultadoEmissaoFiscalContingenciaHandler
    {
        ...
        public InformarResultadoEmissaoFiscalContingenciaHandler(IUnitOfWork unitOfWork,ILogger logger,IExecutionContext executionContext,IDomainTrackingPolicy domainTrackingPolicy,Command.Interfaces.ISagaStepInvoker sagaStepInvoker,IEntradaFiscalContingenciaReadRepository repReadEntradaFiscalContingencia, IEntradaFiscalContingenciaWriteRepository repWriteEntradaFiscalContingencia, ContingenciaFiscalStepStimulusService stepStimulusService)
...
protected partial async Task<State<InformarResultadoEmissaoFiscalContingenciaOutputCommand>> CustomActionHookAsync(State<InformarResultadoEmissaoFiscalContingenciaOutputCommand> state, InformarResultadoEmissaoFiscalContingenciaInputCommand comand, CancellationToken cancellationToken)
{
    ...
    var output = new InformarResultadoEmissaoFiscalContingenciaOutputCommand
    {
