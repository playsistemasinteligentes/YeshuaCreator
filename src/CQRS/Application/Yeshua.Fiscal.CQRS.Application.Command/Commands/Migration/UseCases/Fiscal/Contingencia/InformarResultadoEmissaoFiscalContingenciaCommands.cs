...
{
public partial record InformarResultadoEmissaoFiscalContingenciaInputCommand : ICommand, IOperationalTelemetryCommand
{
...
public partial record InformarResultadoEmissaoFiscalContingenciaOutputCommand : ICommand, ISagaStepStimulusOutput
{
    public string CorrelationId { get; set; } = string.Empty;
    public string CargaId { get; set; } = string.Empty;
