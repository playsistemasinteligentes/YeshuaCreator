...
{
    public struct EmissaoFiscalTransporteDocumentoReadCommand : ICommandRead, IOperationalTelemetryCommand
    {
 ...
 public string OperationalEntity => "EmissaoFiscalTransporteDocumento";
