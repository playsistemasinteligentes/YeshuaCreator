...
{
    public partial interface IMDFeTentativaEmissaoWriteRepository
    {
        void Insert(IMDFeTentativaEmissaoEntity mdfetentativaemissao);
        void Update(IMDFeTentativaEmissaoEntity mdfetentativaemissao);
        void Delete(IMDFeTentativaEmissaoEntity mdfetentativaemissao);
