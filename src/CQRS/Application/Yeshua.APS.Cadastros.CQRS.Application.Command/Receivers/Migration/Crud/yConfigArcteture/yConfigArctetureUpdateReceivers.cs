...
namespace Command.Receivers.Write
{
    public class UpdateyConfigArctetureReceiver : ReciverBase<ICommand, IyConfigArctetureEntity>
    {
        ...
        protected override async Task<State<IyConfigArctetureEntity>> ActionAsync(ICommand comand, CancellationToken cancellationToken = default)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Alteracao, DomainEntryPoint.Crud, "UpdateyConfigArcteture", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(UpdateyConfigArctetureReceiver), commandName: "Command.Write.yConfigArctetureCrudCommand");
