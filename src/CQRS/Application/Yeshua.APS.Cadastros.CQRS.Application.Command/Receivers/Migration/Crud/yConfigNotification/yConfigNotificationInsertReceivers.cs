...
namespace Command.Receivers.Write
{
    public class InsertyConfigNotificationReceiver : ReciverBase<ICommand, IyConfigNotificationEntity>
    {
        ...
        protected override State<IyConfigNotificationEntity> Action(ICommand comand)
        {
             ...
             {    
                 var context = DomainOperationContext.Create(DomainOperation.Registro, DomainEntryPoint.Crud, "InsertyConfigNotification", _executionContext.TenantID, _executionContext.UserId, traceId: _executionContext.TraceId, receiverName: nameof(InsertyConfigNotificationReceiver), commandName: "Command.Write.yConfigNotificationCrudCommand");
