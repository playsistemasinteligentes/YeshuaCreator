...
namespace Input.Repository.FilaProducaoPrevista
{
    public partial class FilaProducaoPrevistaWriteRepository : IFilaProducaoPrevistaWriteRepository
    {
        private readonly IUnitOfWork _UnitOfWork;
       private readonly IFilaProducaoPrevistaQueryWrite _query; 

        public FilaProducaoPrevistaWriteRepository(IUnitOfWork unitOfWork,IFilaProducaoPrevistaQueryWrite query)
        {
             _UnitOfWork= unitOfWork;
             _query = query;
        }

        public void Insert(IFilaProducaoPrevistaEntity FilaProducaoPrevista)
        {
            var query = _query.InserirFilaProducaoPrevistaQuery(FilaProducaoPrevista);
        FilaProducaoPrevista.Id =  _UnitOfWork.ExecuteScalar<int>(query.Query, query.Parameters);
        }

        public void Update(IFilaProducaoPrevistaEntity FilaProducaoPrevista)
        {
            var query = _query.UpdateFilaProducaoPrevistaQuery(FilaProducaoPrevista);
             _UnitOfWork.Execute(query.Query, query.Parameters);
        }
        public void Delete(IFilaProducaoPrevistaEntity FilaProducaoPrevista)
        {
            var query = _query.DeleteFilaProducaoPrevistaQuery(FilaProducaoPrevista);
             _UnitOfWork.Execute(query.Query, query.Parameters);
        }
        ...
        public void UpdateFPR_PESO_UNITARIO(int id, string value)
        {
            var query = _query.UpdateFPR_PESO_UNITARIO(id, value);
             _UnitOfWork.Execute(query.Query, query.Parameters);
        }
        public void UpdateFPR_M2_UNITARIO(int id, string value)
        {
            var query = _query.UpdateFPR_M2_UNITARIO(id, value);
             _UnitOfWork.Execute(query.Query, query.Parameters);
        }
