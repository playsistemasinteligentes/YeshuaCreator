...
namespace Query.Write
{
    public class ItensOrcamentoQueryWrite : QueryBase, IItensOrcamentoQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO ItensOrcamento (ORC_ID, TIP_ID, PRO_ID, ITO_OBS, ITO_QUANTIDADE, ITO_CUSTO, ITO_MARGEM, ITO_VALOR_UNITARIO, ITO_VERSSAO_CUSTO, ITO_STATUS, ITO_ERP_CUSTOS_FIXOS, ITO_ERP_CUSTOS_VARIAVEIS, ITO_ERP_DESPESAS_VAR_VENDA, ITO_ERP_IMPOSTOS, GRP_ID_COMPOSICAO, ITO_LARGURA, ITO_COMPRIMENTO, TenantID, Deleted, Changed, UserId) OUTPUT INSERTED.Id VALUES(@ORC_ID, @TIP_ID, @PRO_ID, @ITO_OBS, @ITO_QUANTIDADE, @ITO_CUSTO, @ITO_MARGEM, @ITO_VALOR_UNITARIO, @ITO_VERSSAO_CUSTO, @ITO_STATUS, @ITO_ERP_CUSTOS_FIXOS, @ITO_ERP_CUSTOS_VARIAVEIS, @ITO_ERP_DESPESAS_VAR_VENDA, @ITO_ERP_IMPOSTOS, @GRP_ID_COMPOSICAO, @ITO_LARGURA, @ITO_COMPRIMENTO, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
