...
namespace Query.Write
{
    public class ItemTestavelQueryWrite : QueryBase, IItemTestavelQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO ItemTestavel (ITE_DESCRICAO, ITE_OBS, ITE_NUMERO_DE_TESTES, ITE_CONDICIONAL_DE_AVALIACAO, ITE_VALOR_DA_CONDICIONAL, ITE_VALOR_CALCULADO_DA_CONDICIONAL, ITE_TIPO_AVALIACAO_FINAL, TenantID, Deleted, Changed, UserId) OUTPUT INSERTED.Id VALUES(@ITE_DESCRICAO, @ITE_OBS, @ITE_NUMERO_DE_TESTES, @ITE_CONDICIONAL_DE_AVALIACAO, @ITE_VALOR_DA_CONDICIONAL, @ITE_VALOR_CALCULADO_DA_CONDICIONAL, @ITE_TIPO_AVALIACAO_FINAL, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
