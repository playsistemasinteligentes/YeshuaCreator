    ...
    public class CorridasOnduladeiraQueryWrite : QueryBase, ICorridasOnduladeiraQueryWrite
    {
        ...
        public QueryModel InserirCorridasOnduladeiraQuery(ICorridasOnduladeiraEntity CorridasOnduladeira)
        {
            ...
            this.Parameters = new
            {
                ...
                OperationalEntityId = CorridasOnduladeira.OperationalEntityId,
        ...
        public QueryModel UpdateOperationalEntityId(int cor_id, string value)
        {
            this.Query = $@" UPDATE [CorridasOnduladeira] SET [OperationalEntityId] = @OperationalEntityId WHERE [COR_ID] = @COR_ID ";
            this.Parameters = new
            {
