    ...
    public class OrderQueryWrite : QueryBase, IOrderQueryWrite
    {
        ...
        public QueryModel InserirOrderQuery(IOrderEntity Order)
        {
            ...
            this.Parameters = new
            {
                ...
                OperationalEntityId = Order.OperationalEntityId,
        ...
        public QueryModel UpdateOperationalEntityId(string ord_id, string value)
        {
            this.Query = $@" UPDATE [Order] SET [OperationalEntityId] = @OperationalEntityId WHERE [ORD_ID] = @ORD_ID ";
            this.Parameters = new
            {
