...
namespace Query.Write
{
    public class ItensEstruturaImpressaoQueryWrite : QueryBase, IItensEstruturaImpressaoQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO [ItensEstruturaImpressao] ([IES_CUSTOM_FONT_SIZE], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId]) OUTPUT INSERTED.[Id] VALUES(@IES_CUSTOM_FONT_SIZE, @OperationalEntityId, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
                IES_CUSTOM_FONT_SIZE = ItensEstruturaImpressao.IES_CUSTOM_FONT_SIZE,
                OperationalEntityId = ItensEstruturaImpressao.OperationalEntityId,
        ...
        {
            this.Query = $@" UPDATE [ItensEstruturaImpressao] SET [OperationalEntityId] = @OperationalEntityId WHERE [Id] = @Id ";
            this.Parameters = new
            {
