    ...
    public class FilaProducaoPrevistaQueryWrite : QueryBase, IFilaProducaoPrevistaQueryWrite
    {
        ...
        public QueryModel InserirFilaProducaoPrevistaQuery(IFilaProducaoPrevistaEntity FilaProducaoPrevista)
        {
            ...
            this.Parameters = new
            {
                ...
                OperationalEntityId = FilaProducaoPrevista.OperationalEntityId,
        ...
        {
            this.Query = $@" UPDATE [FilaProducaoPrevista] SET [OperationalEntityId] = @OperationalEntityId WHERE [Id] = @Id ";
            this.Parameters = new
            {
