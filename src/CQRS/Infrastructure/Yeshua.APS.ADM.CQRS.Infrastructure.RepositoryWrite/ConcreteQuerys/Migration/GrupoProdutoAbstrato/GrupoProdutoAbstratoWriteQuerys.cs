    ...
    public class GrupoProdutoAbstratoQueryWrite : QueryBase, IGrupoProdutoAbstratoQueryWrite
    {
        ...
        public QueryModel InserirGrupoProdutoAbstratoQuery(IGrupoProdutoAbstratoEntity GrupoProdutoAbstrato)
        {
            ...
            this.Parameters = new
            {
                ...
                OperationalEntityId = GrupoProdutoAbstrato.OperationalEntityId,
        ...
        public QueryModel UpdateOperationalEntityId(string grp_id, string value)
        {
            this.Query = $@" UPDATE [GrupoProdutoAbstrato] SET [OperationalEntityId] = @OperationalEntityId WHERE [GRP_ID] = @GRP_ID ";
            this.Parameters = new
            {
