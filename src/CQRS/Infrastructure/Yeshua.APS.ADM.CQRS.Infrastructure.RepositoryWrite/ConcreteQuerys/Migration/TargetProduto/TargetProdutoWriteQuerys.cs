...
namespace Query.Write
{
    public class TargetProdutoQueryWrite : QueryBase, ITargetProdutoQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO [TargetProduto] ([MOV_ID], [ORD_ID], [PRO_ID], [MAQ_ID], [UNI_ID], [TURM_ID], [TURN_ID], [USE_ID], [TAR_DIA_TURMA], [TAR_META_PERFORMANCE], [TAR_REALIZADO_PERFORMANCE], [TAR_PERCENTUAL_REALIZADO_PERFORMANCE], [TAR_PROXIMA_META_PERFORMANCE], [TAR_META_TEMPO_SETUP], [TAR_REALIZADO_TEMPO_SETUP], [TAR_PROXIMA_META_TEMPO_SETUP], [TAR_META_TEMPO_SETUP_AJUSTE], [TAR_REALIZADO_TEMPO_SETUP_AJUSTE], [TAR_PROXIMA_META_TEMPO_SETUP_AJUSTE], [OCO_ID_PERFORMANCE], [TAR_OBS_PERFORMANCE], [OCO_ID_SETUP], [TAR_OBS_SETUP], [OCO_ID_SETUPA], [TAR_OBS_SETUPA], [TAR_TIPO_FEEDBACK_PERFORMANCE], [TAR_TIPO_FEEDBACK_SETUP], [TAR_TIPO_FEEDBACK_SETUP_AJUSTE], [TAR_QTD_SETUP_AJUSTE], [TAR_QTD], [TAR_PARAMETRO_TIME_WORK_STOP_MACHINE], [TAR_PARAMETRO_TEMPO_QUEBRA_DE_LOTE], [ROT_SEQ_TRANFORMACAO], [FPR_SEQ_REPETICAO], [TAR_PERFORMANCE_MAX_VERDE], [TAR_PERFORMANCE_MIN_VERDE], [TAR_SETUP_MAX_VERDE], [TAR_SETUP_MIN_VERDE], [TAR_SETUPA_MAX_VERDE], [TAR_SETUPA_MIN_VERDE], [TAR_PERFORMANCE_MIN_AMARELO], [TAR_SETUP_MAX_AMARELO], [TAR_SETUPA_MAX_AMARELO], [TAR_OBS_OP_PARCIAL], [TAR_OCO_ID_OP_PARCIAL], [TAR_COR_PERFORMANCE], [TAR_COR_SETUP_GERAL], [TAR_COR_SETUP], [TAR_COR_SETUPA], [TAR_DIA_TURMA_D], [FEE_QTD_PECAS_POR_PULSO], [TAR_QTD_PERDAS], [TAR_DATA_INICIAL], [TAR_DATA_FINAL], [TAR_APROVADO], [TAR_TEMPO_PRODUZINDO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId]) OUTPUT INSERTED.[TAR_ID] VALUES(@MOV_ID, @ORD_ID, @PRO_ID, @MAQ_ID, @UNI_ID, @TURM_ID, @TURN_ID, @USE_ID, @TAR_DIA_TURMA, @TAR_META_PERFORMANCE, @TAR_REALIZADO_PERFORMANCE, @TAR_PERCENTUAL_REALIZADO_PERFORMANCE, @TAR_PROXIMA_META_PERFORMANCE, @TAR_META_TEMPO_SETUP, @TAR_REALIZADO_TEMPO_SETUP, @TAR_PROXIMA_META_TEMPO_SETUP, @TAR_META_TEMPO_SETUP_AJUSTE, @TAR_REALIZADO_TEMPO_SETUP_AJUSTE, @TAR_PROXIMA_META_TEMPO_SETUP_AJUSTE, @OCO_ID_PERFORMANCE, @TAR_OBS_PERFORMANCE, @OCO_ID_SETUP, @TAR_OBS_SETUP, @OCO_ID_SETUPA, @TAR_OBS_SETUPA, @TAR_TIPO_FEEDBACK_PERFORMANCE, @TAR_TIPO_FEEDBACK_SETUP, @TAR_TIPO_FEEDBACK_SETUP_AJUSTE, @TAR_QTD_SETUP_AJUSTE, @TAR_QTD, @TAR_PARAMETRO_TIME_WORK_STOP_MACHINE, @TAR_PARAMETRO_TEMPO_QUEBRA_DE_LOTE, @ROT_SEQ_TRANFORMACAO, @FPR_SEQ_REPETICAO, @TAR_PERFORMANCE_MAX_VERDE, @TAR_PERFORMANCE_MIN_VERDE, @TAR_SETUP_MAX_VERDE, @TAR_SETUP_MIN_VERDE, @TAR_SETUPA_MAX_VERDE, @TAR_SETUPA_MIN_VERDE, @TAR_PERFORMANCE_MIN_AMARELO, @TAR_SETUP_MAX_AMARELO, @TAR_SETUPA_MAX_AMARELO, @TAR_OBS_OP_PARCIAL, @TAR_OCO_ID_OP_PARCIAL, @TAR_COR_PERFORMANCE, @TAR_COR_SETUP_GERAL, @TAR_COR_SETUP, @TAR_COR_SETUPA, @TAR_DIA_TURMA_D, @FEE_QTD_PECAS_POR_PULSO, @TAR_QTD_PERDAS, @TAR_DATA_INICIAL, @TAR_DATA_FINAL, @TAR_APROVADO, @TAR_TEMPO_PRODUZINDO, @OperationalEntityId, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
                ...
                OperationalEntityId = TargetProduto.OperationalEntityId,
        ...
        public QueryModel UpdateOperationalEntityId(int tar_id, string value)
        {
            this.Query = $@" UPDATE [TargetProduto] SET [OperationalEntityId] = @OperationalEntityId WHERE [TAR_ID] = @TAR_ID ";
            this.Parameters = new
            {
