...
namespace Query.Write
{
    public class MaquinaQueryWrite : QueryBase, IMaquinaQueryWrite
    {
        ...
        {
            this.Query = $@" UPDATE [Maquina] SET [OperationalEntityId] = @OperationalEntityId WHERE [Id] = @Id ";
            this.Parameters = new
            {
