...
namespace Query.Write
{
    public class ProdutoQueryWrite : QueryBase, IProdutoQueryWrite
    {
        ...
        {
            this.Query = $@" UPDATE [Produto] SET [OperationalEntityId] = @OperationalEntityId WHERE [Id] = @Id ";
            this.Parameters = new
            {
