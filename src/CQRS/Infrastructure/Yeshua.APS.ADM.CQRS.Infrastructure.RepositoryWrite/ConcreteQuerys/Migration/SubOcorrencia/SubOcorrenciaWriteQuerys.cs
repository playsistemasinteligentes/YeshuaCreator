...
namespace Query.Write
{
    public class SubOcorrenciaQueryWrite : QueryBase, ISubOcorrenciaQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO [SubOcorrencia] ([SUB_ID], [SUB_DESCRICAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId]) OUTPUT INSERTED.[Id] VALUES(@SUB_ID, @SUB_DESCRICAO, @OperationalEntityId, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
                SUB_ID = SubOcorrencia.SUB_ID,
                SUB_DESCRICAO = SubOcorrencia.SUB_DESCRICAO,
                OperationalEntityId = SubOcorrencia.OperationalEntityId,
        ...
        {
            this.Query = $@" UPDATE [SubOcorrencia] SET [OperationalEntityId] = @OperationalEntityId WHERE [Id] = @Id ";
            this.Parameters = new
            {
