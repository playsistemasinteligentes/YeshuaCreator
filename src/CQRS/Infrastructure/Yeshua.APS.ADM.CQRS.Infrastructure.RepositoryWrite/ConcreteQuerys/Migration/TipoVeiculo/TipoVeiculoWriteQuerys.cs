...
namespace Query.Write
{
    public class TipoVeiculoQueryWrite : QueryBase, ITipoVeiculoQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO TipoVeiculo (TIP_DESCRICAO, TIP_QTD_DISPONIVEL, TIP_VALOR_KM, TIP_VALOR_DIARIA, TIP_VALOR_AJUDANTE, TIP_QTD_EIXOS, TIP_VELOCIDADE_MEDIA, TIP_CAPACIDADE_ALTURA, TIP_CAPACIDADE_COMPRIMENTO, TIP_CAPACIDADE_LARGURA, TIP_CAPACIDADE_ALTURA_PESCOCO_E, TIP_CAPACIDADE_COMPRIMENTO_PESCOCO_E, TIP_CAPACIDADE_LARGURA_PESCOCO_E, TIP_CAPACIDADE_ALTURA_PESCOCO_D, TIP_CAPACIDADE_COMPRIMENTO_PESCOCO_D, TIP_CAPACIDADE_LARGURA_PESCOCO_D, TIP_CAPACIDADE_M3, TenantID, Deleted, Changed, UserId) OUTPUT INSERTED.Id VALUES(@TIP_DESCRICAO, @TIP_QTD_DISPONIVEL, @TIP_VALOR_KM, @TIP_VALOR_DIARIA, @TIP_VALOR_AJUDANTE, @TIP_QTD_EIXOS, @TIP_VELOCIDADE_MEDIA, @TIP_CAPACIDADE_ALTURA, @TIP_CAPACIDADE_COMPRIMENTO, @TIP_CAPACIDADE_LARGURA, @TIP_CAPACIDADE_ALTURA_PESCOCO_E, @TIP_CAPACIDADE_COMPRIMENTO_PESCOCO_E, @TIP_CAPACIDADE_LARGURA_PESCOCO_E, @TIP_CAPACIDADE_ALTURA_PESCOCO_D, @TIP_CAPACIDADE_COMPRIMENTO_PESCOCO_D, @TIP_CAPACIDADE_LARGURA_PESCOCO_D, @TIP_CAPACIDADE_M3, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
