...
namespace Query.Write
{
    public class UsuarioObjetoControlavelQueryWrite : QueryBase, IUsuarioObjetoControlavelQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO [UsuarioObjetoControlavel] ([USE_ID], [OBJ_ID], [USU_OBJETO_ACAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId]) OUTPUT INSERTED.[Id] VALUES(@USE_ID, @OBJ_ID, @USU_OBJETO_ACAO, @OperationalEntityId, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
                ...
                OperationalEntityId = UsuarioObjetoControlavel.OperationalEntityId,
        ...
        {
            this.Query = $@" UPDATE [UsuarioObjetoControlavel] SET [OperationalEntityId] = @OperationalEntityId WHERE [Id] = @Id ";
            this.Parameters = new
            {
