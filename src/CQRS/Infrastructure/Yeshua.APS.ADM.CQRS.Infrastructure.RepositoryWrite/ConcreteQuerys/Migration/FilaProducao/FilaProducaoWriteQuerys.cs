    ...
    public class FilaProducaoQueryWrite : QueryBase, IFilaProducaoQueryWrite
    {
        ...
        public QueryModel InserirFilaProducaoQuery(IFilaProducaoEntity FilaProducao)
        {
            ...
            this.Parameters = new
            {
                ...
                OperationalEntityId = FilaProducao.OperationalEntityId,
        ...
        {
            this.Query = $@" UPDATE [FilaProducao] SET [OperationalEntityId] = @OperationalEntityId WHERE [Id] = @Id ";
            this.Parameters = new
            {
