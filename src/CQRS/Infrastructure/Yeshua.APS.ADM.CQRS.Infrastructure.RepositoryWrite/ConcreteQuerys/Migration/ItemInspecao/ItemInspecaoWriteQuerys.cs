...
namespace Query.Write
{
    public class ItemInspecaoQueryWrite : QueryBase, IItemInspecaoQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO [ItemInspecao] ([ITI_ID], [ITI_DESC], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId]) OUTPUT INSERTED.[Id] VALUES(@ITI_ID, @ITI_DESC, @OperationalEntityId, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
                ITI_ID = ItemInspecao.ITI_ID,
                ITI_DESC = ItemInspecao.ITI_DESC,
                OperationalEntityId = ItemInspecao.OperationalEntityId,
        ...
        {
            this.Query = $@" UPDATE [ItemInspecao] SET [OperationalEntityId] = @OperationalEntityId WHERE [Id] = @Id ";
            this.Parameters = new
            {
