...
namespace Query.Write
{
    public class TipoInspecaoItensQueryWrite : QueryBase, ITipoInspecaoItensQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO [TipoInspecaoItens] ([TII_ID], [TIV_ID], [ITI_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId]) OUTPUT INSERTED.[Id] VALUES(@TII_ID, @TIV_ID, @ITI_ID, @OperationalEntityId, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
                TII_ID = TipoInspecaoItens.TII_ID,
                TIV_ID = TipoInspecaoItens.TIV_ID,
                ITI_ID = TipoInspecaoItens.ITI_ID,
                OperationalEntityId = TipoInspecaoItens.OperationalEntityId,
        ...
        {
            this.Query = $@" UPDATE [TipoInspecaoItens] SET [OperationalEntityId] = @OperationalEntityId WHERE [Id] = @Id ";
            this.Parameters = new
            {
