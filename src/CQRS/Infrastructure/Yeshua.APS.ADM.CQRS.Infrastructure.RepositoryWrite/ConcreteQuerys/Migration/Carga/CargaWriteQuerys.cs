...
namespace Query.Write
{
    public class CargaQueryWrite : QueryBase, ICargaQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO [Carga] ([CAR_ID], [CAR_PREVISAO_MATERIA_PRIMA], [CAR_DATA_INICIO_PREVISTO], [CAR_DATA_INICIO_REALIZADO], [CAR_DATA_FIM_PREVISTO], [CAR_DATA_FIM_REALIZADO], [CAR_INICIO_JANELA_EMBARQUE], [CAR_FIM_JANELA_EMBARQUE], [CAR_EMBARQUE_ALVO], [CAR_STATUS], [CAR_PESO_TEORICO], [CAR_VOLUME_TEORICO], [CAR_PESO_REAL], [CAR_VOLUME_REAL], [CAR_PESO_EMBALAGEM], [CAR_PESO_ENTRADA], [CAR_PESO_SAIDA], [CAR_ID_DOCA], [VEI_PLACA], [TIP_ID], [TRA_ID], [CAR_GRUPO_PRODUTIVO], [ROT_ID], [CAR_OBSERVACAO_DE_TRANSPORTE], [CAR_JUSTIFICATIVA_DE_CARREGAMENTO], [OCO_ID], [CAR_ID_JUNTADA], [CAR_OBSERVACAO_OTIMIZADOR], [CAR_ID_INTEGRACAO_BALANCA], [CAR_PESAGEM_LIBERADA], [CAR_OBS_LIERACAO], [OCO_ID_LIERACAO], [CAR_DATA_ENTRADA_VEICULO], [CAR_DATA_SAIDA_VEICULO], [CAR_DATA_ROMANEIO_CONSOLIDADO], [CAR_DIA_TURMA_ROMANEIO_CONSOLIDADO], [CAR_DIFERENCA_PESAGEM], [CAR_DATA_AGENCIAMENTO], [TURN_ID], [TURM_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId]) OUTPUT INSERTED.[Id] VALUES(@CAR_ID, @CAR_PREVISAO_MATERIA_PRIMA, @CAR_DATA_INICIO_PREVISTO, @CAR_DATA_INICIO_REALIZADO, @CAR_DATA_FIM_PREVISTO, @CAR_DATA_FIM_REALIZADO, @CAR_INICIO_JANELA_EMBARQUE, @CAR_FIM_JANELA_EMBARQUE, @CAR_EMBARQUE_ALVO, @CAR_STATUS, @CAR_PESO_TEORICO, @CAR_VOLUME_TEORICO, @CAR_PESO_REAL, @CAR_VOLUME_REAL, @CAR_PESO_EMBALAGEM, @CAR_PESO_ENTRADA, @CAR_PESO_SAIDA, @CAR_ID_DOCA, @VEI_PLACA, @TIP_ID, @TRA_ID, @CAR_GRUPO_PRODUTIVO, @ROT_ID, @CAR_OBSERVACAO_DE_TRANSPORTE, @CAR_JUSTIFICATIVA_DE_CARREGAMENTO, @OCO_ID, @CAR_ID_JUNTADA, @CAR_OBSERVACAO_OTIMIZADOR, @CAR_ID_INTEGRACAO_BALANCA, @CAR_PESAGEM_LIBERADA, @CAR_OBS_LIERACAO, @OCO_ID_LIERACAO, @CAR_DATA_ENTRADA_VEICULO, @CAR_DATA_SAIDA_VEICULO, @CAR_DATA_ROMANEIO_CONSOLIDADO, @CAR_DIA_TURMA_ROMANEIO_CONSOLIDADO, @CAR_DIFERENCA_PESAGEM, @CAR_DATA_AGENCIAMENTO, @TURN_ID, @TURM_ID, @OperationalEntityId, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
                CAR_ID = Carga.CAR_ID,
                ...
                OperationalEntityId = Carga.OperationalEntityId,
        ...
        {
            this.Query = $@" UPDATE [Carga] SET [OperationalEntityId] = @OperationalEntityId WHERE [Id] = @Id ";
            this.Parameters = new
            {
