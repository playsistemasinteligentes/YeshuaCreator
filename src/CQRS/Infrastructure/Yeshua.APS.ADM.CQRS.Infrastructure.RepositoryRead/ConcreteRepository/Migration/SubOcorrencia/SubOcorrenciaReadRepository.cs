...
namespace Read.Repository
{
    public partial class SubOcorrenciaReadRepository : ISubOcorrenciaReadRepository
    {
       ...
       protected readonly ISubOcorrenciaQueryRead _query;
        ...
        partial void TryGetSubOcorrenciaCustom(Command.Read.SubOcorrenciaReadCommand command, ref DataPagination<SubOcorrenciaDTO> result, ref bool handled);
        ...
        public SubOcorrenciaDTO FirstByOperationalEntityId(string value )
        {
        ...
        public IEnumerable<SubOcorrenciaDTO> GetAllByOperationalEntityId(string value )
        {
            var query = _query.FirstByOperationalEntityIdQuery(value );
