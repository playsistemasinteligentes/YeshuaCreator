...
namespace Read.Repository
{
    public partial class GrupoMaquinaReadRepository : IGrupoMaquinaReadRepository
    {
       ...
       protected readonly IGrupoMaquinaQueryRead _query;
        ...
        partial void TryGetGrupoMaquinaCustom(Command.Read.GrupoMaquinaReadCommand command, ref DataPagination<GrupoMaquinaDTO> result, ref bool handled);
        ...
        public GrupoMaquinaDTO FirstByOperationalEntityId(string value )
        {
        ...
        public IEnumerable<GrupoMaquinaDTO> GetAllByOperationalEntityId(string value )
        {
            var query = _query.FirstByOperationalEntityIdQuery(value );
