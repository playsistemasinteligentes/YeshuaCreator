...
namespace Read.Repository
{
    public partial class ConfiguracoesReadRepository : IConfiguracoesReadRepository
    {
       ...
       protected readonly IConfiguracoesQueryRead _query;
        ...
        partial void TryGetConfiguracoesCustom(Command.Read.ConfiguracoesReadCommand command, ref DataPagination<ConfiguracoesDTO> result, ref bool handled);
        ...
        public ConfiguracoesDTO FirstByOperationalEntityId(string value )
        {
        ...
        public IEnumerable<ConfiguracoesDTO> GetAllByOperationalEntityId(string value )
        {
            var query = _query.FirstByOperationalEntityIdQuery(value );
