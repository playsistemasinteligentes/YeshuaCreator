...
namespace Read.Repository
{
    public partial class UsuarioPerfilReadRepository : IUsuarioPerfilReadRepository
    {
       ...
       protected readonly IUsuarioPerfilQueryRead _query;
        ...
        partial void TryGetUsuarioPerfilCustom(Command.Read.UsuarioPerfilReadCommand command, ref DataPagination<UsuarioPerfilDTO> result, ref bool handled);
        ...
        public UsuarioPerfilDTO FirstByOperationalEntityId(string value )
        {
        ...
        public IEnumerable<UsuarioPerfilDTO> GetAllByOperationalEntityId(string value )
        {
            var query = _query.FirstByOperationalEntityIdQuery(value );
