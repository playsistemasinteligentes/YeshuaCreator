...
namespace Read.Repository
{
    public partial class TiposVincoProdutosReadRepository : ITiposVincoProdutosReadRepository
    {
       ...
       protected readonly ITiposVincoProdutosQueryRead _query;
        ...
        partial void TryGetTiposVincoProdutosCustom(Command.Read.TiposVincoProdutosReadCommand command, ref DataPagination<TiposVincoProdutosDTO> result, ref bool handled);
        ...
        public TiposVincoProdutosDTO FirstByOperationalEntityId(string value )
        {
        ...
        public IEnumerable<TiposVincoProdutosDTO> GetAllByOperationalEntityId(string value )
        {
            var query = _query.FirstByOperationalEntityIdQuery(value );
