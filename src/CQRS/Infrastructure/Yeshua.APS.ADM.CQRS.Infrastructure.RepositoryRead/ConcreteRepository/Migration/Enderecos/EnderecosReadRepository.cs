...
namespace Read.Repository
{
    public partial class EnderecosReadRepository : IEnderecosReadRepository
    {
       ...
       protected readonly IEnderecosQueryRead _query;
        ...
        partial void TryGetEnderecosCustom(Command.Read.EnderecosReadCommand command, ref DataPagination<EnderecosDTO> result, ref bool handled);
        ...
        public EnderecosDTO FirstByOperationalEntityId(string value )
        {
        ...
        public IEnumerable<EnderecosDTO> GetAllByOperationalEntityId(string value )
        {
            var query = _query.FirstByOperationalEntityIdQuery(value );
