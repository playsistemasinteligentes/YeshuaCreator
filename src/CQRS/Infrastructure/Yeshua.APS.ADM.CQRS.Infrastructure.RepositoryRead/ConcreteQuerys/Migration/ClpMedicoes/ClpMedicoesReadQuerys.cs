...
namespace Query.Read 
{
    public class ClpMedicoesQueryRead : QueryBase, IClpMedicoesQueryRead
    {
        ...
        public QueryModel ClpMedicoesQuery(Command.Read.ClpMedicoesReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Id2], [MaquinaId], [DataInicio], [DataFim], [Emissao], [Quantidade], [Grupo], [Status], [TurnoId], [TurmaId], [IdLoteClp], [OcorrenciaId], [Fase], [ClpOrigem], [CLP_LOTE], [COMPACTA], [BOL_ID], [COR_SEQUENCIA], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [ClpMedicoes] ";
