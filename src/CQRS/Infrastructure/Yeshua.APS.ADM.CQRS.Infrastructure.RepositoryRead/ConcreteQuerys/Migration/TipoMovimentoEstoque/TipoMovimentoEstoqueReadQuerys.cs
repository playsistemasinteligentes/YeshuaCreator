...
{
    public class TipoMovimentoEstoqueQueryRead : QueryBase, ITipoMovimentoEstoqueQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TipoMovimentoEstoqueQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TipoMovimentoEstoqueQuery(Command.Read.TipoMovimentoEstoqueReadCommand Command )
        {
            ...
            this.Query = $@" select [TIP_ID], [TIP_DESCRICAO], [TIP_TYPE], [SPR], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TipoMovimentoEstoque] ";
if (!string.IsNullOrEmpty(Command.TIP_ID)) dict["TIP_ID"] = $"%{Command.TIP_ID}%";
if (!string.IsNullOrEmpty(Command.TIP_ID)) whereClauses.Add($"[TIP_ID] like @TIP_ID");
...
if (Command.TIP_TYPE.HasValue) dict["TIP_TYPE"] = Command.TIP_TYPE.Value;
if (Command.TIP_TYPE.HasValue) whereClauses.Add($"[TIP_TYPE] = @TIP_TYPE");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [TIP_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByTIP_IDQuery(string value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TipoMovimentoEstoque] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TIP_TYPE"] = value; //04
                      whereClauses.Add($" [TIP_TYPE] = @TIP_TYPE ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TIP_TYPE"] = value; //06
                      whereClauses.Add($" [TIP_TYPE] = @TIP_TYPE ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
