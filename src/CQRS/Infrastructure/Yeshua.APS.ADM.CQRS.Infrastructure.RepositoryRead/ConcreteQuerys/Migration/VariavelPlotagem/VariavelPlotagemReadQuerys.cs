...
{
    public class VariavelPlotagemQueryRead : QueryBase, IVariavelPlotagemQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public VariavelPlotagemQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel VariavelPlotagemQuery(Command.Read.VariavelPlotagemReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [VAR_ID], [PLO_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [VariavelPlotagem] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [VariavelPlotagem] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
