...
{
    public class VincoQueryRead : QueryBase, IVincoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public VincoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel VincoQuery(Command.Read.VincoReadCommand Command )
        {
            ...
            this.Query = $@" select [VIN_ID], [VIN_DESCRICAO], [VIN_ID_DESLOCAMENTO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Vinco] ";
if (Command.VIN_ID.HasValue) dict["VIN_ID"] = Command.VIN_ID.Value;
if (Command.VIN_ID.HasValue) whereClauses.Add($"[VIN_ID] = @VIN_ID");
if (!string.IsNullOrEmpty(Command.VIN_DESCRICAO)) dict["VIN_DESCRICAO"] = $"%{Command.VIN_DESCRICAO}%";
if (!string.IsNullOrEmpty(Command.VIN_DESCRICAO)) whereClauses.Add($"[VIN_DESCRICAO] like @VIN_DESCRICAO");
if (!string.IsNullOrEmpty(Command.VIN_ID_DESLOCAMENTO)) dict["VIN_ID_DESLOCAMENTO"] = $"%{Command.VIN_ID_DESLOCAMENTO}%";
if (!string.IsNullOrEmpty(Command.VIN_ID_DESLOCAMENTO)) whereClauses.Add($"[VIN_ID_DESLOCAMENTO] like @VIN_ID_DESLOCAMENTO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [VIN_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByVIN_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Vinco] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["VIN_DESCRICAO"] = value; //04
                      whereClauses.Add($" [VIN_DESCRICAO] = @VIN_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["VIN_ID_DESLOCAMENTO"] = value; //04
                      whereClauses.Add($" [VIN_ID_DESLOCAMENTO] = @VIN_ID_DESLOCAMENTO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["VIN_DESCRICAO"] = value; //06
                      whereClauses.Add($" [VIN_DESCRICAO] = @VIN_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["VIN_ID_DESLOCAMENTO"] = value; //06
                      whereClauses.Add($" [VIN_ID_DESLOCAMENTO] = @VIN_ID_DESLOCAMENTO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
