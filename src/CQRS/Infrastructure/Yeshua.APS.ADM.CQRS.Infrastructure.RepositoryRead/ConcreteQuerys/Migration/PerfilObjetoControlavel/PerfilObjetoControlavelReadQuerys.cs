...
{
    public class PerfilObjetoControlavelQueryRead : QueryBase, IPerfilObjetoControlavelQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public PerfilObjetoControlavelQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel PerfilObjetoControlavelQuery(Command.Read.PerfilObjetoControlavelReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [PER_ID], [OBJ_ID], [PEO_ACAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [PerfilObjetoControlavel] ";
...
if (!string.IsNullOrEmpty(Command.PEO_ACAO)) dict["PEO_ACAO"] = $"%{Command.PEO_ACAO}%";
if (!string.IsNullOrEmpty(Command.PEO_ACAO)) whereClauses.Add($"[PEO_ACAO] like @PEO_ACAO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [PerfilObjetoControlavel] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PEO_ACAO"] = value; //04
                      whereClauses.Add($" [PEO_ACAO] = @PEO_ACAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PEO_ACAO"] = value; //06
                      whereClauses.Add($" [PEO_ACAO] = @PEO_ACAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
