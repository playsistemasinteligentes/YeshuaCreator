...
{
    public class T_FavoritosQueryRead : QueryBase, IT_FavoritosQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public T_FavoritosQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel T_FavoritosQuery(Command.Read.T_FavoritosReadCommand Command )
        {
            ...
            this.Query = $@" select [IDFAVORITO], [USE_ID], [ID_INDICADOR], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [T_Favoritos] ";
if (Command.IDFAVORITO.HasValue) dict["IDFAVORITO"] = Command.IDFAVORITO.Value;
if (Command.IDFAVORITO.HasValue) whereClauses.Add($"[IDFAVORITO] = @IDFAVORITO");
if (Command.USE_ID.HasValue) dict["USE_ID"] = Command.USE_ID.Value;
if (Command.USE_ID.HasValue) whereClauses.Add($"[USE_ID] = @USE_ID");
if (Command.ID_INDICADOR.HasValue) dict["ID_INDICADOR"] = Command.ID_INDICADOR.Value;
if (Command.ID_INDICADOR.HasValue) whereClauses.Add($"[ID_INDICADOR] = @ID_INDICADOR");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [IDFAVORITO] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIDFAVORITOQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [T_Favoritos] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IDFAVORITO"] = value; //04
                      whereClauses.Add($" [IDFAVORITO] = @IDFAVORITO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ID_INDICADOR"] = value; //04
                      whereClauses.Add($" [ID_INDICADOR] = @ID_INDICADOR ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IDFAVORITO"] = value; //06
                      whereClauses.Add($" [IDFAVORITO] = @IDFAVORITO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ID_INDICADOR"] = value; //06
                      whereClauses.Add($" [ID_INDICADOR] = @ID_INDICADOR ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
