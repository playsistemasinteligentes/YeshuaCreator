...
namespace Query.Read 
{
    public class yOutboxQueryRead : QueryBase, IyOutboxQueryRead
    {
        ...
        public QueryModel yOutboxQuery(Command.Read.yOutboxReadCommand Command , bool TakeOffTenantID = false)
        {
            ...
            this.Query = $@" select [Id], [MessageId], [Type], [EntityType], [EntityId], [CorrelationId], [Payload], [Status], [TransportType], [TransportData], [CreatedAt], [SentAt], [RetryCount], [LastError], [ProcessingAt], [NextAttemptAt], [SagaId], [SagaStepId], [TenantID], [OperationalEntityId], [Deleted], [Changed], [UserId] from [yOutbox] ";
...
if (Command.TransportType.HasValue)
{
    dict["TransportType"] = Command.TransportType.Value;
    whereClauses.Add($"[TransportType] = @TransportType");
}
