...
{
    public class OrcamentoQueryRead : QueryBase, IOrcamentoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public OrcamentoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel OrcamentoQuery(Command.Read.OrcamentoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [ORC_ID], [REP_ID], [CON_ID], [ORC_TIPO_FRETE], [ORC_EMISSAO], [CLI_ID], [VER_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Orcamento] ";
...
if (!string.IsNullOrEmpty(Command.ORC_TIPO_FRETE)) dict["ORC_TIPO_FRETE"] = $"%{Command.ORC_TIPO_FRETE}%";
if (!string.IsNullOrEmpty(Command.ORC_TIPO_FRETE)) whereClauses.Add($"[ORC_TIPO_FRETE] like @ORC_TIPO_FRETE");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Orcamento] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ORC_TIPO_FRETE"] = value; //04
                      whereClauses.Add($" [ORC_TIPO_FRETE] = @ORC_TIPO_FRETE ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ORC_EMISSAO"] = value; //04
                      whereClauses.Add($" [ORC_EMISSAO] = @ORC_EMISSAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ORC_TIPO_FRETE"] = value; //06
                      whereClauses.Add($" [ORC_TIPO_FRETE] = @ORC_TIPO_FRETE ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ORC_EMISSAO"] = value; //06
                      whereClauses.Add($" [ORC_EMISSAO] = @ORC_EMISSAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
