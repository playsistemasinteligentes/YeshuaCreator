...
{
    public class CotasQueryRead : QueryBase, ICotasQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public CotasQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel CotasQuery(Command.Read.CotasReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [COT_ID], [COT_DATA_DE], [COT_DATA_ATE], [COT_VALOR], [COT_OCUPADO], [REP_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Cotas] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (Command.COT_ID.HasValue) dict["COT_ID"] = Command.COT_ID.Value;
if (Command.COT_ID.HasValue) whereClauses.Add($"[COT_ID] = @COT_ID");
if (Command.REP_ID.HasValue) dict["REP_ID"] = Command.REP_ID.Value;
if (Command.REP_ID.HasValue) whereClauses.Add($"[REP_ID] = @REP_ID");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Cotas] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["COT_ID"] = value; //04
                      whereClauses.Add($" [COT_ID] = @COT_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["COT_DATA_DE"] = value; //04
                      whereClauses.Add($" [COT_DATA_DE] = @COT_DATA_DE ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["COT_DATA_ATE"] = value; //04
                      whereClauses.Add($" [COT_DATA_ATE] = @COT_DATA_ATE ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["COT_VALOR"] = value; //04
                      whereClauses.Add($" [COT_VALOR] = @COT_VALOR ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["COT_OCUPADO"] = value; //04
                      whereClauses.Add($" [COT_OCUPADO] = @COT_OCUPADO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["COT_ID"] = value; //06
                      whereClauses.Add($" [COT_ID] = @COT_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["COT_DATA_DE"] = value; //06
                      whereClauses.Add($" [COT_DATA_DE] = @COT_DATA_DE ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["COT_DATA_ATE"] = value; //06
                      whereClauses.Add($" [COT_DATA_ATE] = @COT_DATA_ATE ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["COT_VALOR"] = value; //06
                      whereClauses.Add($" [COT_VALOR] = @COT_VALOR ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["COT_OCUPADO"] = value; //06
                      whereClauses.Add($" [COT_OCUPADO] = @COT_OCUPADO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
