...
{
    public class PeriodicidadeTesteQueryRead : QueryBase, IPeriodicidadeTesteQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public PeriodicidadeTesteQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel PeriodicidadeTesteQuery(Command.Read.PeriodicidadeTesteReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [PER_ID], [PER_QTD], [UNI_ID], [GRP_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [PeriodicidadeTeste] ";
...
if (!string.IsNullOrEmpty(Command.PER_QTD)) dict["PER_QTD"] = $"%{Command.PER_QTD}%";
if (!string.IsNullOrEmpty(Command.PER_QTD)) whereClauses.Add($"[PER_QTD] like @PER_QTD");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [PeriodicidadeTeste] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PER_QTD"] = value; //04
                      whereClauses.Add($" [PER_QTD] = @PER_QTD ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PER_QTD"] = value; //06
                      whereClauses.Add($" [PER_QTD] = @PER_QTD ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
