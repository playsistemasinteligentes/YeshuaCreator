...
{
    public class TipoDispositivoQueryRead : QueryBase, ITipoDispositivoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TipoDispositivoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TipoDispositivoQuery(Command.Read.TipoDispositivoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [TDI_ID], [TDI_DESCRICAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TipoDispositivo] ";
...
if (!string.IsNullOrEmpty(Command.TDI_DESCRICAO)) dict["TDI_DESCRICAO"] = $"%{Command.TDI_DESCRICAO}%";
if (!string.IsNullOrEmpty(Command.TDI_DESCRICAO)) whereClauses.Add($"[TDI_DESCRICAO] like @TDI_DESCRICAO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TipoDispositivo] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TDI_DESCRICAO"] = value; //04
                      whereClauses.Add($" [TDI_DESCRICAO] = @TDI_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TDI_DESCRICAO"] = value; //06
                      whereClauses.Add($" [TDI_DESCRICAO] = @TDI_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
