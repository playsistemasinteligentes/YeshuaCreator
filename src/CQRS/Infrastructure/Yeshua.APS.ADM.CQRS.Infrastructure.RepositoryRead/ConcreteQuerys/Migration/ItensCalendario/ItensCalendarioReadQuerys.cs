...
{
    public class ItensCalendarioQueryRead : QueryBase, IItensCalendarioQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public ItensCalendarioQueryRead(IExecutionContext executionContext)
        {
...
if (!string.IsNullOrEmpty(Command.ICA_OBSERVACAO)) whereClauses.Add($"[ICA_OBSERVACAO] like @ICA_OBSERVACAO");
if (Command.ICA_TIPO.HasValue) dict["ICA_TIPO"] = Command.ICA_TIPO.Value;
if (Command.ICA_TIPO.HasValue) whereClauses.Add($"[ICA_TIPO] = @ICA_TIPO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [ICA_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_ID"] = value; //04
                      whereClauses.Add($" [ICA_ID] = @ICA_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_DATA_DE"] = value; //04
                      whereClauses.Add($" [ICA_DATA_DE] = @ICA_DATA_DE ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_DATA_ATE"] = value; //04
                      whereClauses.Add($" [ICA_DATA_ATE] = @ICA_DATA_ATE ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_OBSERVACAO"] = value; //04
                      whereClauses.Add($" [ICA_OBSERVACAO] = @ICA_OBSERVACAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_TIPO"] = value; //04
                      whereClauses.Add($" [ICA_TIPO] = @ICA_TIPO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_LIMPESA_MAQUINA"] = value; //04
                      whereClauses.Add($" [ICA_LIMPESA_MAQUINA] = @ICA_LIMPESA_MAQUINA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_ID"] = value; //06
                      whereClauses.Add($" [ICA_ID] = @ICA_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_DATA_DE"] = value; //06
                      whereClauses.Add($" [ICA_DATA_DE] = @ICA_DATA_DE ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_DATA_ATE"] = value; //06
                      whereClauses.Add($" [ICA_DATA_ATE] = @ICA_DATA_ATE ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_OBSERVACAO"] = value; //06
                      whereClauses.Add($" [ICA_OBSERVACAO] = @ICA_OBSERVACAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_TIPO"] = value; //06
                      whereClauses.Add($" [ICA_TIPO] = @ICA_TIPO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ICA_LIMPESA_MAQUINA"] = value; //06
                      whereClauses.Add($" [ICA_LIMPESA_MAQUINA] = @ICA_LIMPESA_MAQUINA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
