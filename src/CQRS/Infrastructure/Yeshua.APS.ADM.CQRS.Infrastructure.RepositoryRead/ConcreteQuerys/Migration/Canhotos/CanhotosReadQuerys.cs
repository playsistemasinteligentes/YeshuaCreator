...
{
    public class CanhotosQueryRead : QueryBase, ICanhotosQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public CanhotosQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel CanhotosQuery(Command.Read.CanhotosReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [CAR_ID], [ORD_ID], [NOT_ID], [CAN_DATA_ENTREGA], [CAN_IMG], [CAN_LAT_ENTREGA], [CAN_LONG_ENTREGA], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Canhotos] ";
...
if (!string.IsNullOrEmpty(Command.CAN_IMG)) dict["CAN_IMG"] = $"%{Command.CAN_IMG}%";
if (!string.IsNullOrEmpty(Command.CAN_IMG)) whereClauses.Add($"[CAN_IMG] like @CAN_IMG");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Canhotos] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CAN_DATA_ENTREGA"] = value; //04
                      whereClauses.Add($" [CAN_DATA_ENTREGA] = @CAN_DATA_ENTREGA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CAN_IMG"] = value; //04
                      whereClauses.Add($" [CAN_IMG] = @CAN_IMG ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CAN_LAT_ENTREGA"] = value; //04
                      whereClauses.Add($" [CAN_LAT_ENTREGA] = @CAN_LAT_ENTREGA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CAN_LONG_ENTREGA"] = value; //04
                      whereClauses.Add($" [CAN_LONG_ENTREGA] = @CAN_LONG_ENTREGA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CAN_DATA_ENTREGA"] = value; //06
                      whereClauses.Add($" [CAN_DATA_ENTREGA] = @CAN_DATA_ENTREGA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CAN_IMG"] = value; //06
                      whereClauses.Add($" [CAN_IMG] = @CAN_IMG ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CAN_LAT_ENTREGA"] = value; //06
                      whereClauses.Add($" [CAN_LAT_ENTREGA] = @CAN_LAT_ENTREGA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CAN_LONG_ENTREGA"] = value; //06
                      whereClauses.Add($" [CAN_LONG_ENTREGA] = @CAN_LONG_ENTREGA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
