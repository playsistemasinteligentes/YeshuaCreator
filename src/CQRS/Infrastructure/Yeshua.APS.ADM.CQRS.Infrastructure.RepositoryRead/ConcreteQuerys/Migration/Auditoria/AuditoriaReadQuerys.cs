...
{
    public class AuditoriaQueryRead : QueryBase, IAuditoriaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public AuditoriaQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel AuditoriaQuery(Command.Read.AuditoriaReadCommand Command )
        {
            ...
            this.Query = $@" select [ID], [DATA], [USE_ID], [ROTINA], [HISTORICO], [CHAVE], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Auditoria] ";
...
if (!string.IsNullOrEmpty(Command.ROTINA)) dict["ROTINA"] = $"%{Command.ROTINA}%";
if (!string.IsNullOrEmpty(Command.ROTINA)) whereClauses.Add($"[ROTINA] like @ROTINA");
if (!string.IsNullOrEmpty(Command.HISTORICO)) dict["HISTORICO"] = $"%{Command.HISTORICO}%";
if (!string.IsNullOrEmpty(Command.HISTORICO)) whereClauses.Add($"[HISTORICO] like @HISTORICO");
if (!string.IsNullOrEmpty(Command.CHAVE)) dict["CHAVE"] = $"%{Command.CHAVE}%";
if (!string.IsNullOrEmpty(Command.CHAVE)) whereClauses.Add($"[CHAVE] like @CHAVE");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Auditoria] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ROTINA"] = value; //04
                      whereClauses.Add($" [ROTINA] = @ROTINA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["HISTORICO"] = value; //04
                      whereClauses.Add($" [HISTORICO] = @HISTORICO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CHAVE"] = value; //04
                      whereClauses.Add($" [CHAVE] = @CHAVE ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ROTINA"] = value; //06
                      whereClauses.Add($" [ROTINA] = @ROTINA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["HISTORICO"] = value; //06
                      whereClauses.Add($" [HISTORICO] = @HISTORICO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CHAVE"] = value; //06
                      whereClauses.Add($" [CHAVE] = @CHAVE ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
