...
{
    public class OndaQueryRead : QueryBase, IOndaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public OndaQueryRead(IExecutionContext executionContext)
        {
...
if (Command.OND_PROFUNDIDADE_VINCO.HasValue) whereClauses.Add($"OND_PROFUNDIDADE_VINCO = @OND_PROFUNDIDADE_VINCO");
if (!string.IsNullOrEmpty(Command.OND_ID_INTEGRACAO)) dict["OND_ID_INTEGRACAO"] = $"%{Command.OND_ID_INTEGRACAO}%";
...
if (Command.UserId.HasValue) whereClauses.Add($"UserId = @UserId");
            ...
            Query += " ORDER BY OND_ID OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_ESPESSURA"] = value; //04
                      whereClauses.Add($" OND_ESPESSURA = @OND_ESPESSURA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_PESO_COLA"] = value; //04
                      whereClauses.Add($" OND_PESO_COLA = @OND_PESO_COLA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_RENDIMENTO_ONDA_1"] = value; //04
                      whereClauses.Add($" OND_RENDIMENTO_ONDA_1 = @OND_RENDIMENTO_ONDA_1 ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_RENDIMENTO_ONDA_2"] = value; //04
                      whereClauses.Add($" OND_RENDIMENTO_ONDA_2 = @OND_RENDIMENTO_ONDA_2 ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_PROFUNDIDADE_VINCO"] = value; //04
                      whereClauses.Add($" OND_PROFUNDIDADE_VINCO = @OND_PROFUNDIDADE_VINCO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_ID_INTEGRACAO"] = value; //04
                      whereClauses.Add($" OND_ID_INTEGRACAO = @OND_ID_INTEGRACAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_ESPESSURA"] = value; //06
                      whereClauses.Add($" OND_ESPESSURA = @OND_ESPESSURA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_PESO_COLA"] = value; //06
                      whereClauses.Add($" OND_PESO_COLA = @OND_PESO_COLA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_RENDIMENTO_ONDA_1"] = value; //06
                      whereClauses.Add($" OND_RENDIMENTO_ONDA_1 = @OND_RENDIMENTO_ONDA_1 ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_RENDIMENTO_ONDA_2"] = value; //06
                      whereClauses.Add($" OND_RENDIMENTO_ONDA_2 = @OND_RENDIMENTO_ONDA_2 ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_PROFUNDIDADE_VINCO"] = value; //06
                      whereClauses.Add($" OND_PROFUNDIDADE_VINCO = @OND_PROFUNDIDADE_VINCO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["OND_ID_INTEGRACAO"] = value; //06
                      whereClauses.Add($" OND_ID_INTEGRACAO = @OND_ID_INTEGRACAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
