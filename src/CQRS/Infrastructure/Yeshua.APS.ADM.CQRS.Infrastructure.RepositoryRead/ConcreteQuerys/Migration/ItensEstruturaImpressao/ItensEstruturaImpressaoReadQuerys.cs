...
{
    public class ItensEstruturaImpressaoQueryRead : QueryBase, IItensEstruturaImpressaoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public ItensEstruturaImpressaoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel ItensEstruturaImpressaoQuery(Command.Read.ItensEstruturaImpressaoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [IES_CUSTOM_FONT_SIZE], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [ItensEstruturaImpressao] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (Command.IES_CUSTOM_FONT_SIZE.HasValue) dict["IES_CUSTOM_FONT_SIZE"] = Command.IES_CUSTOM_FONT_SIZE.Value;
if (Command.IES_CUSTOM_FONT_SIZE.HasValue) whereClauses.Add($"[IES_CUSTOM_FONT_SIZE] = @IES_CUSTOM_FONT_SIZE");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [ItensEstruturaImpressao] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IES_CUSTOM_FONT_SIZE"] = value; //04
                      whereClauses.Add($" [IES_CUSTOM_FONT_SIZE] = @IES_CUSTOM_FONT_SIZE ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IES_CUSTOM_FONT_SIZE"] = value; //06
                      whereClauses.Add($" [IES_CUSTOM_FONT_SIZE] = @IES_CUSTOM_FONT_SIZE ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
