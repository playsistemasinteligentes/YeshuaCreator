...
{
    public class MesesQueryRead : QueryBase, IMesesQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public MesesQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel MesesQuery(Command.Read.MesesReadCommand Command )
        {
            ...
            this.Query = $@" select [MES], [fator], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Meses] ";
if (!string.IsNullOrEmpty(Command.MES)) dict["MES"] = $"%{Command.MES}%";
if (!string.IsNullOrEmpty(Command.MES)) whereClauses.Add($"[MES] like @MES");
if (Command.fator.HasValue) dict["fator"] = Command.fator.Value;
if (Command.fator.HasValue) whereClauses.Add($"[fator] = @fator");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [MES] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByMESQuery(string value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Meses] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MES"] = value; //04
                      whereClauses.Add($" [MES] = @MES ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["fator"] = value; //04
                      whereClauses.Add($" [fator] = @fator ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["fator"] = value; //06
                      whereClauses.Add($" [fator] = @fator ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
