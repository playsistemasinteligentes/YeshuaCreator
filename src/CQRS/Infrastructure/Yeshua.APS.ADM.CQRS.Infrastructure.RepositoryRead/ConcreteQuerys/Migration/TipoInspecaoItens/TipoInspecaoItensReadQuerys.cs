...
{
    public class TipoInspecaoItensQueryRead : QueryBase, ITipoInspecaoItensQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TipoInspecaoItensQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TipoInspecaoItensQuery(Command.Read.TipoInspecaoItensReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [TII_ID], [TIV_ID], [ITI_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TipoInspecaoItens] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (Command.TII_ID.HasValue) dict["TII_ID"] = Command.TII_ID.Value;
if (Command.TII_ID.HasValue) whereClauses.Add($"[TII_ID] = @TII_ID");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TipoInspecaoItens] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TII_ID"] = value; //04
                      whereClauses.Add($" [TII_ID] = @TII_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TII_ID"] = value; //06
                      whereClauses.Add($" [TII_ID] = @TII_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
