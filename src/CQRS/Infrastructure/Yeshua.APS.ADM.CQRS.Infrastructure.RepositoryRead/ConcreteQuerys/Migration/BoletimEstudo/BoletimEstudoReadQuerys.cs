...
{
    public class BoletimEstudoQueryRead : QueryBase, IBoletimEstudoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public BoletimEstudoQueryRead(IExecutionContext executionContext)
        {
