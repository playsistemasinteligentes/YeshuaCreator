...
{
    public class TemplatesGrupoMaquinaQueryRead : QueryBase, ITemplatesGrupoMaquinaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TemplatesGrupoMaquinaQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TemplatesGrupoMaquinaQuery(Command.Read.TemplatesGrupoMaquinaReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [TEM_ID], [GMA_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TemplatesGrupoMaquina] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TemplatesGrupoMaquina] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
