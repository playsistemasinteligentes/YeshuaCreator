...
{
    public class T_MAQUINAS_EQUIPESQueryRead : QueryBase, IT_MAQUINAS_EQUIPESQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public T_MAQUINAS_EQUIPESQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel T_MAQUINAS_EQUIPESQuery(Command.Read.T_MAQUINAS_EQUIPESReadCommand Command )
        {
            ...
            this.Query = $@" select Id, MAQ_ID, EQU_ID, CAL_ID, CLI_ID, TenantID, Deleted, Changed, UserId from T_MAQUINAS_EQUIPES ";
...
if (Command.UserId.HasValue) whereClauses.Add($"UserId = @UserId");
 ...
 whereClauses.Add($"Deleted = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM T_MAQUINAS_EQUIPES ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"TenantID = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
