...
{
    public class ResultMedidaQueryRead : QueryBase, IResultMedidaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public ResultMedidaQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel ResultMedidaQuery(Command.Read.ResultMedidaReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [RSM_ID], [RL_ID], [MDT_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [ResultMedida] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (Command.RSM_ID.HasValue) dict["RSM_ID"] = Command.RSM_ID.Value;
if (Command.RSM_ID.HasValue) whereClauses.Add($"[RSM_ID] = @RSM_ID");
if (Command.RL_ID.HasValue) dict["RL_ID"] = Command.RL_ID.Value;
if (Command.RL_ID.HasValue) whereClauses.Add($"[RL_ID] = @RL_ID");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [ResultMedida] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["RSM_ID"] = value; //04
                      whereClauses.Add($" [RSM_ID] = @RSM_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["RL_ID"] = value; //04
                      whereClauses.Add($" [RL_ID] = @RL_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["RSM_ID"] = value; //06
                      whereClauses.Add($" [RSM_ID] = @RSM_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["RL_ID"] = value; //06
                      whereClauses.Add($" [RL_ID] = @RL_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
