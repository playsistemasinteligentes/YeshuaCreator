...
{
    public class TemplateDeTestesQueryRead : QueryBase, ITemplateDeTestesQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TemplateDeTestesQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TemplateDeTestesQuery(Command.Read.TemplateDeTestesReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Descricao], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId], [Observacao] from [TemplateDeTestes] ";
...
if (!string.IsNullOrEmpty(Command.Observacao)) whereClauses.Add($"[Observacao] like @Observacao");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TemplateDeTestes] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
