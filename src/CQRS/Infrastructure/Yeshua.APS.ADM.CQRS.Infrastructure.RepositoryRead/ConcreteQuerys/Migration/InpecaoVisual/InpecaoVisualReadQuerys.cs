...
{
    public class InpecaoVisualQueryRead : QueryBase, IInpecaoVisualQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public InpecaoVisualQueryRead(IExecutionContext executionContext)
        {
            _executionContext = executionContext;
        }
        public QueryModel InpecaoVisualQuery(Command.Read.InpecaoVisualReadCommand Command )
        {
            var whereClauses = new List<string>();
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $@" select [Id], [IPV_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [InpecaoVisual] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
        ...
        public QueryModel InpecaoVisualTenantIDQuery(Command.Patterns.Command.SearchFKCommand Command )
        {
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel InpecaoVisualUserIdQuery(Command.Patterns.Command.SearchFKCommand Command )
        {
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [InpecaoVisual] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
