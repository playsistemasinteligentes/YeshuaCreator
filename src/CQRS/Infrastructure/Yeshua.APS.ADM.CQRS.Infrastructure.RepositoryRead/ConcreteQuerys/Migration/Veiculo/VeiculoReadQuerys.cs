...
namespace Query.Read 
{
    public class VeiculoQueryRead : QueryBase, IVeiculoQueryRead
    {
        ...
        public QueryModel VeiculoQuery(Command.Read.VeiculoReadCommand Command )
        {
            ...
            this.Query = $@" select Id, VEI_PLACA, TIP_ID, VEI_CAPACIDADE_M3, VEI_CAPACIDADE_LARGURA, VEI_CAPACIDADE_COMPRIMENTO, VEI_CAPACIDADE_ALTURA, VEI_MODELO, VEI_NOME_MOTORISTA, VEI_DADOS_CONTATO, VEI_CPF_MOTORISTA, TCA_ID, VEI_EMISSAO, VEI_VENCIMENTO, VEI_STATUS, TenantID, Deleted, Changed, UserId from Veiculo ";
