...
{
    public class T_FeedbackMovEstoqueQueryRead : QueryBase, IT_FeedbackMovEstoqueQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public T_FeedbackMovEstoqueQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel T_FeedbackMovEstoqueQuery(Command.Read.T_FeedbackMovEstoqueReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [FeedbackId], [MovimentoEstoqueId], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [T_FeedbackMovEstoque] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (Command.FeedbackId.HasValue) dict["FeedbackId"] = Command.FeedbackId.Value;
if (Command.FeedbackId.HasValue) whereClauses.Add($"[FeedbackId] = @FeedbackId");
if (Command.MovimentoEstoqueId.HasValue) dict["MovimentoEstoqueId"] = Command.MovimentoEstoqueId.Value;
if (Command.MovimentoEstoqueId.HasValue) whereClauses.Add($"[MovimentoEstoqueId] = @MovimentoEstoqueId");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
        ...
        {
            this.Query = $@" select [Id] from [Feedback] ";
            var whereClauses = new List<string>();
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [T_FeedbackMovEstoque] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["FeedbackId"] = value; //04
                      whereClauses.Add($" [FeedbackId] = @FeedbackId ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MovimentoEstoqueId"] = value; //04
                      whereClauses.Add($" [MovimentoEstoqueId] = @MovimentoEstoqueId ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["FeedbackId"] = value; //06
                      whereClauses.Add($" [FeedbackId] = @FeedbackId ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MovimentoEstoqueId"] = value; //06
                      whereClauses.Add($" [MovimentoEstoqueId] = @MovimentoEstoqueId ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
