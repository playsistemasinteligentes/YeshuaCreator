...
namespace Query.Read 
{
    public class RoteiroQueryRead : QueryBase, IRoteiroQueryRead
    {
        ...
        public QueryModel RoteiroQuery(Command.Read.RoteiroReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [MaquinaId], [ProdutoId], [SequenciaTransformacao], [GrupoMaquinaId], [PecasPorPulso], [PrioridadeInformada], [Acao], [Performance], [TempoSetup], [TempoSetupAjuste], [ProximaSequenciaTransformacao], [Status], [HierarquiaSequenciaTransformacao], [AvaliaCusto], [Operacoes], [ExcecaoOperacoes], [PercentualInicioPassoAnterior], [LinhaDireta], [TemplateDeTestesId], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Roteiro] ";
