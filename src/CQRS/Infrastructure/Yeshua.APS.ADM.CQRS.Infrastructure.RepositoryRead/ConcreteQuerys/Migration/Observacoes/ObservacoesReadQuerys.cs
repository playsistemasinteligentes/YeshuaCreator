...
{
    public class ObservacoesQueryRead : QueryBase, IObservacoesQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public ObservacoesQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel ObservacoesQuery(Command.Read.ObservacoesReadCommand Command )
        {
            ...
            this.Query = $@" select [OBS_ID], [OBS_TIPO], [OBS_DESCRICAO], [CLI_ID], [MAQ_ID], [PRO_ID], [ROT_SEQ_TRANFORMACAO], [OBS_INTEGRACAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Observacoes] ";
if (Command.OBS_ID.HasValue) dict["OBS_ID"] = Command.OBS_ID.Value;
if (Command.OBS_ID.HasValue) whereClauses.Add($"[OBS_ID] = @OBS_ID");
if (!string.IsNullOrEmpty(Command.OBS_TIPO)) dict["OBS_TIPO"] = $"%{Command.OBS_TIPO}%";
if (!string.IsNullOrEmpty(Command.OBS_TIPO)) whereClauses.Add($"[OBS_TIPO] like @OBS_TIPO");
if (!string.IsNullOrEmpty(Command.OBS_DESCRICAO)) dict["OBS_DESCRICAO"] = $"%{Command.OBS_DESCRICAO}%";
if (!string.IsNullOrEmpty(Command.OBS_DESCRICAO)) whereClauses.Add($"[OBS_DESCRICAO] like @OBS_DESCRICAO");
...
if (!string.IsNullOrEmpty(Command.OBS_INTEGRACAO)) dict["OBS_INTEGRACAO"] = $"%{Command.OBS_INTEGRACAO}%";
if (!string.IsNullOrEmpty(Command.OBS_INTEGRACAO)) whereClauses.Add($"[OBS_INTEGRACAO] like @OBS_INTEGRACAO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [OBS_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByOBS_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Observacoes] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OBS_ID"] = value; //04
                      whereClauses.Add($" [OBS_ID] = @OBS_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OBS_TIPO"] = value; //04
                      whereClauses.Add($" [OBS_TIPO] = @OBS_TIPO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OBS_DESCRICAO"] = value; //04
                      whereClauses.Add($" [OBS_DESCRICAO] = @OBS_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OBS_INTEGRACAO"] = value; //04
                      whereClauses.Add($" [OBS_INTEGRACAO] = @OBS_INTEGRACAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OBS_ID"] = value; //06
                      whereClauses.Add($" [OBS_ID] = @OBS_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OBS_TIPO"] = value; //06
                      whereClauses.Add($" [OBS_TIPO] = @OBS_TIPO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OBS_DESCRICAO"] = value; //06
                      whereClauses.Add($" [OBS_DESCRICAO] = @OBS_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OBS_INTEGRACAO"] = value; //06
                      whereClauses.Add($" [OBS_INTEGRACAO] = @OBS_INTEGRACAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
