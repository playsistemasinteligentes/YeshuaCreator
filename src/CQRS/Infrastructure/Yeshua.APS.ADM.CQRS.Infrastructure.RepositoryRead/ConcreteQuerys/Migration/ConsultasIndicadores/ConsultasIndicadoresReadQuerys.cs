...
{
    public class ConsultasIndicadoresQueryRead : QueryBase, IConsultasIndicadoresQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public ConsultasIndicadoresQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel ConsultasIndicadoresQuery(Command.Read.ConsultasIndicadoresReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [CON_ID], [IND_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [ConsultasIndicadores] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [ConsultasIndicadores] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
