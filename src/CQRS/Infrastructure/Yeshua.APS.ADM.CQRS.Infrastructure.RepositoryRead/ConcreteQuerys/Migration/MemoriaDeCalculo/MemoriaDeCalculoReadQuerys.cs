...
{
    public class MemoriaDeCalculoQueryRead : QueryBase, IMemoriaDeCalculoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public MemoriaDeCalculoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel MemoriaDeCalculoQuery(Command.Read.MemoriaDeCalculoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [MEM_ID], [ORC_ID], [MEM_VALOR], [MEM_DESCRICAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [MemoriaDeCalculo] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (Command.MEM_ID.HasValue) dict["MEM_ID"] = Command.MEM_ID.Value;
if (Command.MEM_ID.HasValue) whereClauses.Add($"[MEM_ID] = @MEM_ID");
if (Command.ORC_ID.HasValue) dict["ORC_ID"] = Command.ORC_ID.Value;
if (Command.ORC_ID.HasValue) whereClauses.Add($"[ORC_ID] = @ORC_ID");
if (!string.IsNullOrEmpty(Command.MEM_DESCRICAO)) dict["MEM_DESCRICAO"] = $"%{Command.MEM_DESCRICAO}%";
if (!string.IsNullOrEmpty(Command.MEM_DESCRICAO)) whereClauses.Add($"[MEM_DESCRICAO] like @MEM_DESCRICAO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [MemoriaDeCalculo] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MEM_ID"] = value; //04
                      whereClauses.Add($" [MEM_ID] = @MEM_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MEM_VALOR"] = value; //04
                      whereClauses.Add($" [MEM_VALOR] = @MEM_VALOR ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MEM_DESCRICAO"] = value; //04
                      whereClauses.Add($" [MEM_DESCRICAO] = @MEM_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MEM_ID"] = value; //06
                      whereClauses.Add($" [MEM_ID] = @MEM_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MEM_VALOR"] = value; //06
                      whereClauses.Add($" [MEM_VALOR] = @MEM_VALOR ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MEM_DESCRICAO"] = value; //06
                      whereClauses.Add($" [MEM_DESCRICAO] = @MEM_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
