...
{
    public class TipoCarroceriaQueryRead : QueryBase, ITipoCarroceriaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TipoCarroceriaQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TipoCarroceriaQuery(Command.Read.TipoCarroceriaReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [TCA_ID], [TCA_DESCRICAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TipoCarroceria] ";
...
if (!string.IsNullOrEmpty(Command.TCA_DESCRICAO)) dict["TCA_DESCRICAO"] = $"%{Command.TCA_DESCRICAO}%";
if (!string.IsNullOrEmpty(Command.TCA_DESCRICAO)) whereClauses.Add($"[TCA_DESCRICAO] like @TCA_DESCRICAO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TipoCarroceria] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TCA_DESCRICAO"] = value; //04
                      whereClauses.Add($" [TCA_DESCRICAO] = @TCA_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TCA_DESCRICAO"] = value; //06
                      whereClauses.Add($" [TCA_DESCRICAO] = @TCA_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
