...
{
    public class TabelaQueryRead : QueryBase, ITabelaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TabelaQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TabelaQuery(Command.Read.TabelaReadCommand Command )
        {
            ...
            this.Query = $@" select [ID_TABELA], [CODIGO], [NOME], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Tabela] ";
if (Command.ID_TABELA.HasValue) dict["ID_TABELA"] = Command.ID_TABELA.Value;
if (Command.ID_TABELA.HasValue) whereClauses.Add($"[ID_TABELA] = @ID_TABELA");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [ID_TABELA] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByID_TABELAQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Tabela] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ID_TABELA"] = value; //04
                      whereClauses.Add($" [ID_TABELA] = @ID_TABELA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ID_TABELA"] = value; //06
                      whereClauses.Add($" [ID_TABELA] = @ID_TABELA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
