...
{
    public class TiposVincoGruposProdutosQueryRead : QueryBase, ITiposVincoGruposProdutosQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TiposVincoGruposProdutosQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TiposVincoGruposProdutosQuery(Command.Read.TiposVincoGruposProdutosReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Id2], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TiposVincoGruposProdutos] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TiposVincoGruposProdutos] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
