...
{
    public class CargosQueryRead : QueryBase, ICargosQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public CargosQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel CargosQuery(Command.Read.CargosReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [RGO_ID], [RGO_DESCRICAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Cargos] ";
...
if (!string.IsNullOrEmpty(Command.RGO_DESCRICAO)) dict["RGO_DESCRICAO"] = $"%{Command.RGO_DESCRICAO}%";
if (!string.IsNullOrEmpty(Command.RGO_DESCRICAO)) whereClauses.Add($"[RGO_DESCRICAO] like @RGO_DESCRICAO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Cargos] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["RGO_DESCRICAO"] = value; //04
                      whereClauses.Add($" [RGO_DESCRICAO] = @RGO_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["RGO_DESCRICAO"] = value; //06
                      whereClauses.Add($" [RGO_DESCRICAO] = @RGO_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
