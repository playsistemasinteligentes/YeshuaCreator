...
{
    public class PlanocontasQueryRead : QueryBase, IPlanocontasQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public PlanocontasQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel PlanocontasQuery(Command.Read.PlanocontasReadCommand Command )
        {
            ...
            this.Query = $@" select [PLA_ID], [PLA_CODIGO], [PLA_DESCRICAO], [PLA_TIPO], [PLA_NATUREZA], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Planocontas] ";
if (Command.PLA_ID.HasValue) dict["PLA_ID"] = Command.PLA_ID.Value;
if (Command.PLA_ID.HasValue) whereClauses.Add($"[PLA_ID] = @PLA_ID");
if (!string.IsNullOrEmpty(Command.PLA_CODIGO)) dict["PLA_CODIGO"] = $"%{Command.PLA_CODIGO}%";
if (!string.IsNullOrEmpty(Command.PLA_CODIGO)) whereClauses.Add($"[PLA_CODIGO] like @PLA_CODIGO");
...
if (Command.PLA_TIPO.HasValue) dict["PLA_TIPO"] = Command.PLA_TIPO.Value;
if (Command.PLA_TIPO.HasValue) whereClauses.Add($"[PLA_TIPO] = @PLA_TIPO");
if (!string.IsNullOrEmpty(Command.PLA_NATUREZA)) dict["PLA_NATUREZA"] = $"%{Command.PLA_NATUREZA}%";
if (!string.IsNullOrEmpty(Command.PLA_NATUREZA)) whereClauses.Add($"[PLA_NATUREZA] like @PLA_NATUREZA");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByPLA_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Planocontas] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PLA_CODIGO"] = value; //04
                      whereClauses.Add($" [PLA_CODIGO] = @PLA_CODIGO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PLA_TIPO"] = value; //04
                      whereClauses.Add($" [PLA_TIPO] = @PLA_TIPO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PLA_NATUREZA"] = value; //04
                      whereClauses.Add($" [PLA_NATUREZA] = @PLA_NATUREZA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PLA_CODIGO"] = value; //06
                      whereClauses.Add($" [PLA_CODIGO] = @PLA_CODIGO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PLA_TIPO"] = value; //06
                      whereClauses.Add($" [PLA_TIPO] = @PLA_TIPO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PLA_NATUREZA"] = value; //06
                      whereClauses.Add($" [PLA_NATUREZA] = @PLA_NATUREZA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
