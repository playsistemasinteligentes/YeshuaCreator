...
{
    public class T_USER_GRUPOQueryRead : QueryBase, IT_USER_GRUPOQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public T_USER_GRUPOQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel T_USER_GRUPOQuery(Command.Read.T_USER_GRUPOReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [GRU_ID], [ID_USUARIO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [T_USER_GRUPO] ";
...
if (Command.ID_USUARIO.HasValue) dict["ID_USUARIO"] = Command.ID_USUARIO.Value;
if (Command.ID_USUARIO.HasValue) whereClauses.Add($"[ID_USUARIO] = @ID_USUARIO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [T_USER_GRUPO] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ID_USUARIO"] = value; //04
                      whereClauses.Add($" [ID_USUARIO] = @ID_USUARIO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ID_USUARIO"] = value; //06
                      whereClauses.Add($" [ID_USUARIO] = @ID_USUARIO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
