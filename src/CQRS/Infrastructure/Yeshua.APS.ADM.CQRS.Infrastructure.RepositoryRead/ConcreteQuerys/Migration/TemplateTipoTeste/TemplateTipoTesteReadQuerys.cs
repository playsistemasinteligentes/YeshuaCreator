...
{
    public class TemplateTipoTesteQueryRead : QueryBase, ITemplateTipoTesteQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TemplateTipoTesteQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TemplateTipoTesteQuery(Command.Read.TemplateTipoTesteReadCommand Command )
        {
            ...
            this.Query = $@" select [TTT_ID], [TT_ID], [TEM_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TemplateTipoTeste] ";
if (Command.TTT_ID.HasValue) dict["TTT_ID"] = Command.TTT_ID.Value;
if (Command.TTT_ID.HasValue) whereClauses.Add($"[TTT_ID] = @TTT_ID");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [TTT_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, this.Parameters);
        }
        public QueryModel TemplateTipoTesteTT_IDQuery(Command.Patterns.Command.SearchFKCommand Command )
        {
            this.Query = $@" select [TT_ID] from [TipoTeste] ";
            var whereClauses = new List<string>();
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            if (!string.IsNullOrEmpty(Command.searchFK)) 
            {
                 ...
                 {
                      dict["TT_ID"] = numero; //01
                      whereClauses.Add($" [TT_ID] = @TT_ID");//01 
                 }
                 else 
                 {
                      dict["TT_ID"] = $"%{Command.searchFK}%";//02 
                      whereClauses.Add($" [TT_ID] like @TT_ID ");//02
                 }
           }
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByTTT_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TemplateTipoTeste] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TTT_ID"] = value; //04
                      whereClauses.Add($" [TTT_ID] = @TTT_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TTT_ID"] = value; //06
                      whereClauses.Add($" [TTT_ID] = @TTT_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
