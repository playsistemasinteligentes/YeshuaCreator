...
{
    public class EstruturaImpressaoQueryRead : QueryBase, IEstruturaImpressaoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public EstruturaImpressaoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel EstruturaImpressaoQuery(Command.Read.EstruturaImpressaoReadCommand Command )
        {
            ...
            this.Query = $@" select [EST_ID], [HTML_ESTRUTURA], [CLI_ID], [EST_DESCRICAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [EstruturaImpressao] ";
if (Command.EST_ID.HasValue) dict["EST_ID"] = Command.EST_ID.Value;
if (Command.EST_ID.HasValue) whereClauses.Add($"[EST_ID] = @EST_ID");
if (!string.IsNullOrEmpty(Command.HTML_ESTRUTURA)) dict["HTML_ESTRUTURA"] = $"%{Command.HTML_ESTRUTURA}%";
if (!string.IsNullOrEmpty(Command.HTML_ESTRUTURA)) whereClauses.Add($"[HTML_ESTRUTURA] like @HTML_ESTRUTURA");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByEST_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [EstruturaImpressao] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["HTML_ESTRUTURA"] = value; //04
                      whereClauses.Add($" [HTML_ESTRUTURA] = @HTML_ESTRUTURA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["HTML_ESTRUTURA"] = value; //06
                      whereClauses.Add($" [HTML_ESTRUTURA] = @HTML_ESTRUTURA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
