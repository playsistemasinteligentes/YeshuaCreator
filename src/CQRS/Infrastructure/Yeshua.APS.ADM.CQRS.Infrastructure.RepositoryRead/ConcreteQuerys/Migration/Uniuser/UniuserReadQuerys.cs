...
{
    public class UniuserQueryRead : QueryBase, IUniuserQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public UniuserQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel UniuserQuery(Command.Read.UniuserReadCommand Command )
        {
            ...
            this.Query = $@" select USERGRU_ID, UNI_ID, USE_ID, TenantID, Deleted, Changed, UserId from Uniuser ";
if (Command.USERGRU_ID.HasValue) dict["USERGRU_ID"] = Command.USERGRU_ID.Value;
if (Command.USERGRU_ID.HasValue) whereClauses.Add($"USERGRU_ID = @USERGRU_ID");
...
if (Command.UserId.HasValue) whereClauses.Add($"UserId = @UserId");
            ...
            Query += " ORDER BY USERGRU_ID OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, this.Parameters);
        }
        public QueryModel UniuserUNI_IDQuery(Command.Patterns.Command.SearchFKCommand Command )
        {
            this.Query = $@" select UNI_ID from Unidade ";
            this.Parameters = null;
            var whereClauses = new List<string>();
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
 ...
 whereClauses.Add($"Deleted = @Deleted");
        ...
        public QueryModel ExistsByUSERGRU_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM Uniuser ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"TenantID = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["USERGRU_ID"] = value; //04
                      whereClauses.Add($" USERGRU_ID = @USERGRU_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["USERGRU_ID"] = value; //06
                      whereClauses.Add($" USERGRU_ID = @USERGRU_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
