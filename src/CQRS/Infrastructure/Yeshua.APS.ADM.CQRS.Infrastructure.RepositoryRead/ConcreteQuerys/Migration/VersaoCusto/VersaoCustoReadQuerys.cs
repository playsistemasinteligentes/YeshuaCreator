...
{
    public class VersaoCustoQueryRead : QueryBase, IVersaoCustoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public VersaoCustoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel VersaoCustoQuery(Command.Read.VersaoCustoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [VER_ID], [VER_STATUS], [VER_OBS], [TenantID], [Deleted], [Changed], [UserId] from [VersaoCusto] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [VersaoCusto] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
