...
{
    public class ImpressoraQueryRead : QueryBase, IImpressoraQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public ImpressoraQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel ImpressoraQuery(Command.Read.ImpressoraReadCommand Command )
        {
            ...
            this.Query = $@" select [IMP_ID], [IMP_IP], [IMP_NOME], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Impressora] ";
if (Command.IMP_ID.HasValue) dict["IMP_ID"] = Command.IMP_ID.Value;
if (Command.IMP_ID.HasValue) whereClauses.Add($"[IMP_ID] = @IMP_ID");
if (!string.IsNullOrEmpty(Command.IMP_IP)) dict["IMP_IP"] = $"%{Command.IMP_IP}%";
if (!string.IsNullOrEmpty(Command.IMP_IP)) whereClauses.Add($"[IMP_IP] like @IMP_IP");
if (!string.IsNullOrEmpty(Command.IMP_NOME)) dict["IMP_NOME"] = $"%{Command.IMP_NOME}%";
if (!string.IsNullOrEmpty(Command.IMP_NOME)) whereClauses.Add($"[IMP_NOME] like @IMP_NOME");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [IMP_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIMP_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Impressora] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IMP_IP"] = value; //04
                      whereClauses.Add($" [IMP_IP] = @IMP_IP ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IMP_NOME"] = value; //04
                      whereClauses.Add($" [IMP_NOME] = @IMP_NOME ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IMP_IP"] = value; //06
                      whereClauses.Add($" [IMP_IP] = @IMP_IP ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IMP_NOME"] = value; //06
                      whereClauses.Add($" [IMP_NOME] = @IMP_NOME ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
