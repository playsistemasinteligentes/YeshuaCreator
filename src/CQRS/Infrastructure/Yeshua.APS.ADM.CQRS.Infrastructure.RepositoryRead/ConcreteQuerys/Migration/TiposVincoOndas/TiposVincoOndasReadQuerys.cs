...
{
    public class TiposVincoOndasQueryRead : QueryBase, ITiposVincoOndasQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TiposVincoOndasQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TiposVincoOndasQuery(Command.Read.TiposVincoOndasReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Id2], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TiposVincoOndas] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TiposVincoOndas] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
