...
namespace Query.Read 
{
    public class T_IndicadoresQueryRead : QueryBase, IT_IndicadoresQueryRead
    {
        ...
        public QueryModel T_IndicadoresQuery(Command.Read.T_IndicadoresReadCommand Command )
        {
            ...
            this.Query = $@" select [IND_ID], [IND_DESCRICAO], [NEG_ID], [DESC_CALCULO], [IND_TIPOCOMPARADOR], [IND_GRAFICO], [IND_CONEXAO], [IND_DTCRIACAO], [RESPOSAVELIND], [RESPOSAVELCARGA], [PROCEXTRACAO], [PER_ID], [DIM_ID], [DOM_EMPRESA], [DOM_FILIAL], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [T_Indicadores] ";
