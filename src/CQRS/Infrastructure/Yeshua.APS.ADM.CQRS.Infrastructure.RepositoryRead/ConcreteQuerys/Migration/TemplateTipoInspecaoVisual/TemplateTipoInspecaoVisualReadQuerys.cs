...
{
    public class TemplateTipoInspecaoVisualQueryRead : QueryBase, ITemplateTipoInspecaoVisualQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TemplateTipoInspecaoVisualQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TemplateTipoInspecaoVisualQuery(Command.Read.TemplateTipoInspecaoVisualReadCommand Command )
        {
            ...
            this.Query = $@" select [TTI_ID], [TIV_ID], [TEM_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TemplateTipoInspecaoVisual] ";
if (Command.TTI_ID.HasValue) dict["TTI_ID"] = Command.TTI_ID.Value;
if (Command.TTI_ID.HasValue) whereClauses.Add($"[TTI_ID] = @TTI_ID");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [TTI_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByTTI_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TemplateTipoInspecaoVisual] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TTI_ID"] = value; //04
                      whereClauses.Add($" [TTI_ID] = @TTI_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TTI_ID"] = value; //06
                      whereClauses.Add($" [TTI_ID] = @TTI_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
