...
{
    public class MedidasTesteQueryRead : QueryBase, IMedidasTesteQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public MedidasTesteQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel MedidasTesteQuery(Command.Read.MedidasTesteReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [MDT_ID], [MDT_DESC], [MDT_VALOR_ESPERADO], [MDT_ENCONTRADO], [UNI_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [MedidasTeste] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (Command.MDT_ID.HasValue) dict["MDT_ID"] = Command.MDT_ID.Value;
if (Command.MDT_ID.HasValue) whereClauses.Add($"[MDT_ID] = @MDT_ID");
if (!string.IsNullOrEmpty(Command.MDT_DESC)) dict["MDT_DESC"] = $"%{Command.MDT_DESC}%";
if (!string.IsNullOrEmpty(Command.MDT_DESC)) whereClauses.Add($"[MDT_DESC] like @MDT_DESC");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [MedidasTeste] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MDT_ID"] = value; //04
                      whereClauses.Add($" [MDT_ID] = @MDT_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MDT_DESC"] = value; //04
                      whereClauses.Add($" [MDT_DESC] = @MDT_DESC ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MDT_VALOR_ESPERADO"] = value; //04
                      whereClauses.Add($" [MDT_VALOR_ESPERADO] = @MDT_VALOR_ESPERADO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MDT_ENCONTRADO"] = value; //04
                      whereClauses.Add($" [MDT_ENCONTRADO] = @MDT_ENCONTRADO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MDT_ID"] = value; //06
                      whereClauses.Add($" [MDT_ID] = @MDT_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MDT_DESC"] = value; //06
                      whereClauses.Add($" [MDT_DESC] = @MDT_DESC ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MDT_VALOR_ESPERADO"] = value; //06
                      whereClauses.Add($" [MDT_VALOR_ESPERADO] = @MDT_VALOR_ESPERADO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MDT_ENCONTRADO"] = value; //06
                      whereClauses.Add($" [MDT_ENCONTRADO] = @MDT_ENCONTRADO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
