...
{
    public class EquipeQueryRead : QueryBase, IEquipeQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public EquipeQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel EquipeQuery(Command.Read.EquipeReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [EQU_ID], [EQU_HIERARQUIA_SEQ_TRANSFORMACAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Equipe] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Equipe] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EQU_HIERARQUIA_SEQ_TRANSFORMACAO"] = value; //04
                      whereClauses.Add($" [EQU_HIERARQUIA_SEQ_TRANSFORMACAO] = @EQU_HIERARQUIA_SEQ_TRANSFORMACAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EQU_HIERARQUIA_SEQ_TRANSFORMACAO"] = value; //06
                      whereClauses.Add($" [EQU_HIERARQUIA_SEQ_TRANSFORMACAO] = @EQU_HIERARQUIA_SEQ_TRANSFORMACAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
