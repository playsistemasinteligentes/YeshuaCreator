...
{
    public class GrupoMaquinaQueryRead : QueryBase, IGrupoMaquinaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public GrupoMaquinaQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel GrupoMaquinaQuery(Command.Read.GrupoMaquinaReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Descricao], [Status], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId], [GMA_TIPO_PLANEJAMENTO] from [GrupoMaquina] ";
...
if (!string.IsNullOrEmpty(Command.GMA_TIPO_PLANEJAMENTO)) dict["GMA_TIPO_PLANEJAMENTO"] = $"%{Command.GMA_TIPO_PLANEJAMENTO}%";
if (!string.IsNullOrEmpty(Command.GMA_TIPO_PLANEJAMENTO)) whereClauses.Add($"[GMA_TIPO_PLANEJAMENTO] like @GMA_TIPO_PLANEJAMENTO");
            if (whereClauses.Any()) 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(string value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [GrupoMaquina] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["GMA_TIPO_PLANEJAMENTO"] = value; //04
                      whereClauses.Add($" [GMA_TIPO_PLANEJAMENTO] = @GMA_TIPO_PLANEJAMENTO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["GMA_TIPO_PLANEJAMENTO"] = value; //06
                      whereClauses.Add($" [GMA_TIPO_PLANEJAMENTO] = @GMA_TIPO_PLANEJAMENTO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
