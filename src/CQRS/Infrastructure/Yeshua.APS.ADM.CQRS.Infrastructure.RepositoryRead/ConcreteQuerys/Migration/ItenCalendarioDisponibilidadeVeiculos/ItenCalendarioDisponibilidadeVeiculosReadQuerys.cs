...
{
    public class ItenCalendarioDisponibilidadeVeiculosQueryRead : QueryBase, IItenCalendarioDisponibilidadeVeiculosQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public ItenCalendarioDisponibilidadeVeiculosQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel ItenCalendarioDisponibilidadeVeiculosQuery(Command.Read.ItenCalendarioDisponibilidadeVeiculosReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [CDV_ID], [TIP_ID], [IDV_QTD], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [ItenCalendarioDisponibilidadeVeiculos] ";
...
if (Command.IDV_QTD.HasValue) dict["IDV_QTD"] = Command.IDV_QTD.Value;
if (Command.IDV_QTD.HasValue) whereClauses.Add($"[IDV_QTD] = @IDV_QTD");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [ItenCalendarioDisponibilidadeVeiculos] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IDV_QTD"] = value; //04
                      whereClauses.Add($" [IDV_QTD] = @IDV_QTD ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IDV_QTD"] = value; //06
                      whereClauses.Add($" [IDV_QTD] = @IDV_QTD ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
