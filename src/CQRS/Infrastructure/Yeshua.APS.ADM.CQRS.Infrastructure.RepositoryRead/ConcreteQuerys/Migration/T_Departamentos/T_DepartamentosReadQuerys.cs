...
{
    public class T_DepartamentosQueryRead : QueryBase, IT_DepartamentosQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public T_DepartamentosQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel T_DepartamentosQuery(Command.Read.T_DepartamentosReadCommand Command )
        {
            ...
            this.Query = $@" select [DEP_ID], [DEP_NOME], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [T_Departamentos] ";
if (Command.DEP_ID.HasValue) dict["DEP_ID"] = Command.DEP_ID.Value;
if (Command.DEP_ID.HasValue) whereClauses.Add($"[DEP_ID] = @DEP_ID");
if (!string.IsNullOrEmpty(Command.DEP_NOME)) dict["DEP_NOME"] = $"%{Command.DEP_NOME}%";
if (!string.IsNullOrEmpty(Command.DEP_NOME)) whereClauses.Add($"[DEP_NOME] like @DEP_NOME");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [DEP_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByDEP_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [T_Departamentos] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DEP_NOME"] = value; //04
                      whereClauses.Add($" [DEP_NOME] = @DEP_NOME ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DEP_NOME"] = value; //06
                      whereClauses.Add($" [DEP_NOME] = @DEP_NOME ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
