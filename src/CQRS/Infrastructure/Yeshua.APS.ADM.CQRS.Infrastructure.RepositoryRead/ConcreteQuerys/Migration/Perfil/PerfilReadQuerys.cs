...
{
    public class PerfilQueryRead : QueryBase, IPerfilQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public PerfilQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel PerfilQuery(Command.Read.PerfilReadCommand Command )
        {
            ...
            this.Query = $@" select [PER_ID], [PER_NOME], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Perfil] ";
if (Command.PER_ID.HasValue) dict["PER_ID"] = Command.PER_ID.Value;
if (Command.PER_ID.HasValue) whereClauses.Add($"[PER_ID] = @PER_ID");
if (!string.IsNullOrEmpty(Command.PER_NOME)) dict["PER_NOME"] = $"%{Command.PER_NOME}%";
if (!string.IsNullOrEmpty(Command.PER_NOME)) whereClauses.Add($"[PER_NOME] like @PER_NOME");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [PER_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByPER_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Perfil] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PER_NOME"] = value; //04
                      whereClauses.Add($" [PER_NOME] = @PER_NOME ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PER_NOME"] = value; //06
                      whereClauses.Add($" [PER_NOME] = @PER_NOME ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
