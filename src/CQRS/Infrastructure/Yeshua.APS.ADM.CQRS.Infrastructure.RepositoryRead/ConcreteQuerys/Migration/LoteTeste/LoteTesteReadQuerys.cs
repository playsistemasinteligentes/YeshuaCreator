...
{
    public class LoteTesteQueryRead : QueryBase, ILoteTesteQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public LoteTesteQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel LoteTesteQuery(Command.Read.LoteTesteReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [LT_ID], [TES_ID], [RL_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [LoteTeste] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (Command.LT_ID.HasValue) dict["LT_ID"] = Command.LT_ID.Value;
if (Command.LT_ID.HasValue) whereClauses.Add($"[LT_ID] = @LT_ID");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [LoteTeste] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["LT_ID"] = value; //04
                      whereClauses.Add($" [LT_ID] = @LT_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["LT_ID"] = value; //06
                      whereClauses.Add($" [LT_ID] = @LT_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
