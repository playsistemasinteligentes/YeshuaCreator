...
{
    public class Unidade_UnidadeQueryRead : QueryBase, IUnidade_UnidadeQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public Unidade_UnidadeQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel Unidade_UnidadeQuery(Command.Read.Unidade_UnidadeReadCommand Command )
        {
            ...
            this.Query = $@" select [UNI_ID], [UNI_DESCRICAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Unidade_Unidade] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByUNI_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Unidade_Unidade] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
