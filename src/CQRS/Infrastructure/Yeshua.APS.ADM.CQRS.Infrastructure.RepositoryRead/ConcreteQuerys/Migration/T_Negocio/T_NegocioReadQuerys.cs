...
{
    public class T_NegocioQueryRead : QueryBase, IT_NegocioQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public T_NegocioQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel T_NegocioQuery(Command.Read.T_NegocioReadCommand Command )
        {
            ...
            this.Query = $@" select [NEG_ID], [NEG_DESCRICAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [T_Negocio] ";
if (Command.NEG_ID.HasValue) dict["NEG_ID"] = Command.NEG_ID.Value;
if (Command.NEG_ID.HasValue) whereClauses.Add($"[NEG_ID] = @NEG_ID");
if (!string.IsNullOrEmpty(Command.NEG_DESCRICAO)) dict["NEG_DESCRICAO"] = $"%{Command.NEG_DESCRICAO}%";
if (!string.IsNullOrEmpty(Command.NEG_DESCRICAO)) whereClauses.Add($"[NEG_DESCRICAO] like @NEG_DESCRICAO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [NEG_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByNEG_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [T_Negocio] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["NEG_DESCRICAO"] = value; //04
                      whereClauses.Add($" [NEG_DESCRICAO] = @NEG_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["NEG_DESCRICAO"] = value; //06
                      whereClauses.Add($" [NEG_DESCRICAO] = @NEG_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
