...
{
    public class TipoOcorrenciaQueryRead : QueryBase, ITipoOcorrenciaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TipoOcorrenciaQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TipoOcorrenciaQuery(Command.Read.TipoOcorrenciaReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Descricao], [Spr], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TipoOcorrencia] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TipoOcorrencia] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
