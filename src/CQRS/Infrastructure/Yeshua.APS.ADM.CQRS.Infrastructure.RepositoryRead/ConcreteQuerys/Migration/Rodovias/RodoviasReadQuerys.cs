...
{
    public class RodoviasQueryRead : QueryBase, IRodoviasQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public RodoviasQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel RodoviasQuery(Command.Read.RodoviasReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [ROD_ID], [ROD_DESCRICAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Rodovias] ";
...
if (!string.IsNullOrEmpty(Command.ROD_DESCRICAO)) dict["ROD_DESCRICAO"] = $"%{Command.ROD_DESCRICAO}%";
if (!string.IsNullOrEmpty(Command.ROD_DESCRICAO)) whereClauses.Add($"[ROD_DESCRICAO] like @ROD_DESCRICAO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Rodovias] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ROD_DESCRICAO"] = value; //04
                      whereClauses.Add($" [ROD_DESCRICAO] = @ROD_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ROD_DESCRICAO"] = value; //06
                      whereClauses.Add($" [ROD_DESCRICAO] = @ROD_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
