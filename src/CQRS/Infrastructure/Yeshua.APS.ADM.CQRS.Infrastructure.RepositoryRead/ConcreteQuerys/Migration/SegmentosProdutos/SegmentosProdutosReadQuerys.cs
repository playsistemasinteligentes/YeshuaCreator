...
{
    public class SegmentosProdutosQueryRead : QueryBase, ISegmentosProdutosQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public SegmentosProdutosQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel SegmentosProdutosQuery(Command.Read.SegmentosProdutosReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [GRS_ID], [PRO_ID], [SEG_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [SegmentosProdutos] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [SegmentosProdutos] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
