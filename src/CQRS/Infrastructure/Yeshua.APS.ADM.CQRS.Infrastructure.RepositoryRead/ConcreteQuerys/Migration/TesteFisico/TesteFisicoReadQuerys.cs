...
namespace Query.Read 
{
    public class TesteFisicoQueryRead : QueryBase, ITesteFisicoQueryRead
    {
        ...
        public QueryModel TesteFisicoQuery(Command.Read.TesteFisicoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [TES_ID], [ITE_ID], [USR_ID], [TES_NOME_TECNICO], [TES_AMOSTRA], [TES_OP], [TES_VALOR_NUMERICO], [TES_VALOR_DATA], [TES_VALOR_TEXTO], [TES_EMISSAO], [ORD_ID], [PRO_ID], [MAQ_ID], [FPR_SEQ_REPETICAO], [FPR_SEQ_TRANFORMACAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TesteFisico] ";
