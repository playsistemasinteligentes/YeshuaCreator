...
{
    public class ItenCargaQueryRead : QueryBase, IItenCargaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public ItenCargaQueryRead(IExecutionContext executionContext)
        {
...
if (Command.ITC_ORDEM_ENTREGA.HasValue) dict["ITC_ORDEM_ENTREGA"] = Command.ITC_ORDEM_ENTREGA.Value;
if (Command.ITC_ORDEM_ENTREGA.HasValue) whereClauses.Add($"ITC_ORDEM_ENTREGA = @ITC_ORDEM_ENTREGA");
if (!string.IsNullOrEmpty(Command.ORD_HASH_KEY)) dict["ORD_HASH_KEY"] = $"%{Command.ORD_HASH_KEY}%";
...
if (Command.UserId.HasValue) whereClauses.Add($"UserId = @UserId");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ITC_ENTREGA_PLANEJADA"] = value; //04
                      whereClauses.Add($" ITC_ENTREGA_PLANEJADA = @ITC_ENTREGA_PLANEJADA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ITC_ENTREGA_REALIZADA"] = value; //04
                      whereClauses.Add($" ITC_ENTREGA_REALIZADA = @ITC_ENTREGA_REALIZADA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ITC_ORDEM_ENTREGA"] = value; //04
                      whereClauses.Add($" ITC_ORDEM_ENTREGA = @ITC_ORDEM_ENTREGA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ITC_QTD_PLANEJADA"] = value; //04
                      whereClauses.Add($" ITC_QTD_PLANEJADA = @ITC_QTD_PLANEJADA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ITC_QTD_REALIZADA"] = value; //04
                      whereClauses.Add($" ITC_QTD_REALIZADA = @ITC_QTD_REALIZADA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ORD_HASH_KEY"] = value; //04
                      whereClauses.Add($" ORD_HASH_KEY = @ORD_HASH_KEY ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["NOT_ID"] = value; //04
                      whereClauses.Add($" NOT_ID = @NOT_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["NOT_EMISSAO"] = value; //04
                      whereClauses.Add($" NOT_EMISSAO = @NOT_EMISSAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ITC_ENTREGA_PLANEJADA"] = value; //06
                      whereClauses.Add($" ITC_ENTREGA_PLANEJADA = @ITC_ENTREGA_PLANEJADA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ITC_ENTREGA_REALIZADA"] = value; //06
                      whereClauses.Add($" ITC_ENTREGA_REALIZADA = @ITC_ENTREGA_REALIZADA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ITC_ORDEM_ENTREGA"] = value; //06
                      whereClauses.Add($" ITC_ORDEM_ENTREGA = @ITC_ORDEM_ENTREGA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ITC_QTD_PLANEJADA"] = value; //06
                      whereClauses.Add($" ITC_QTD_PLANEJADA = @ITC_QTD_PLANEJADA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ITC_QTD_REALIZADA"] = value; //06
                      whereClauses.Add($" ITC_QTD_REALIZADA = @ITC_QTD_REALIZADA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ORD_HASH_KEY"] = value; //06
                      whereClauses.Add($" ORD_HASH_KEY = @ORD_HASH_KEY ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["NOT_ID"] = value; //06
                      whereClauses.Add($" NOT_ID = @NOT_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["NOT_EMISSAO"] = value; //06
                      whereClauses.Add($" NOT_EMISSAO = @NOT_EMISSAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
