...
{
    public class TipoABNTQueryRead : QueryBase, ITipoABNTQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TipoABNTQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TipoABNTQuery(Command.Read.TipoABNTReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [ABN_ID], [ABN_DESCRICAO], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TipoABNT] ";
...
if (!string.IsNullOrEmpty(Command.ABN_DESCRICAO)) dict["ABN_DESCRICAO"] = $"%{Command.ABN_DESCRICAO}%";
if (!string.IsNullOrEmpty(Command.ABN_DESCRICAO)) whereClauses.Add($"[ABN_DESCRICAO] like @ABN_DESCRICAO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TipoABNT] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ABN_DESCRICAO"] = value; //04
                      whereClauses.Add($" [ABN_DESCRICAO] = @ABN_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ABN_DESCRICAO"] = value; //06
                      whereClauses.Add($" [ABN_DESCRICAO] = @ABN_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
