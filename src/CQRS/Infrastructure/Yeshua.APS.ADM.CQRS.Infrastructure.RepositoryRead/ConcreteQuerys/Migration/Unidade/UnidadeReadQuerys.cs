...
{
    public class UnidadeQueryRead : QueryBase, IUnidadeQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public UnidadeQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel UnidadeQuery(Command.Read.UnidadeReadCommand Command )
        {
            ...
            this.Query = $@" select [UNI_ID], [DEESCRICAO], [UN], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Unidade] ";
if (Command.UNI_ID.HasValue) dict["UNI_ID"] = Command.UNI_ID.Value;
if (Command.UNI_ID.HasValue) whereClauses.Add($"[UNI_ID] = @UNI_ID");
if (!string.IsNullOrEmpty(Command.DEESCRICAO)) dict["DEESCRICAO"] = $"%{Command.DEESCRICAO}%";
if (!string.IsNullOrEmpty(Command.DEESCRICAO)) whereClauses.Add($"[DEESCRICAO] like @DEESCRICAO");
if (!string.IsNullOrEmpty(Command.UN)) dict["UN"] = $"%{Command.UN}%";
if (!string.IsNullOrEmpty(Command.UN)) whereClauses.Add($"[UN] like @UN");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByUNI_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Unidade] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DEESCRICAO"] = value; //04
                      whereClauses.Add($" [DEESCRICAO] = @DEESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DEESCRICAO"] = value; //06
                      whereClauses.Add($" [DEESCRICAO] = @DEESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
