...
{
    public class CorConfiguracaoGraficoQueryRead : QueryBase, ICorConfiguracaoGraficoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public CorConfiguracaoGraficoQueryRead(IExecutionContext executionContext)
        {
...
if (Command.UserId.HasValue) whereClauses.Add($"UserId = @UserId");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["COR_PERCENTUAL_INI"] = value; //04
                      whereClauses.Add($" COR_PERCENTUAL_INI = @COR_PERCENTUAL_INI ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["COR_PERCENTUAL_FIM"] = value; //04
                      whereClauses.Add($" COR_PERCENTUAL_FIM = @COR_PERCENTUAL_FIM ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["COR_DESCRICAO"] = value; //04
                      whereClauses.Add($" COR_DESCRICAO = @COR_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["COR_PERCENTUAL_INI"] = value; //06
                      whereClauses.Add($" COR_PERCENTUAL_INI = @COR_PERCENTUAL_INI ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["COR_PERCENTUAL_FIM"] = value; //06
                      whereClauses.Add($" COR_PERCENTUAL_FIM = @COR_PERCENTUAL_FIM ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["COR_DESCRICAO"] = value; //06
                      whereClauses.Add($" COR_DESCRICAO = @COR_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
