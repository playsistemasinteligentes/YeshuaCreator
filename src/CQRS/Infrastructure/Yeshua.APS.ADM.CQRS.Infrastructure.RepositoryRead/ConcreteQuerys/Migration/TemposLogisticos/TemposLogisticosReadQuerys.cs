...
{
    public class TemposLogisticosQueryRead : QueryBase, ITemposLogisticosQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TemposLogisticosQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel TemposLogisticosQuery(Command.Read.TemposLogisticosReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [TMP_TIPO_TEMPO], [TMP_TIPO_CARGA], [TMP_TEMPO_MEDIO_UNITARIO], [CLI_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TemposLogisticos] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (!string.IsNullOrEmpty(Command.TMP_TIPO_TEMPO)) dict["TMP_TIPO_TEMPO"] = $"%{Command.TMP_TIPO_TEMPO}%";
if (!string.IsNullOrEmpty(Command.TMP_TIPO_TEMPO)) whereClauses.Add($"[TMP_TIPO_TEMPO] like @TMP_TIPO_TEMPO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TemposLogisticos] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TMP_TIPO_TEMPO"] = value; //04
                      whereClauses.Add($" [TMP_TIPO_TEMPO] = @TMP_TIPO_TEMPO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TMP_TEMPO_MEDIO_UNITARIO"] = value; //04
                      whereClauses.Add($" [TMP_TEMPO_MEDIO_UNITARIO] = @TMP_TEMPO_MEDIO_UNITARIO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TMP_TIPO_TEMPO"] = value; //06
                      whereClauses.Add($" [TMP_TIPO_TEMPO] = @TMP_TIPO_TEMPO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TMP_TEMPO_MEDIO_UNITARIO"] = value; //06
                      whereClauses.Add($" [TMP_TEMPO_MEDIO_UNITARIO] = @TMP_TEMPO_MEDIO_UNITARIO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
