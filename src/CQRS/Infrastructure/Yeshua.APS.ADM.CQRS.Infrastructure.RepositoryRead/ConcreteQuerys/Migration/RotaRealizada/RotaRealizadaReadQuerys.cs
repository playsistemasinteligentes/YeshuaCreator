...
{
    public class RotaRealizadaQueryRead : QueryBase, IRotaRealizadaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public RotaRealizadaQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel RotaRealizadaQuery(Command.Read.RotaRealizadaReadCommand Command )
        {
            ...
            this.Query = $@" select [ROT_ID], [CAR_ID], [ROT_DATA_HORA], [ROT_LAT], [ROT_LONG], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [RotaRealizada] ";
if (Command.ROT_ID.HasValue) dict["ROT_ID"] = Command.ROT_ID.Value;
if (Command.ROT_ID.HasValue) whereClauses.Add($"[ROT_ID] = @ROT_ID");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [ROT_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByROT_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [RotaRealizada] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ROT_DATA_HORA"] = value; //04
                      whereClauses.Add($" [ROT_DATA_HORA] = @ROT_DATA_HORA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ROT_LAT"] = value; //04
                      whereClauses.Add($" [ROT_LAT] = @ROT_LAT ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ROT_LONG"] = value; //04
                      whereClauses.Add($" [ROT_LONG] = @ROT_LONG ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ROT_DATA_HORA"] = value; //06
                      whereClauses.Add($" [ROT_DATA_HORA] = @ROT_DATA_HORA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ROT_LAT"] = value; //06
                      whereClauses.Add($" [ROT_LAT] = @ROT_LAT ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ROT_LONG"] = value; //06
                      whereClauses.Add($" [ROT_LONG] = @ROT_LONG ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
