...
{
    public class TemplatesMaquinasQueryRead : QueryBase, ITemplatesMaquinasQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public TemplatesMaquinasQueryRead(IExecutionContext executionContext)
        {
            _executionContext = executionContext;
        }
        public QueryModel TemplatesMaquinasQuery(Command.Read.TemplatesMaquinasReadCommand Command )
        {
            var whereClauses = new List<string>();
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $@" select [Id], [TEM_ID], [MAQ_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [TemplatesMaquinas] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
        ...
        public QueryModel TemplatesMaquinasTenantIDQuery(Command.Patterns.Command.SearchFKCommand Command )
        {
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel TemplatesMaquinasUserIdQuery(Command.Patterns.Command.SearchFKCommand Command )
        {
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [TemplatesMaquinas] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
