...
namespace Query.Read 
{
    public class TurmaQueryRead : QueryBase, ITurmaQueryRead
    {
        ...
        public QueryModel TurmaQuery(Command.Read.TurmaReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Descricao], [TURM_HORA_INI_DIA1], [TURM_HORA_FIM_DIA1], [TURM_HORA_INI_DIA2], [TURM_HORA_FIM_DIA2], [TURM_HORA_INI_DIA3], [TURM_HORA_FIM_DIA3], [TURM_HORA_INI_DIA4], [TURM_HORA_FIM_DIA4], [TURM_HORA_INI_DIA5], [TURM_HORA_FIM_DIA5], [TURM_HORA_INI_DIA6], [TURM_HORA_FIM_DIA6], [TURM_HORA_INI_DIA7], [TURM_HORA_FIM_DIA7], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Turma] ";
