...
{
    public class yFileUploadQueryRead : QueryBase, IyFileUploadQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public yFileUploadQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel yFileUploadQuery(Command.Read.yFileUploadReadCommand Command , bool TakeOffTenantID = false)
        {
            ...
            this.Query = $@" select [Id], [Type], [Status], [FilePath], [FileSize], [EntityType], [EntityId], [CreatedAt], [CompletedAt], [TenantID], [OperationalEntityId], [Deleted], [Changed], [UserId] from [yFileUpload] ";
