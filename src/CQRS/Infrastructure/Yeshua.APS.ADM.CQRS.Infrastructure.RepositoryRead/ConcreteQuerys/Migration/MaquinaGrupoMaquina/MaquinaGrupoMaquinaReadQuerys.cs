...
{
    public class MaquinaGrupoMaquinaQueryRead : QueryBase, IMaquinaGrupoMaquinaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public MaquinaGrupoMaquinaQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel MaquinaGrupoMaquinaQuery(Command.Read.MaquinaGrupoMaquinaReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [GMA_ID], [MAQ_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [MaquinaGrupoMaquina] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [MaquinaGrupoMaquina] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
