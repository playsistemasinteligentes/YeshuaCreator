...
{
    public class T_HORARIO_RECEBIMENTOQueryRead : QueryBase, IT_HORARIO_RECEBIMENTOQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public T_HORARIO_RECEBIMENTOQueryRead(IExecutionContext executionContext)
        {
...
if (Command.UserId.HasValue) whereClauses.Add($"UserId = @UserId");
            ...
            Query += " ORDER BY HRE_ID OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["HRE_DIA_DA_SEMANA"] = value; //04
                      whereClauses.Add($" HRE_DIA_DA_SEMANA = @HRE_DIA_DA_SEMANA ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["HRE_HORA_INICIAL"] = value; //04
                      whereClauses.Add($" HRE_HORA_INICIAL = @HRE_HORA_INICIAL ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["HRE_HORA_FINAL"] = value; //04
                      whereClauses.Add($" HRE_HORA_FINAL = @HRE_HORA_FINAL ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["HRE_ID"] = value; //04
                      whereClauses.Add($" HRE_ID = @HRE_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["HRE_DIA_DA_SEMANA"] = value; //06
                      whereClauses.Add($" HRE_DIA_DA_SEMANA = @HRE_DIA_DA_SEMANA ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["HRE_HORA_INICIAL"] = value; //06
                      whereClauses.Add($" HRE_HORA_INICIAL = @HRE_HORA_INICIAL ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["HRE_HORA_FINAL"] = value; //06
                      whereClauses.Add($" HRE_HORA_FINAL = @HRE_HORA_FINAL ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["HRE_ID"] = value; //06
                      whereClauses.Add($" HRE_ID = @HRE_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
