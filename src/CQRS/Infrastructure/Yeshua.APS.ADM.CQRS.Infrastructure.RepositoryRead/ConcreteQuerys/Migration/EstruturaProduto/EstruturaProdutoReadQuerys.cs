...
{
    public class EstruturaProdutoQueryRead : QueryBase, IEstruturaProdutoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public EstruturaProdutoQueryRead(IExecutionContext executionContext)
        {
...
if (!string.IsNullOrEmpty(Command.EST_TIPO_REQUISICAO)) dict["EST_TIPO_REQUISICAO"] = $"%{Command.EST_TIPO_REQUISICAO}%";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EST_DATA_VALIDADE"] = value; //04
                      whereClauses.Add($" [EST_DATA_VALIDADE] = @EST_DATA_VALIDADE ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EST_DATA_INCLUSAO"] = value; //04
                      whereClauses.Add($" [EST_DATA_INCLUSAO] = @EST_DATA_INCLUSAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EST_TIPO_REQUISICAO"] = value; //04
                      whereClauses.Add($" [EST_TIPO_REQUISICAO] = @EST_TIPO_REQUISICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EST_CODIGO_DE_EXCECAO"] = value; //04
                      whereClauses.Add($" [EST_CODIGO_DE_EXCECAO] = @EST_CODIGO_DE_EXCECAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EST_DATA_VALIDADE"] = value; //06
                      whereClauses.Add($" [EST_DATA_VALIDADE] = @EST_DATA_VALIDADE ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EST_DATA_INCLUSAO"] = value; //06
                      whereClauses.Add($" [EST_DATA_INCLUSAO] = @EST_DATA_INCLUSAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EST_TIPO_REQUISICAO"] = value; //06
                      whereClauses.Add($" [EST_TIPO_REQUISICAO] = @EST_TIPO_REQUISICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EST_CODIGO_DE_EXCECAO"] = value; //06
                      whereClauses.Add($" [EST_CODIGO_DE_EXCECAO] = @EST_CODIGO_DE_EXCECAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
