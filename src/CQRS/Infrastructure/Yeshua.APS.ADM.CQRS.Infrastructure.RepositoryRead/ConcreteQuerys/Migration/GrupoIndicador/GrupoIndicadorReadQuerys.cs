...
{
    public class GrupoIndicadorQueryRead : QueryBase, IGrupoIndicadorQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public GrupoIndicadorQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel GrupoIndicadorQuery(Command.Read.GrupoIndicadorReadCommand Command )
        {
            ...
            this.Query = $@" select [GRU_IND_ID], [GRU_ID], [IND_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [GrupoIndicador] ";
if (Command.GRU_IND_ID.HasValue) dict["GRU_IND_ID"] = Command.GRU_IND_ID.Value;
if (Command.GRU_IND_ID.HasValue) whereClauses.Add($"[GRU_IND_ID] = @GRU_IND_ID");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [GRU_IND_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, this.Parameters);
        }
        public QueryModel GrupoIndicadorGRU_IDQuery(Command.Patterns.Command.SearchFKCommand Command )
        {
            this.Query = $@" select [GRU_ID], [NOME] from [T_Grupo] ";
            var whereClauses = new List<string>();
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            if (!string.IsNullOrEmpty(Command.searchFK)) 
            {
                 ...
                 {
                      dict["GRU_ID"] = numero; //01
                      whereClauses.Add($" [GRU_ID] = @GRU_ID");//01 
                 }
                 else 
                 {
                      dict["GRU_ID"] = $"%{Command.searchFK}%";//02 
                      whereClauses.Add($" [GRU_ID] like @GRU_ID ");//02
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByGRU_IND_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [GrupoIndicador] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["GRU_IND_ID"] = value; //04
                      whereClauses.Add($" [GRU_IND_ID] = @GRU_IND_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["GRU_IND_ID"] = value; //06
                      whereClauses.Add($" [GRU_IND_ID] = @GRU_IND_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
