...
{
    public class OperacoesQueryRead : QueryBase, IOperacoesQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public OperacoesQueryRead(IExecutionContext executionContext)
        {
...
if (!string.IsNullOrEmpty(Command.OPE_TIPO_REGISTRO)) whereClauses.Add($"[OPE_TIPO_REGISTRO] like @OPE_TIPO_REGISTRO");
if (!string.IsNullOrEmpty(Command.OPE_ID)) dict["OPE_ID"] = $"%{Command.OPE_ID}%";
if (!string.IsNullOrEmpty(Command.OPE_ID)) whereClauses.Add($"[OPE_ID] like @OPE_ID");
...
if (!string.IsNullOrEmpty(Command.OPE_EXCECAO)) dict["OPE_EXCECAO"] = $"%{Command.OPE_EXCECAO}%";
if (!string.IsNullOrEmpty(Command.OPE_EXCECAO)) whereClauses.Add($"[OPE_EXCECAO] like @OPE_EXCECAO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OPE_TIPO_REGISTRO"] = value; //04
                      whereClauses.Add($" [OPE_TIPO_REGISTRO] = @OPE_TIPO_REGISTRO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OPE_ID"] = value; //04
                      whereClauses.Add($" [OPE_ID] = @OPE_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OPE_EXCECAO"] = value; //04
                      whereClauses.Add($" [OPE_EXCECAO] = @OPE_EXCECAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OPE_TIPO_REGISTRO"] = value; //06
                      whereClauses.Add($" [OPE_TIPO_REGISTRO] = @OPE_TIPO_REGISTRO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OPE_ID"] = value; //06
                      whereClauses.Add($" [OPE_ID] = @OPE_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["OPE_EXCECAO"] = value; //06
                      whereClauses.Add($" [OPE_EXCECAO] = @OPE_EXCECAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
