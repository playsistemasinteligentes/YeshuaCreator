...
{
    public class IndicadoresDepartamentosQueryRead : QueryBase, IIndicadoresDepartamentosQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public IndicadoresDepartamentosQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel IndicadoresDepartamentosQuery(Command.Read.IndicadoresDepartamentosReadCommand Command )
        {
            ...
            this.Query = $@" select [INDDEP_ID], [DEP_ID], [IND_ID], [TenantID], [Deleted], [Changed], [UserId] from [IndicadoresDepartamentos] ";
if (Command.INDDEP_ID.HasValue) dict["INDDEP_ID"] = Command.INDDEP_ID.Value;
if (Command.INDDEP_ID.HasValue) whereClauses.Add($"[INDDEP_ID] = @INDDEP_ID");
if (Command.DEP_ID.HasValue) dict["DEP_ID"] = Command.DEP_ID.Value;
if (Command.DEP_ID.HasValue) whereClauses.Add($"[DEP_ID] = @DEP_ID");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
            ...
            Query += " ORDER BY [INDDEP_ID] OFFSET @Offset ROWS FETCH NEXT @PageSize ROWS ONLY"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, this.Parameters);
        }
        public QueryModel IndicadoresDepartamentosDEP_IDQuery(Command.Patterns.Command.SearchFKCommand Command )
        {
            this.Query = $@" select [DEP_ID] from [T_Departamentos] ";
            this.Parameters = null;
            var whereClauses = new List<string>();
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            if (!string.IsNullOrEmpty(Command.searchFK)) 
            {
                 ...
                 {
                      dict["DEP_ID"] = numero; //01
                      whereClauses.Add($" [DEP_ID] = @DEP_ID");//01 
                 }
                 else 
                 {
                      dict["DEP_ID"] = $"%{Command.searchFK}%";//02 
                      whereClauses.Add($" [DEP_ID] like @DEP_ID ");//02
                 }
           }
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByINDDEP_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [IndicadoresDepartamentos] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["INDDEP_ID"] = value; //04
                      whereClauses.Add($" [INDDEP_ID] = @INDDEP_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DEP_ID"] = value; //04
                      whereClauses.Add($" [DEP_ID] = @DEP_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["INDDEP_ID"] = value; //06
                      whereClauses.Add($" [INDDEP_ID] = @INDDEP_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DEP_ID"] = value; //06
                      whereClauses.Add($" [DEP_ID] = @DEP_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
