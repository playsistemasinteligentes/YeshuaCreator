...
{
    public class FilaProducaoPrevistaQueryRead : QueryBase, IFilaProducaoPrevistaQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public FilaProducaoPrevistaQueryRead(IExecutionContext executionContext)
        {
...
if (!string.IsNullOrEmpty(Command.FPR_PESO_UNITARIO)) dict["FPR_PESO_UNITARIO"] = $"%{Command.FPR_PESO_UNITARIO}%";
if (!string.IsNullOrEmpty(Command.FPR_PESO_UNITARIO)) whereClauses.Add($"[FPR_PESO_UNITARIO] like @FPR_PESO_UNITARIO");
if (!string.IsNullOrEmpty(Command.FPR_M2_UNITARIO)) dict["FPR_M2_UNITARIO"] = $"%{Command.FPR_M2_UNITARIO}%";
if (!string.IsNullOrEmpty(Command.FPR_M2_UNITARIO)) whereClauses.Add($"[FPR_M2_UNITARIO] like @FPR_M2_UNITARIO");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [FilaProducaoPrevista] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["FPR_PESO_UNITARIO"] = value; //04
                      whereClauses.Add($" [FPR_PESO_UNITARIO] = @FPR_PESO_UNITARIO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["FPR_M2_UNITARIO"] = value; //04
                      whereClauses.Add($" [FPR_M2_UNITARIO] = @FPR_M2_UNITARIO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["FPR_PESO_UNITARIO"] = value; //06
                      whereClauses.Add($" [FPR_PESO_UNITARIO] = @FPR_PESO_UNITARIO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["FPR_M2_UNITARIO"] = value; //06
                      whereClauses.Add($" [FPR_M2_UNITARIO] = @FPR_M2_UNITARIO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
