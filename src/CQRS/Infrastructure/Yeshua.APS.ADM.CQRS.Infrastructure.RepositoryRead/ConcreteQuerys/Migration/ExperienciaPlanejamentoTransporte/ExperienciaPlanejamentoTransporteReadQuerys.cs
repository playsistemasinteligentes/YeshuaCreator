...
{
    public class ExperienciaPlanejamentoTransporteQueryRead : QueryBase, IExperienciaPlanejamentoTransporteQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public ExperienciaPlanejamentoTransporteQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel ExperienciaPlanejamentoTransporteQuery(Command.Read.ExperienciaPlanejamentoTransporteReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Tipo], [Referencia], [PedidoId], [ClienteId], [Municipio], [Regiao], [RotaId], [Peso], [Volume], [Observacao], [CriadoEm], [CriadoPor], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [ExperienciaPlanejamentoTransporte] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (Command.Tipo.HasValue)
{
    dict["Tipo"] = Command.Tipo.Value;
    whereClauses.Add($"[Tipo] = @Tipo");
}
if (!string.IsNullOrEmpty(Command.Referencia)) dict["Referencia"] = $"%{Command.Referencia}%";
if (!string.IsNullOrEmpty(Command.Referencia)) whereClauses.Add($"[Referencia] like @Referencia");
...
if (!string.IsNullOrEmpty(Command.CriadoPor)) dict["CriadoPor"] = $"%{Command.CriadoPor}%";
if (!string.IsNullOrEmpty(Command.CriadoPor)) whereClauses.Add($"[CriadoPor] like @CriadoPor");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [ExperienciaPlanejamentoTransporte] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Referencia"] = value; //04
                      whereClauses.Add($" [Referencia] = @Referencia ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CriadoEm"] = value; //04
                      whereClauses.Add($" [CriadoEm] = @CriadoEm ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CriadoPor"] = value; //04
                      whereClauses.Add($" [CriadoPor] = @CriadoPor ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Referencia"] = value; //06
                      whereClauses.Add($" [Referencia] = @Referencia ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CriadoEm"] = value; //06
                      whereClauses.Add($" [CriadoEm] = @CriadoEm ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CriadoPor"] = value; //06
                      whereClauses.Add($" [CriadoPor] = @CriadoPor ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
