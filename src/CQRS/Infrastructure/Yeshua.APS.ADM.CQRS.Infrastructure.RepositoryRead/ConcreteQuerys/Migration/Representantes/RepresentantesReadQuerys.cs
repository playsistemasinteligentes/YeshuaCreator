...
{
    public class RepresentantesQueryRead : QueryBase, IRepresentantesQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public RepresentantesQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel RepresentantesQuery(Command.Read.RepresentantesReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [REP_ID], [REP_NOME], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Representantes] ";
...
if (!string.IsNullOrEmpty(Command.REP_NOME)) dict["REP_NOME"] = $"%{Command.REP_NOME}%";
if (!string.IsNullOrEmpty(Command.REP_NOME)) whereClauses.Add($"[REP_NOME] like @REP_NOME");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [Representantes] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["REP_NOME"] = value; //04
                      whereClauses.Add($" [REP_NOME] = @REP_NOME ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["REP_NOME"] = value; //06
                      whereClauses.Add($" [REP_NOME] = @REP_NOME ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
