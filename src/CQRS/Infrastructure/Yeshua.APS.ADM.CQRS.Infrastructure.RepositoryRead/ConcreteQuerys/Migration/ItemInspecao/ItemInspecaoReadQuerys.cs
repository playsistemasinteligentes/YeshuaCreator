...
{
    public class ItemInspecaoQueryRead : QueryBase, IItemInspecaoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public ItemInspecaoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel ItemInspecaoQuery(Command.Read.ItemInspecaoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [ITI_ID], [ITI_DESC], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [ItemInspecao] ";
...
if (!string.IsNullOrEmpty(Command.ITI_DESC)) dict["ITI_DESC"] = $"%{Command.ITI_DESC}%";
if (!string.IsNullOrEmpty(Command.ITI_DESC)) whereClauses.Add($"[ITI_DESC] like @ITI_DESC");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [ItemInspecao] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ITI_DESC"] = value; //04
                      whereClauses.Add($" [ITI_DESC] = @ITI_DESC ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ITI_DESC"] = value; //06
                      whereClauses.Add($" [ITI_DESC] = @ITI_DESC ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
