...
{
    public class FechamentoTesteQueryRead : QueryBase, IFechamentoTesteQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public FechamentoTesteQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel FechamentoTesteQuery(Command.Read.FechamentoTesteReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [FEC_ID], [FEC_QTD], [GRP_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [FechamentoTeste] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (Command.FEC_ID.HasValue) dict["FEC_ID"] = Command.FEC_ID.Value;
if (Command.FEC_ID.HasValue) whereClauses.Add($"[FEC_ID] = @FEC_ID");
if (Command.FEC_QTD.HasValue) dict["FEC_QTD"] = Command.FEC_QTD.Value;
if (Command.FEC_QTD.HasValue) whereClauses.Add($"[FEC_QTD] = @FEC_QTD");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [FechamentoTeste] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["FEC_ID"] = value; //04
                      whereClauses.Add($" [FEC_ID] = @FEC_ID ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["FEC_QTD"] = value; //04
                      whereClauses.Add($" [FEC_QTD] = @FEC_QTD ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["FEC_ID"] = value; //06
                      whereClauses.Add($" [FEC_ID] = @FEC_ID ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["FEC_QTD"] = value; //06
                      whereClauses.Add($" [FEC_QTD] = @FEC_QTD ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
