...
{
    public class ConsultasGruposQueryRead : QueryBase, IConsultasGruposQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public ConsultasGruposQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel ConsultasGruposQuery(Command.Read.ConsultasGruposReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [CON_ID], [GRU_ID], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [ConsultasGrupos] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [ConsultasGrupos] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
