...
namespace Query.Read 
{
    public class SegmentoQueryRead : QueryBase, ISegmentoQueryRead
    {
        ...
        public QueryModel SegmentoQuery(Command.Read.SegmentoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [SEG_ID], [SEG_DESCRICAO], [SEG_ID_SEGUIMENTO_PAI], [GRS_ID], [SEG_INTEGRACAO_ERP], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Segmento] ";
