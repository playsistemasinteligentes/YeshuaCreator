...
namespace Query.Write
{
    public class EspecialidadeQueryWrite : QueryBase, IEspecialidadeQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO [Especialidade] ([Descricao], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId]) OUTPUT INSERTED.[Id] VALUES(@Descricao, @OperationalEntityId, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
                Descricao = Especialidade.Descricao,
                OperationalEntityId = Especialidade.OperationalEntityId,
        ...
        {
            this.Query = $@" UPDATE [Especialidade] SET [OperationalEntityId] = @OperationalEntityId WHERE [Id] = @Id ";
            this.Parameters = new
            {
