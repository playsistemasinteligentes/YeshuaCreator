...
{
    public class MDFeQueryRead : QueryBase, IMDFeQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public MDFeQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel MDFeQuery(Command.Read.MDFeReadCommand Command )
        {
            ...
            this.Query = $@" select Id, ChaveAcesso, Serie, Numero, UfCarregamento, UfDescarregamento, PlacaVeiculo, EmitidoEm, AutorizadoEm, IniciadoEm, EncerradoEm, CanceladoEm, Situacao, TenantID, Deleted, Changed, UserId from MDFe ";
...
if (!string.IsNullOrEmpty(Command.UfCarregamento)) dict["UfCarregamento"] = $"%{Command.UfCarregamento}%";
if (!string.IsNullOrEmpty(Command.UfCarregamento)) whereClauses.Add($"UfCarregamento like @UfCarregamento");
if (!string.IsNullOrEmpty(Command.UfDescarregamento)) dict["UfDescarregamento"] = $"%{Command.UfDescarregamento}%";
if (!string.IsNullOrEmpty(Command.UfDescarregamento)) whereClauses.Add($"UfDescarregamento like @UfDescarregamento");
...
if (Command.Situacao != null && Command.Situacao.Any())
{
    var paramList_Situacao = new List<string>();
    for (int i = 0; i < Command.Situacao.Count; i++)
    {
        string paramName = "Situacao_" + i;
        dict[paramName] = Command.Situacao[i];
        paramList_Situacao.Add("@" + paramName);
    }
    whereClauses.Add($"t0.Situacao IN ({string.Join(", ", paramList_Situacao)})");
}
...
if (Command.UserId.HasValue) whereClauses.Add($"UserId = @UserId");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["UfCarregamento"] = value; //04
                      whereClauses.Add($" UfCarregamento = @UfCarregamento ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["UfDescarregamento"] = value; //04
                      whereClauses.Add($" UfDescarregamento = @UfDescarregamento ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["EmitidoEm"] = value; //04
                      whereClauses.Add($" EmitidoEm = @EmitidoEm ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["AutorizadoEm"] = value; //04
                      whereClauses.Add($" AutorizadoEm = @AutorizadoEm ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["IniciadoEm"] = value; //04
                      whereClauses.Add($" IniciadoEm = @IniciadoEm ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["EncerradoEm"] = value; //04
                      whereClauses.Add($" EncerradoEm = @EncerradoEm ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["CanceladoEm"] = value; //04
                      whereClauses.Add($" CanceladoEm = @CanceladoEm ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["Situacao"] = value; //04
                      whereClauses.Add($" Situacao = @Situacao ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["UfCarregamento"] = value; //06
                      whereClauses.Add($" UfCarregamento = @UfCarregamento ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["UfDescarregamento"] = value; //06
                      whereClauses.Add($" UfDescarregamento = @UfDescarregamento ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["EmitidoEm"] = value; //06
                      whereClauses.Add($" EmitidoEm = @EmitidoEm ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["AutorizadoEm"] = value; //06
                      whereClauses.Add($" AutorizadoEm = @AutorizadoEm ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["IniciadoEm"] = value; //06
                      whereClauses.Add($" IniciadoEm = @IniciadoEm ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["EncerradoEm"] = value; //06
                      whereClauses.Add($" EncerradoEm = @EncerradoEm ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["CanceladoEm"] = value; //06
                      whereClauses.Add($" CanceladoEm = @CanceladoEm ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["Situacao"] = value; //06
                      whereClauses.Add($" Situacao = @Situacao ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
