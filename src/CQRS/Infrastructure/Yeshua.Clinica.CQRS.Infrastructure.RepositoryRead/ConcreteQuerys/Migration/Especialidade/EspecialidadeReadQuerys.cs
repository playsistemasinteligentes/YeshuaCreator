...
namespace Query.Read 
{
    public class EspecialidadeQueryRead : QueryBase, IEspecialidadeQueryRead
    {
        ...
        public EspecialidadeQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel EspecialidadeQuery(Command.Read.EspecialidadeReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Descricao], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Especialidade] ";
