...
{
    public class MovimentoFinanceiroQueryRead : QueryBase, IMovimentoFinanceiroQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public MovimentoFinanceiroQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel MovimentoFinanceiroQuery(Command.Read.MovimentoFinanceiroReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [IdOrigem], [ContaDebitoId], [Valor], [DataMovimento], [DataVencimento], [Status], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [MovimentoFinanceiro] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IdOrigem"] = value; //04
                      whereClauses.Add($" [IdOrigem] = @IdOrigem ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DataMovimento"] = value; //04
                      whereClauses.Add($" [DataMovimento] = @DataMovimento ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DataVencimento"] = value; //04
                      whereClauses.Add($" [DataVencimento] = @DataVencimento ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["IdOrigem"] = value; //06
                      whereClauses.Add($" [IdOrigem] = @IdOrigem ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DataMovimento"] = value; //06
                      whereClauses.Add($" [DataMovimento] = @DataMovimento ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DataVencimento"] = value; //06
                      whereClauses.Add($" [DataVencimento] = @DataVencimento ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
