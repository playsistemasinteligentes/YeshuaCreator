...
namespace Query.Read 
{
    public class PlanoContaQueryRead : QueryBase, IPlanoContaQueryRead
    {
        ...
        public PlanoContaQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel PlanoContaQuery(Command.Read.PlanoContaReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Codigo], [Nome], [Tipo], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [PlanoConta] ";
