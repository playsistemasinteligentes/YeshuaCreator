...
namespace Query.Read 
{
    public class yTenantModuleQueryRead : QueryBase, IyTenantModuleQueryRead
    {
        ...
        public QueryModel yTenantModuleQuery(Command.Read.yTenantModuleReadCommand Command )
        {
            ...
            this.Query = $@" select [OperationalEntityId], [Id], [ModuleId], [TenantID], [ValidUntil], [Deleted], [Changed], [UserId] from [yTenantModule] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
        ...
        {
            this.Query = $@" select [Id] from [yModule] ";
            var whereClauses = new List<string>();
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByOperationalEntityIdQuery(string value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [yTenantModule] ";
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ModuleId"] = value; //04
                      whereClauses.Add($" [ModuleId] = @ModuleId ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      ...
                      whereClauses.Add($" [ModuleId] = @ModuleId ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
