...
namespace Query.Read 
{
    public class DisponibilidadeAgendaQueryRead : QueryBase, IDisponibilidadeAgendaQueryRead
    {
        ...
        public DisponibilidadeAgendaQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel DisponibilidadeAgendaQuery(Command.Read.DisponibilidadeAgendaReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [ProfissionalId], [DataHora], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [DisponibilidadeAgenda] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [DisponibilidadeAgenda] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DataHora"] = value; //04
                      whereClauses.Add($" [DataHora] = @DataHora ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DataHora"] = value; //06
                      whereClauses.Add($" [DataHora] = @DataHora ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
