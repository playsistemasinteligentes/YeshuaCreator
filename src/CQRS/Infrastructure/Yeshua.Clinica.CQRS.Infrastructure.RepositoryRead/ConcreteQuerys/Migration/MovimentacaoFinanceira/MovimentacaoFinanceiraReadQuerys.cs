...
namespace Query.Read 
{
    public class MovimentacaoFinanceiraQueryRead : QueryBase, IMovimentacaoFinanceiraQueryRead
    {
        ...
        public QueryModel MovimentacaoFinanceiraQuery(Command.Read.MovimentacaoFinanceiraReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [PacienteId], [ServicoId], [Valor], [TipoMovimentacao], [DataMovimentacao], [SaldoAtual], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [MovimentacaoFinanceira] ";
...
if (Command.TipoMovimentacao.HasValue)
{
    dict["TipoMovimentacao"] = Command.TipoMovimentacao.Value;
