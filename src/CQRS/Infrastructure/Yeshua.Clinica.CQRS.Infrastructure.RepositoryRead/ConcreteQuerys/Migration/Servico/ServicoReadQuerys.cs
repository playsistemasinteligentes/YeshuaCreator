...
namespace Query.Read 
{
    public class ServicoQueryRead : QueryBase, IServicoQueryRead
    {
        ...
        public ServicoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel ServicoQuery(Command.Read.ServicoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [GrupoServicoId], [Nome], [Valor], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Servico] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (Command.GrupoServicoId.HasValue) dict["GrupoServicoId"] = Command.GrupoServicoId.Value;
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["GrupoServicoId"] = value; //04
                      whereClauses.Add($" [GrupoServicoId] = @GrupoServicoId ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["GrupoServicoId"] = value; //06
                      whereClauses.Add($" [GrupoServicoId] = @GrupoServicoId ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
