...
namespace Query.Read 
{
    public class PacienteQueryRead : QueryBase, IPacienteQueryRead
    {
        ...
        public QueryModel PacienteQuery(Command.Read.PacienteReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Nome], [Telefone], [DataNascimento], [Genero], [Escolaridade], [Profissao], [Endereco], [NomeResponsavel], [TelefoneResponsavel], [Observacao], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [Paciente] ";
