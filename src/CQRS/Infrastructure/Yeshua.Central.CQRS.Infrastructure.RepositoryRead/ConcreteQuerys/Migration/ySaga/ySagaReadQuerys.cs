...
namespace Query.Read 
{
    public class ySagaQueryRead : QueryBase, IySagaQueryRead
    {
        ...
        public QueryModel ySagaQuery(Command.Read.ySagaReadCommand Command , bool TakeOffTenantID = false)
        {
            ...
            this.Query = $@" select [Id], [CorrelationId], [Type], [Status], [KeyCurrentStep], [CreatedAt], [CompletedAt], [EntityType], [EntityId], [NextExecutionAt], [LockedAt], [LockedBy], [TenantID], [OperationalEntityId], [Deleted], [Changed], [UserId] from [ySaga] ";
