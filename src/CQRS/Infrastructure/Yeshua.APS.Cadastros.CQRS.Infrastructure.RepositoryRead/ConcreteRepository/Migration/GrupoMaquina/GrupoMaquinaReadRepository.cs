...
namespace Read.Repository
{
    public partial class GrupoMaquinaReadRepository : IGrupoMaquinaReadRepository
    {
       ...
       protected readonly IGrupoMaquinaQueryRead _query;
        ...
        {
            var query = _query.ExistsByGMA_DESCRICAOQuery(value );
        ...
        {
            var query = _query.ExistsByGMA_STATUSQuery(value );
        ...
        {
            var query = _query.FirstByGMA_DESCRICAOQuery(value );
        ...
        {
            var query = _query.FirstByGMA_STATUSQuery(value );
