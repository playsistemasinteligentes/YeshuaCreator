...
namespace Read.Repository
{
    public partial class MaquinaReadRepository : IMaquinaReadRepository
    {
       ...
       protected readonly IMaquinaQueryRead _query;
        ...
        {
            var query = _query.ExistsByMAQ_DESCRICAOQuery(value );
        ...
        {
            var query = _query.ExistsByMAQ_STATUSQuery(value );
        ...
        {
            var query = _query.FirstByMAQ_DESCRICAOQuery(value );
        ...
        {
            var query = _query.FirstByMAQ_STATUSQuery(value );
