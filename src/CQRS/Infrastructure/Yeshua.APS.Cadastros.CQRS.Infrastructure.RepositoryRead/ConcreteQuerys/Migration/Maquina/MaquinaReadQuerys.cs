...
namespace Query.Read 
{
    public class MaquinaQueryRead : QueryBase, IMaquinaQueryRead
    {
        ...
        public QueryModel MaquinaQuery(Command.Read.MaquinaReadCommand Command )
        {
            ...
            this.Query = $@" select MAQ_ID, MAQ_DESCRICAO, MAQ_STATUS, TenantID, Deleted, Changed, UserId from Maquina ";
...
if (!string.IsNullOrEmpty(Command.MAQ_DESCRICAO)) dict["MAQ_DESCRICAO"] = $"%{Command.MAQ_DESCRICAO}%";
if (!string.IsNullOrEmpty(Command.MAQ_DESCRICAO)) whereClauses.Add($"MAQ_DESCRICAO like @MAQ_DESCRICAO");
if (!string.IsNullOrEmpty(Command.MAQ_STATUS)) dict["MAQ_STATUS"] = $"%{Command.MAQ_STATUS}%";
if (!string.IsNullOrEmpty(Command.MAQ_STATUS)) whereClauses.Add($"MAQ_STATUS like @MAQ_STATUS");
...
if (Command.UserId.HasValue) whereClauses.Add($"UserId = @UserId");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["MAQ_DESCRICAO"] = value; //04
                      whereClauses.Add($" MAQ_DESCRICAO = @MAQ_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["MAQ_STATUS"] = value; //04
                      whereClauses.Add($" MAQ_STATUS = @MAQ_STATUS ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"Deleted = @Deleted");
        ...
        public QueryModel FirstByMAQ_IDQuery(string value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT * FROM Maquina ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"TenantID = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["MAQ_DESCRICAO"] = value; //06
                      whereClauses.Add($" MAQ_DESCRICAO = @MAQ_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["MAQ_STATUS"] = value; //06
                      whereClauses.Add($" MAQ_STATUS = @MAQ_STATUS ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
