...
namespace Query.Read 
{
    public class TemplateDeTestesQueryRead : QueryBase, ITemplateDeTestesQueryRead
    {
        ...
        public QueryModel TemplateDeTestesQuery(Command.Read.TemplateDeTestesReadCommand Command )
        {
            ...
            this.Query = $@" select TEM_ID, TEM_DESCRICAO, TenantID, Deleted, Changed, UserId from TemplateDeTestes ";
if (Command.TEM_ID.HasValue) dict["TEM_ID"] = Command.TEM_ID.Value;
if (Command.TEM_ID.HasValue) whereClauses.Add($"TEM_ID = @TEM_ID");
if (!string.IsNullOrEmpty(Command.TEM_DESCRICAO)) dict["TEM_DESCRICAO"] = $"%{Command.TEM_DESCRICAO}%";
if (!string.IsNullOrEmpty(Command.TEM_DESCRICAO)) whereClauses.Add($"TEM_DESCRICAO like @TEM_DESCRICAO");
...
if (Command.UserId.HasValue) whereClauses.Add($"UserId = @UserId");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["TEM_DESCRICAO"] = value; //04
                      whereClauses.Add($" TEM_DESCRICAO = @TEM_DESCRICAO ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"Deleted = @Deleted");
        ...
        public QueryModel FirstByTEM_IDQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT * FROM TemplateDeTestes ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"TenantID = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["TEM_DESCRICAO"] = value; //06
                      whereClauses.Add($" TEM_DESCRICAO = @TEM_DESCRICAO ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
