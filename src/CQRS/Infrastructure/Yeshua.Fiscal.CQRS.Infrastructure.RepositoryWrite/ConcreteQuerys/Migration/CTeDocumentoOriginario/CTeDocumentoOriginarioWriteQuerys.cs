    ...
    public class CTeDocumentoOriginarioQueryWrite : QueryBase, ICTeDocumentoOriginarioQueryWrite
    {
        ...
        public QueryModel InserirCTeDocumentoOriginarioQuery(ICTeDocumentoOriginarioEntity CTeDocumentoOriginario)
        {
            ...
            this.Parameters = new
            {
                ...
                DocumentoFiscalOriginarioId = CTeDocumentoOriginario.DocumentoFiscalOriginarioId,
        ...
        {
            this.Query = $@" UPDATE [CTeDocumentoOriginario] SET [DocumentoFiscalOriginarioId] = @DocumentoFiscalOriginarioId WHERE [Id] = @Id ";
            this.Parameters = new
            {
