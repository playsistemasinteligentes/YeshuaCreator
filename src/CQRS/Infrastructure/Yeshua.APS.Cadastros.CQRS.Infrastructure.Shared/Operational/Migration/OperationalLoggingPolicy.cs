    ...
    var decision = Evaluate(
        ...
        return new OperationalTelemetryDecision(
            ...
            decision.Depth);
                ...
                {
                    ulong mask = 0UL;
                    if (DomainFieldTracked(policy, "Produto", operation, recordId, "PRO_ID"))
                        mask |= ProdutoTrackingFields.PRO_ID;
                    if (DomainFieldTracked(policy, "Produto", operation, recordId, "PRO_DESCRICAO"))
                        mask |= ProdutoTrackingFields.PRO_DESCRICAO;
                    if (DomainFieldTracked(policy, "Produto", operation, recordId, "PRO_STATUS"))
                        mask |= ProdutoTrackingFields.PRO_STATUS;
                ...
                {
                    ulong mask = 0UL;
                    if (DomainFieldTracked(policy, "Maquina", operation, recordId, "MAQ_ID"))
                        mask |= MaquinaTrackingFields.MAQ_ID;
                    if (DomainFieldTracked(policy, "Maquina", operation, recordId, "MAQ_DESCRICAO"))
                        mask |= MaquinaTrackingFields.MAQ_DESCRICAO;
                    if (DomainFieldTracked(policy, "Maquina", operation, recordId, "MAQ_STATUS"))
                        mask |= MaquinaTrackingFields.MAQ_STATUS;
                ...
                {
                    ulong mask = 0UL;
                    if (DomainFieldTracked(policy, "GrupoMaquina", operation, recordId, "GMA_ID"))
                        mask |= GrupoMaquinaTrackingFields.GMA_ID;
                    if (DomainFieldTracked(policy, "GrupoMaquina", operation, recordId, "GMA_DESCRICAO"))
                        mask |= GrupoMaquinaTrackingFields.GMA_DESCRICAO;
                    if (DomainFieldTracked(policy, "GrupoMaquina", operation, recordId, "GMA_STATUS"))
                        mask |= GrupoMaquinaTrackingFields.GMA_STATUS;
                ...
                {
                    ulong mask = 0UL;
                    if (DomainFieldTracked(policy, "TemplateDeTestes", operation, recordId, "TEM_ID"))
                        mask |= TemplateDeTestesTrackingFields.TEM_ID;
                    if (DomainFieldTracked(policy, "TemplateDeTestes", operation, recordId, "TEM_DESCRICAO"))
                        mask |= TemplateDeTestesTrackingFields.TEM_DESCRICAO;
                ...
                {
                    ulong mask = 0UL;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "MAQ_ID"))
                        mask |= RoteiroTrackingFields.MAQ_ID;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "PRO_ID"))
                        mask |= RoteiroTrackingFields.PRO_ID;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_SEQ_TRANFORMACAO"))
                        mask |= RoteiroTrackingFields.ROT_SEQ_TRANFORMACAO;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "GMA_ID"))
                        mask |= RoteiroTrackingFields.GMA_ID;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_PECAS_POR_PULSO"))
                        mask |= RoteiroTrackingFields.ROT_PECAS_POR_PULSO;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_PRIORIDADE_INFORMADA"))
                        mask |= RoteiroTrackingFields.ROT_PRIORIDADE_INFORMADA;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_ACAO"))
                        mask |= RoteiroTrackingFields.ROT_ACAO;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_PERFORMANCE"))
                        mask |= RoteiroTrackingFields.ROT_PERFORMANCE;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_TEMPO_SETUP"))
                        mask |= RoteiroTrackingFields.ROT_TEMPO_SETUP;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_TEMPO_SETUP_AJUSTE"))
                        mask |= RoteiroTrackingFields.ROT_TEMPO_SETUP_AJUSTE;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_VA_PARA_SEQ_TRANSFORMACAO"))
                        mask |= RoteiroTrackingFields.ROT_VA_PARA_SEQ_TRANSFORMACAO;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_STATUS"))
                        mask |= RoteiroTrackingFields.ROT_STATUS;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_HIERARQUIA_SEQ_TRANSFORMACAO"))
                        mask |= RoteiroTrackingFields.ROT_HIERARQUIA_SEQ_TRANSFORMACAO;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_AVALIA_CUSTO"))
                        mask |= RoteiroTrackingFields.ROT_AVALIA_CUSTO;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_OPERACOES"))
                        mask |= RoteiroTrackingFields.ROT_OPERACOES;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_EXCECAO_OPERACOES"))
                        mask |= RoteiroTrackingFields.ROT_EXCECAO_OPERACOES;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_PERCENTUAL_INICIO_PASSO_ANTERIOR"))
                        mask |= RoteiroTrackingFields.ROT_PERCENTUAL_INICIO_PASSO_ANTERIOR;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "ROT_LINHA_DIRETA"))
                        mask |= RoteiroTrackingFields.ROT_LINHA_DIRETA;
                    if (DomainFieldTracked(policy, "Roteiro", operation, recordId, "TEM_ID"))
                        mask |= RoteiroTrackingFields.TEM_ID;
