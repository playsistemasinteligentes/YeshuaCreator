...
namespace Read.Repository
{
    public partial class MDFeEncerramentoReadRepository : IMDFeEncerramentoReadRepository
    {
       ...
       protected readonly IMDFeEncerramentoQueryRead _query;
        ...
        partial void TryGetMDFeEncerramentoCustom(Command.Read.MDFeEncerramentoReadCommand command, ref DataPagination<MDFeEncerramentoDTO> result, ref bool handled);
