...
namespace Read.Repository
{
    public partial class CTeParticipanteSnapshotReadRepository : ICTeParticipanteSnapshotReadRepository
    {
       ...
       protected readonly ICTeParticipanteSnapshotQueryRead _query;
        ...
        partial void TryGetCTeParticipanteSnapshotCustom(Command.Read.CTeParticipanteSnapshotReadCommand command, ref DataPagination<CTeParticipanteSnapshotDTO> result, ref bool handled);
