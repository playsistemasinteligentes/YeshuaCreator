...
{
    public class CTeTentativaEmissaoQueryRead : QueryBase, ICTeTentativaEmissaoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public CTeTentativaEmissaoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel CTeTentativaEmissaoQuery(Command.Read.CTeTentativaEmissaoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [CTeSolicitacaoFiscalId], [ChaveAcesso], [Numero], [Serie], [Tentativa], [XmlAssinadoStorageKey], [XmlProcStorageKey], [XmlHash], [CodigoRetorno], [MensagemRetorno], [ProtocoloAutorizacao], [EnviadoEmUtc], [AutorizadoEmUtc], [Status], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [CTeTentativaEmissao] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [CTeTentativaEmissao] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
