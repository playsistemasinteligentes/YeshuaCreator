...
namespace Query.Read 
{
    public class ContingenciaFiscalQueryRead : QueryBase, IContingenciaFiscalQueryRead
    {
        ...
        public QueryModel ContingenciaFiscalQuery(Command.Read.ContingenciaFiscalReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [EmissaoFiscalTransporteId], [EntradaFiscalContingenciaId], [CorrelationId], [CargaId], [TipoSolicitante], [Ambiente], [EmitenteDocumento], [TomadorDocumento], [TransportadorDocumento], [QuantidadeDocumentos], [QuantidadeCTe], [QuantidadeMDFe], [ValorCarga], [PesoBruto], [UltimaMensagem], [CriadoEmUtc], [AtualizadoEmUtc], [ConcluidoEmUtc], [Status], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [ContingenciaFiscal] ";
