...
{
    public class MDFeCondutorQueryRead : QueryBase, IMDFeCondutorQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public MDFeCondutorQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel MDFeCondutorQuery(Command.Read.MDFeCondutorReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [MDFeSolicitacaoFiscalId], [Nome], [Documento], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [MDFeCondutor] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [MDFeCondutor] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
