...
{
    public class MDFeDocumentoOriginarioQueryRead : QueryBase, IMDFeDocumentoOriginarioQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public MDFeDocumentoOriginarioQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel MDFeDocumentoOriginarioQuery(Command.Read.MDFeDocumentoOriginarioReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [MDFeSolicitacaoFiscalId], [DocumentoFiscalOriginarioId], [TipoDocumento], [ChaveAcesso], [SnapshotJson], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [MDFeDocumentoOriginario] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [MDFeDocumentoOriginario] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
