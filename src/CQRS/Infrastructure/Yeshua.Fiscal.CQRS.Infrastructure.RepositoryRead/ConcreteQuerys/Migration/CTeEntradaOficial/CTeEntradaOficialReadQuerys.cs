...
{
    public class CTeEntradaOficialQueryRead : QueryBase, ICTeEntradaOficialQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public CTeEntradaOficialQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel CTeEntradaOficialQuery(Command.Read.CTeEntradaOficialReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [CorrelationId], [SourceApplication], [SourceModule], [SourceMessageId], [MessageType], [MessageVersion], [ReceivedAtUtc], [PayloadHash], [PayloadStorageKey], [Status], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [CTeEntradaOficial] ";
...
if (!string.IsNullOrEmpty(Command.MessageType)) dict["MessageType"] = $"%{Command.MessageType}%";
if (!string.IsNullOrEmpty(Command.MessageType)) whereClauses.Add($"[MessageType] like @MessageType");
if (!string.IsNullOrEmpty(Command.MessageVersion)) dict["MessageVersion"] = $"%{Command.MessageVersion}%";
if (!string.IsNullOrEmpty(Command.MessageVersion)) whereClauses.Add($"[MessageVersion] like @MessageVersion");
if (!string.IsNullOrEmpty(Command.PayloadHash)) dict["PayloadHash"] = $"%{Command.PayloadHash}%";
if (!string.IsNullOrEmpty(Command.PayloadHash)) whereClauses.Add($"[PayloadHash] like @PayloadHash");
if (!string.IsNullOrEmpty(Command.PayloadStorageKey)) dict["PayloadStorageKey"] = $"%{Command.PayloadStorageKey}%";
if (!string.IsNullOrEmpty(Command.PayloadStorageKey)) whereClauses.Add($"[PayloadStorageKey] like @PayloadStorageKey");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [CTeEntradaOficial] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MessageType"] = value; //04
                      whereClauses.Add($" [MessageType] = @MessageType ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MessageVersion"] = value; //04
                      whereClauses.Add($" [MessageVersion] = @MessageVersion ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ReceivedAtUtc"] = value; //04
                      whereClauses.Add($" [ReceivedAtUtc] = @ReceivedAtUtc ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PayloadHash"] = value; //04
                      whereClauses.Add($" [PayloadHash] = @PayloadHash ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PayloadStorageKey"] = value; //04
                      whereClauses.Add($" [PayloadStorageKey] = @PayloadStorageKey ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MessageType"] = value; //06
                      whereClauses.Add($" [MessageType] = @MessageType ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MessageVersion"] = value; //06
                      whereClauses.Add($" [MessageVersion] = @MessageVersion ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ReceivedAtUtc"] = value; //06
                      whereClauses.Add($" [ReceivedAtUtc] = @ReceivedAtUtc ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PayloadHash"] = value; //06
                      whereClauses.Add($" [PayloadHash] = @PayloadHash ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["PayloadStorageKey"] = value; //06
                      whereClauses.Add($" [PayloadStorageKey] = @PayloadStorageKey ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
