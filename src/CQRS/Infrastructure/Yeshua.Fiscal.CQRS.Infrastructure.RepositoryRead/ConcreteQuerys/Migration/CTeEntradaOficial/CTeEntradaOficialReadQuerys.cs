...
namespace Query.Read 
{
    public class CTeEntradaOficialQueryRead : QueryBase, ICTeEntradaOficialQueryRead
    {
        ...
        public QueryModel CTeEntradaOficialQuery(Command.Read.CTeEntradaOficialReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [CorrelationId], [SourceApplication], [SourceModule], [SourceMessageId], [MessageType], [MessageVersion], [ReceivedAtUtc], [PayloadHash], [PayloadStorageKey], [Status], [TenantID], [Deleted], [Changed], [UserId] from [CTeEntradaOficial] ";
