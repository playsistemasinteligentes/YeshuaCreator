...
namespace Query.Read 
{
    public class yInboxQueryRead : QueryBase, IyInboxQueryRead
    {
        ...
        public yInboxQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel yInboxQuery(Command.Read.yInboxReadCommand Command , bool TakeOffTenantID = false)
        {
            ...
            this.Query = $@" select [Id], [MessageId], [Type], [EntityType], [EntityId], [CorrelationId], [Payload], [Status], [CreatedAt], [RetryCount], [LastError], [ProcessingAt], [NextAttemptAt], [SagaId], [SagaStepId], [TenantID], [OperationalEntityId], [Deleted], [Changed], [UserId] from [yInbox] ";
