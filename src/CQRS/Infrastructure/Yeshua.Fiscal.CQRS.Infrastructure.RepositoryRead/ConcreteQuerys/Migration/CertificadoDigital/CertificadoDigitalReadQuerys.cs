...
{
    public class CertificadoDigitalQueryRead : QueryBase, ICertificadoDigitalQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public CertificadoDigitalQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel CertificadoDigitalQuery(Command.Read.CertificadoDigitalReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [Apelido], [DocumentoTitular], [StorageKey], [Thumbprint], [ValidoDe], [ValidoAte], [Ativo], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId], [SenhaStorageKey] from [CertificadoDigital] ";
if (Command.Id.HasValue) dict["Id"] = Command.Id.Value;
if (Command.Id.HasValue) whereClauses.Add($"[Id] = @Id");
if (!string.IsNullOrEmpty(Command.Apelido)) dict["Apelido"] = $"%{Command.Apelido}%";
if (!string.IsNullOrEmpty(Command.Apelido)) whereClauses.Add($"[Apelido] like @Apelido");
if (!string.IsNullOrEmpty(Command.DocumentoTitular)) dict["DocumentoTitular"] = $"%{Command.DocumentoTitular}%";
if (!string.IsNullOrEmpty(Command.DocumentoTitular)) whereClauses.Add($"[DocumentoTitular] like @DocumentoTitular");
if (!string.IsNullOrEmpty(Command.StorageKey)) dict["StorageKey"] = $"%{Command.StorageKey}%";
if (!string.IsNullOrEmpty(Command.StorageKey)) whereClauses.Add($"[StorageKey] like @StorageKey");
if (!string.IsNullOrEmpty(Command.Thumbprint)) dict["Thumbprint"] = $"%{Command.Thumbprint}%";
if (!string.IsNullOrEmpty(Command.Thumbprint)) whereClauses.Add($"[Thumbprint] like @Thumbprint");
if (Command.Ativo.HasValue)
{
    dict["Ativo"] = Command.Ativo.Value;
...
if (!string.IsNullOrEmpty(Command.SenhaStorageKey)) whereClauses.Add($"[SenhaStorageKey] like @SenhaStorageKey");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Apelido"] = value; //04
                      whereClauses.Add($" [Apelido] = @Apelido ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DocumentoTitular"] = value; //04
                      whereClauses.Add($" [DocumentoTitular] = @DocumentoTitular ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["StorageKey"] = value; //04
                      whereClauses.Add($" [StorageKey] = @StorageKey ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Thumbprint"] = value; //04
                      whereClauses.Add($" [Thumbprint] = @Thumbprint ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ValidoDe"] = value; //04
                      whereClauses.Add($" [ValidoDe] = @ValidoDe ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ValidoAte"] = value; //04
                      whereClauses.Add($" [ValidoAte] = @ValidoAte ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Ativo"] = value; //04
                      whereClauses.Add($" [Ativo] = @Ativo ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Apelido"] = value; //06
                      whereClauses.Add($" [Apelido] = @Apelido ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["DocumentoTitular"] = value; //06
                      whereClauses.Add($" [DocumentoTitular] = @DocumentoTitular ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["StorageKey"] = value; //06
                      whereClauses.Add($" [StorageKey] = @StorageKey ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Thumbprint"] = value; //06
                      whereClauses.Add($" [Thumbprint] = @Thumbprint ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ValidoDe"] = value; //06
                      whereClauses.Add($" [ValidoDe] = @ValidoDe ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["ValidoAte"] = value; //06
                      whereClauses.Add($" [ValidoAte] = @ValidoAte ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Ativo"] = value; //06
                      whereClauses.Add($" [Ativo] = @Ativo ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
