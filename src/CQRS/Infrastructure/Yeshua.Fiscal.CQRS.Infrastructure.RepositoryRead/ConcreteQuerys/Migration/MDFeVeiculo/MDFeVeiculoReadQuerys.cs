...
{
    public class MDFeVeiculoQueryRead : QueryBase, IMDFeVeiculoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public MDFeVeiculoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel MDFeVeiculoQuery(Command.Read.MDFeVeiculoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [MDFeSolicitacaoFiscalId], [Placa], [Renavam], [Tara], [CapacidadeKg], [CapacidadeM3], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [MDFeVeiculo] ";
...
if (!string.IsNullOrEmpty(Command.Placa)) dict["Placa"] = $"%{Command.Placa}%";
if (!string.IsNullOrEmpty(Command.Placa)) whereClauses.Add($"[Placa] like @Placa");
if (!string.IsNullOrEmpty(Command.Renavam)) dict["Renavam"] = $"%{Command.Renavam}%";
if (!string.IsNullOrEmpty(Command.Renavam)) whereClauses.Add($"[Renavam] like @Renavam");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [MDFeVeiculo] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Placa"] = value; //04
                      whereClauses.Add($" [Placa] = @Placa ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Renavam"] = value; //04
                      whereClauses.Add($" [Renavam] = @Renavam ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CapacidadeKg"] = value; //04
                      whereClauses.Add($" [CapacidadeKg] = @CapacidadeKg ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CapacidadeM3"] = value; //04
                      whereClauses.Add($" [CapacidadeM3] = @CapacidadeM3 ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Placa"] = value; //06
                      whereClauses.Add($" [Placa] = @Placa ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Renavam"] = value; //06
                      whereClauses.Add($" [Renavam] = @Renavam ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CapacidadeKg"] = value; //06
                      whereClauses.Add($" [CapacidadeKg] = @CapacidadeKg ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CapacidadeM3"] = value; //06
                      whereClauses.Add($" [CapacidadeM3] = @CapacidadeM3 ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
