...
{
    public class SefazEndpointQueryRead : QueryBase, ISefazEndpointQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public SefazEndpointQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel SefazEndpointQuery(Command.Read.SefazEndpointReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [ProdutoFiscal], [UF], [Ambiente], [Servico], [Versao], [Url], [Ativo], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [SefazEndpoint] ";
...
if (!string.IsNullOrEmpty(Command.Servico)) dict["Servico"] = $"%{Command.Servico}%";
if (!string.IsNullOrEmpty(Command.Servico)) whereClauses.Add($"[Servico] like @Servico");
if (!string.IsNullOrEmpty(Command.Versao)) dict["Versao"] = $"%{Command.Versao}%";
if (!string.IsNullOrEmpty(Command.Versao)) whereClauses.Add($"[Versao] like @Versao");
if (!string.IsNullOrEmpty(Command.Url)) dict["Url"] = $"%{Command.Url}%";
if (!string.IsNullOrEmpty(Command.Url)) whereClauses.Add($"[Url] like @Url");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [SefazEndpoint] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Servico"] = value; //04
                      whereClauses.Add($" [Servico] = @Servico ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Versao"] = value; //04
                      whereClauses.Add($" [Versao] = @Versao ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Servico"] = value; //06
                      whereClauses.Add($" [Servico] = @Servico ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Versao"] = value; //06
                      whereClauses.Add($" [Versao] = @Versao ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
