...
{
    public class DocumentoFiscalOriginarioQueryRead : QueryBase, IDocumentoFiscalOriginarioQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public DocumentoFiscalOriginarioQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel DocumentoFiscalOriginarioQuery(Command.Read.DocumentoFiscalOriginarioReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [DocumentoFiscalId], [CorrelationId], [SourceApplication], [SourceModule], [SourceMessageId], [TipoDocumento], [ChaveAcesso], [Numero], [Serie], [EmitenteDocumento], [DestinatarioDocumento], [ValorDocumento], [PesoBruto], [Volume], [SnapshotJson], [Status], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [DocumentoFiscalOriginario] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [DocumentoFiscalOriginario] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
