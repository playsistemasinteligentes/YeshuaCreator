...
namespace Query.Read 
{
    public class DocumentoFiscalOriginarioQueryRead : QueryBase, IDocumentoFiscalOriginarioQueryRead
    {
        ...
        public QueryModel DocumentoFiscalOriginarioQuery(Command.Read.DocumentoFiscalOriginarioReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [DocumentoFiscalId], [CorrelationId], [SourceApplication], [SourceModule], [SourceMessageId], [TipoDocumento], [ChaveAcesso], [Numero], [Serie], [EmitenteDocumento], [DestinatarioDocumento], [ValorDocumento], [PesoBruto], [Volume], [SnapshotJson], [Status], [TenantID], [Deleted], [Changed], [UserId] from [DocumentoFiscalOriginario] ";
