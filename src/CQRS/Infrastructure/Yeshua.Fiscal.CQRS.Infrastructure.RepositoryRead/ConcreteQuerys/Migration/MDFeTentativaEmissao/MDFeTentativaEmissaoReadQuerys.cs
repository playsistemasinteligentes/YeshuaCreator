...
namespace Query.Read 
{
    public class MDFeTentativaEmissaoQueryRead : QueryBase, IMDFeTentativaEmissaoQueryRead
    {
        ...
        public QueryModel MDFeTentativaEmissaoQuery(Command.Read.MDFeTentativaEmissaoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [MDFeSolicitacaoFiscalId], [ChaveAcesso], [Numero], [Serie], [Tentativa], [XmlAssinadoStorageKey], [XmlProcStorageKey], [XmlHash], [CodigoRetorno], [MensagemRetorno], [ProtocoloAutorizacao], [EnviadoEmUtc], [AutorizadoEmUtc], [Status], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [MDFeTentativaEmissao] ";
