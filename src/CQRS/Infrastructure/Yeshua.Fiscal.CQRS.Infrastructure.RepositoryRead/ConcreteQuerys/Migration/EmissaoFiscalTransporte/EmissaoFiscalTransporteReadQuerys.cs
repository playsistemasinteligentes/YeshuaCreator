...
namespace Query.Read 
{
    public class EmissaoFiscalTransporteQueryRead : QueryBase, IEmissaoFiscalTransporteQueryRead
    {
        ...
        public QueryModel EmissaoFiscalTransporteQuery(Command.Read.EmissaoFiscalTransporteReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [CorrelationId], [OrigemFluxo], [CargaId], [RomaneioId], [Ambiente], [EmitenteDocumento], [TomadorDocumento], [TransportadorDocumento], [UFInicio], [UFFim], [MunicipioInicioCodigoIbge], [MunicipioFimCodigoIbge], [QuantidadeNFe], [QuantidadeCTe], [QuantidadeMDFe], [ValorCarga], [PesoBruto], [Volume], [UltimaMensagem], [CriadoEmUtc], [AtualizadoEmUtc], [ConcluidoEmUtc], [Status], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [EmissaoFiscalTransporte] ";
