...
{
    public class CTeParticipanteSnapshotQueryRead : QueryBase, ICTeParticipanteSnapshotQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public CTeParticipanteSnapshotQueryRead(IExecutionContext executionContext)
        {
...
if (Command.CTeSolicitacaoFiscalId.HasValue) whereClauses.Add($"[CTeSolicitacaoFiscalId] = @CTeSolicitacaoFiscalId");
if (!string.IsNullOrEmpty(Command.Papel)) dict["Papel"] = $"%{Command.Papel}%";
if (!string.IsNullOrEmpty(Command.Papel)) whereClauses.Add($"[Papel] like @Papel");
if (!string.IsNullOrEmpty(Command.Documento)) dict["Documento"] = $"%{Command.Documento}%";
if (!string.IsNullOrEmpty(Command.Documento)) whereClauses.Add($"[Documento] like @Documento");
...
if (!string.IsNullOrEmpty(Command.InscricaoEstadual)) dict["InscricaoEstadual"] = $"%{Command.InscricaoEstadual}%";
if (!string.IsNullOrEmpty(Command.InscricaoEstadual)) whereClauses.Add($"[InscricaoEstadual] like @InscricaoEstadual");
if (!string.IsNullOrEmpty(Command.UF)) dict["UF"] = $"%{Command.UF}%";
if (!string.IsNullOrEmpty(Command.UF)) whereClauses.Add($"[UF] like @UF");
if (!string.IsNullOrEmpty(Command.MunicipioCodigoIbge)) dict["MunicipioCodigoIbge"] = $"%{Command.MunicipioCodigoIbge}%";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CTeSolicitacaoFiscalId"] = value; //04
                      whereClauses.Add($" [CTeSolicitacaoFiscalId] = @CTeSolicitacaoFiscalId ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Documento"] = value; //04
                      whereClauses.Add($" [Documento] = @Documento ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["InscricaoEstadual"] = value; //04
                      whereClauses.Add($" [InscricaoEstadual] = @InscricaoEstadual ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MunicipioCodigoIbge"] = value; //04
                      whereClauses.Add($" [MunicipioCodigoIbge] = @MunicipioCodigoIbge ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EnderecoJson"] = value; //04
                      whereClauses.Add($" [EnderecoJson] = @EnderecoJson ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CTeSolicitacaoFiscalId"] = value; //06
                      whereClauses.Add($" [CTeSolicitacaoFiscalId] = @CTeSolicitacaoFiscalId ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["Documento"] = value; //06
                      whereClauses.Add($" [Documento] = @Documento ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["InscricaoEstadual"] = value; //06
                      whereClauses.Add($" [InscricaoEstadual] = @InscricaoEstadual ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["MunicipioCodigoIbge"] = value; //06
                      whereClauses.Add($" [MunicipioCodigoIbge] = @MunicipioCodigoIbge ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["EnderecoJson"] = value; //06
                      whereClauses.Add($" [EnderecoJson] = @EnderecoJson ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
