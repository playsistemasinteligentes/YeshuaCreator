...
{
    public class CTeDocumentoOriginarioQueryRead : QueryBase, ICTeDocumentoOriginarioQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public CTeDocumentoOriginarioQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel CTeDocumentoOriginarioQuery(Command.Read.CTeDocumentoOriginarioReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [CTeSolicitacaoFiscalId], [DocumentoFiscalOriginarioId], [TipoDocumento], [ChaveAcesso], [Numero], [Serie], [EmitenteDocumento], [DestinatarioDocumento], [ValorDocumento], [PesoBruto], [SnapshotJson], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [CTeDocumentoOriginario] ";
...
if (!string.IsNullOrEmpty(Command.TipoDocumento)) dict["TipoDocumento"] = $"%{Command.TipoDocumento}%";
if (!string.IsNullOrEmpty(Command.TipoDocumento)) whereClauses.Add($"[TipoDocumento] like @TipoDocumento");
...
if (!string.IsNullOrEmpty(Command.Numero)) dict["Numero"] = $"%{Command.Numero}%";
if (!string.IsNullOrEmpty(Command.Numero)) whereClauses.Add($"[Numero] like @Numero");
if (!string.IsNullOrEmpty(Command.Serie)) dict["Serie"] = $"%{Command.Serie}%";
if (!string.IsNullOrEmpty(Command.Serie)) whereClauses.Add($"[Serie] like @Serie");
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel CTeDocumentoOriginarioDocumentoFiscalOriginarioIdQuery(Command.Patterns.Command.SearchFKCommand Command )
        {
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [CTeDocumentoOriginario] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TipoDocumento"] = value; //04
                      whereClauses.Add($" [TipoDocumento] = @TipoDocumento ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["TipoDocumento"] = value; //06
                      whereClauses.Add($" [TipoDocumento] = @TipoDocumento ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
