...
if (Command.CertificadoDigitalId.HasValue) dict["CertificadoDigitalId"] = Command.CertificadoDigitalId.Value;
if (Command.CertificadoDigitalId.HasValue) whereClauses.Add($"[CertificadoDigitalId] = @CertificadoDigitalId");
            if (whereClauses.Any()) 
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        {
            this.Query = $@" select [Id] from [CertificadoDigital] ";
            var whereClauses = new List<string>();
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            if (!string.IsNullOrEmpty(Command.searchFK)) 
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CertificadoDigitalId"] = value; //04
                      whereClauses.Add($" [CertificadoDigitalId] = @CertificadoDigitalId ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
 ...
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
                      dict["CertificadoDigitalId"] = value; //06
                      whereClauses.Add($" [CertificadoDigitalId] = @CertificadoDigitalId ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
