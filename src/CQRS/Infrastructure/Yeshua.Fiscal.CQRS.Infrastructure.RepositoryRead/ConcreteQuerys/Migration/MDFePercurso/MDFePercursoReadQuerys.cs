...
{
    public class MDFePercursoQueryRead : QueryBase, IMDFePercursoQueryRead
    {
        protected readonly IExecutionContext _executionContext;
        public MDFePercursoQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel MDFePercursoQuery(Command.Read.MDFePercursoReadCommand Command )
        {
            ...
            this.Query = $@" select [Id], [MDFeSolicitacaoFiscalId], [UF], [Ordem], [OperationalEntityId], [TenantID], [Deleted], [Changed], [UserId] from [MDFePercurso] ";
...
if (Command.UserId.HasValue) whereClauses.Add($"[UserId] = @UserId");
 ...
 whereClauses.Add($"[Deleted] = @Deleted");
        ...
        public QueryModel ExistsByIdQuery(int value )
        {
            ...
            dynamic parameters = new ExpandoObject();
            var dict = (IDictionary<string, object>)parameters;
            this.Query = $"SELECT 1 FROM [MDFePercurso] ";
 dict["TenantID"] = _executionContext.TenantID;
 whereClauses.Add($"[TenantID] = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"[Deleted] = @Deleted");
