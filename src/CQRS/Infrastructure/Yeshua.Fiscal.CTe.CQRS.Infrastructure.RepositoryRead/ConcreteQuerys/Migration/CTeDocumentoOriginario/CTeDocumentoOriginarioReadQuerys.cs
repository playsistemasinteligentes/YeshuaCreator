...
namespace Query.Read 
{
    public class CTeDocumentoOriginarioQueryRead : QueryBase, ICTeDocumentoOriginarioQueryRead
    {
        ...
        public QueryModel CTeDocumentoOriginarioQuery(Command.Read.CTeDocumentoOriginarioReadCommand Command )
        {
            ...
            this.Query = $@" select Id, CTeSolicitacaoFiscalId, TipoDocumento, ChaveAcesso, Numero, Serie, EmitenteDocumento, DestinatarioDocumento, ValorDocumento, PesoBruto, SnapshotJson, TenantID, Deleted, Changed, UserId from CTeDocumentoOriginario ";
