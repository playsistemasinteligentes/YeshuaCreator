...
namespace Query.Read 
{
    public class yPerfilGrantQueryRead : QueryBase, IyPerfilGrantQueryRead
    {
        ...
        public yPerfilGrantQueryRead(IExecutionContext executionContext)
        {
        ...
        public QueryModel yPerfilGrantQuery(Command.Read.yPerfilGrantReadCommand Command )
        {
            ...
            this.Query = $@" select Id, PerfilId, GrantId, CanGrant, CanCreate, CanRead, CanUpdate, CanDelete, ValidUntil, TenantID, Deleted, Changed, UserId from yPerfilGrant ";
