                    ...
                    public partial class TargetProdutoEntity : ITargetProdutoEntity
{
 ...
 TAR_DIA_TURMA_D = tar_dia_turma_d.HasValue && tar_dia_turma_d.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : tar_dia_turma_d; 
 FEE_QTD_PECAS_POR_PULSO = fee_qtd_pecas_por_pulso; 
 TAR_QTD_PERDAS = tar_qtd_perdas; 
 TAR_DATA_INICIAL = tar_data_inicial.HasValue && tar_data_inicial.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : tar_data_inicial; 
