                    ...
                    public partial class CorridasOnduladeiraEntity : ICorridasOnduladeiraEntity
{
 ...
 COR_INICIO_PREVISTO = cor_inicio_previsto.HasValue && cor_inicio_previsto.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : cor_inicio_previsto; 
 COR_FIM_PREVISTO = cor_fim_previsto.HasValue && cor_fim_previsto.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : cor_fim_previsto; 
 PRO_ID = pro_id; 
