                    ...
                    public partial class ClpMedicoesHEntity : IClpMedicoesHEntity
{
 ...
 CLP_EMISSAO = clp_emissao.HasValue && clp_emissao.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : clp_emissao; 
 QTD = qtd; 
 GRUPO = grupo; 
 STATUS = status; 
 URN_ID = urn_id; 
...
_erroMensagem = new List<string>();
   ...
   if(DATA_INI < (new DateTime(1800, 1, 1)))
   this._erroMensagem.Add("DATA INI deve ser informado.");
   if(DATA_FIM < (new DateTime(1800, 1, 1)))
