                    ...
                    public partial class TesteFisicoEntity : ITesteFisicoEntity
{
 ...
 TES_VALOR_DATA = tes_valor_data.HasValue && tes_valor_data.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : tes_valor_data; 
 TES_VALOR_TEXTO = tes_valor_texto; 
 TES_EMISSAO = tes_emissao.HasValue && tes_emissao.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : tes_emissao; 
 ORD_ID = ord_id; 
 PRO_ID = pro_id; 
 MAQ_ID = maq_id; 
