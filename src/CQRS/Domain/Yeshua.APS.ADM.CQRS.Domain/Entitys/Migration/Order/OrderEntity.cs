                    ...
                    public partial class OrderEntity : IOrderEntity
{
 ...
 HASH_KEY = hash_key; 
 ORD_INICIO_JANELA_EMBARQUE = ord_inicio_janela_embarque.HasValue && ord_inicio_janela_embarque.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : ord_inicio_janela_embarque; 
 ORD_FIM_JANELA_EMBARQUE = ord_fim_janela_embarque.HasValue && ord_fim_janela_embarque.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : ord_fim_janela_embarque; 
 ORD_EMBARQUE_ALVO = ord_embarque_alvo.HasValue && ord_embarque_alvo.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : ord_embarque_alvo; 
 ORD_INICIO_GRUPO_PRODUTIVO = ord_inicio_grupo_produtivo.HasValue && ord_inicio_grupo_produtivo.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : ord_inicio_grupo_produtivo; 
 ORD_FIM_GRUPO_PRODUTIVO = ord_fim_grupo_produtivo.HasValue && ord_fim_grupo_produtivo.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : ord_fim_grupo_produtivo; 
 ...
 ORD_EMISSAO = ord_emissao.HasValue && ord_emissao.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : ord_emissao; 
 REP_ID = rep_id; 
 ...
 ORD_DATA_CANCELAMENTO = ord_data_cancelamento.HasValue && ord_data_cancelamento.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : ord_data_cancelamento; 
...
_erroMensagem = new List<string>();
   ...
   if(ORD_DATA_ENTREGA_DE < (new DateTime(1800, 1, 1)))
   this._erroMensagem.Add("ORD DATA ENTREGA DE deve ser informado.");
   if(ORD_DATA_ENTREGA_ATE < (new DateTime(1800, 1, 1)))
