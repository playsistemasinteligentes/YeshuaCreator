                    ...
                    public partial class InspecaoVisualEntity : IInspecaoVisualEntity
{
 ...
 IPV_OBS = ipv_obs; 
 IPV_DATA_COLETA = ipv_data_coleta.HasValue && ipv_data_coleta.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : ipv_data_coleta; 
 IPV_DATA_AVAL = ipv_data_aval.HasValue && ipv_data_aval.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : ipv_data_aval; 
 TIV_ID = tiv_id; 
 TURN_ID = turn_id; 
 TURM_ID = turm_id; 
 ORD_ID = ord_id; 
