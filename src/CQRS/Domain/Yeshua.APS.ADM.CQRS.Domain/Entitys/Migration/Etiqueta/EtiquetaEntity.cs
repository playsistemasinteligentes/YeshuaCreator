                    ...
                    public partial class EtiquetaEntity : IEtiquetaEntity
{
 ...
 ETI_ID = eti_id; 
 ETI_EMISSAO = eti_emissao.HasValue && eti_emissao.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : eti_emissao; 
 ETI_CODIGO_BARRAS = eti_codigo_barras; 
 ETI_SEQUENCIA = eti_sequencia; 
 ETI_NUMERO_COPIAS = eti_numero_copias; 
 ETI_STATUS = eti_status; 
 ETI_DATA_FABRICACAO = eti_data_fabricacao.HasValue && eti_data_fabricacao.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : eti_data_fabricacao; 
