...
// </yeshua>
                ...
                {
                    public partial class FilaProducaoEntity : IFilaProducaoEntity
{
 ...
 FPR_DATA_ENCERRAMENTO = (fpr_data_encerramento < (new DateTime(1800, 1, 1))) ? DateTime.Now : fpr_data_encerramento; 
}
