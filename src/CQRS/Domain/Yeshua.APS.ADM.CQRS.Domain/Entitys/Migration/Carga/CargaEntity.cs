                    ...
                    public partial class CargaEntity : ICargaEntity
{
 ...
 CAR_DATA_ENTRADA_VEICULO = car_data_entrada_veiculo.HasValue && car_data_entrada_veiculo.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : car_data_entrada_veiculo; 
 CAR_DATA_SAIDA_VEICULO = car_data_saida_veiculo.HasValue && car_data_saida_veiculo.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : car_data_saida_veiculo; 
 CAR_DATA_ROMANEIO_CONSOLIDADO = car_data_romaneio_consolidado.HasValue && car_data_romaneio_consolidado.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : car_data_romaneio_consolidado; 
