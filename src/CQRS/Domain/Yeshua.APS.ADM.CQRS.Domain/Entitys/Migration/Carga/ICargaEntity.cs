                    ...
                    public interface ICargaEntity
{
    ...
    string CAR_ID_INTEGRACAO_BALANCA { get; set; }
    string CAR_PESAGEM_LIBERADA { get; set; }
    string CAR_OBS_LIERACAO { get; set; }
    string OCO_ID_LIERACAO { get; set; }
    DateTime? CAR_DATA_ENTRADA_VEICULO { get; set; }
    DateTime? CAR_DATA_SAIDA_VEICULO { get; set; }
    DateTime? CAR_DATA_ROMANEIO_CONSOLIDADO { get; set; }
    string CAR_DIA_TURMA_ROMANEIO_CONSOLIDADO { get; set; }
    Decimal? CAR_DIFERENCA_PESAGEM { get; set; }
    DateTime? CAR_DATA_AGENCIAMENTO { get; set; }
