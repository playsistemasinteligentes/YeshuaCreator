                    ...
                    public partial class yOutboxEntity : IyOutboxEntity
{
 ...
 SentAt = sentat.HasValue && sentat.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : sentat; 
 RetryCount = retrycount; 
 LastError = lasterror; 
 ProcessingAt = processingat.HasValue && processingat.Value < (new DateTime(1800, 1, 1)) ? DateTime.Now : processingat; 
...
_erroMensagem = new List<string>();
   ...
   if(CreatedAt < (new DateTime(1800, 1, 1)))
