...
// </yeshua>
                            ...
                            namespace Dominio.Entitys
                            {
                                public class TemplateDeTestesFactory
                                {
                                    ...
                                    } public ITemplateDeTestesEntity Create(int? tem_id, string tem_descricao )
                            {
                                return Create(null, tem_id, tem_descricao);
                            }

                            public ITemplateDeTestesEntity Create(
                                Dominio.Patterns.Domain.DomainOperationContext? context, int? tem_id, string tem_descricao )
                            {
                            var entity = new TemplateDeTestesEntity(tem_id, tem_descricao );
