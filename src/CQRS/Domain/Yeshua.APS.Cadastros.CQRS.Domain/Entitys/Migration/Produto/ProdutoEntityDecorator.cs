...
// </yeshua>
        ...
        {
            public const ulong PRO_ID = 1UL << 0;
            public const ulong PRO_DESCRICAO = 1UL << 1;
            public const ulong PRO_STATUS = 1UL << 2;
                            ...
                            _trackingRecordId = context?.RecordId;
                                    ...
                                    public string PRO_ID
                                    {
                                        ...
                                        set
                                        {
                                            ...
                                            {
                                                _inner.PRO_ID = value;
                                                if ((_trackingMask & ProdutoTrackingFields.PRO_ID) != 0UL)
                                                    _logger.DomainValueChanged("Produto", "PRO_ID", _trackingTraceId, _trackingOperation, _trackingRecordId, value);
                                            }
                                        }
                                    }
                                    ...
                                    {
                                        get => _inner.PRO_DESCRICAO;
                                        set
                                        {
                                            if (_inner.PRO_DESCRICAO != value)
                                            {
                                                _inner.PRO_DESCRICAO = value;
                                                if ((_trackingMask & ProdutoTrackingFields.PRO_DESCRICAO) != 0UL)
                                                    _logger.DomainValueChanged("Produto", "PRO_DESCRICAO", _trackingTraceId, _trackingOperation, _trackingRecordId, value);
                                            }
                                        }
                                    }
                                    ...
                                    {
                                        get => _inner.PRO_STATUS;
                                        set
                                        {
                                            if (_inner.PRO_STATUS != value)
                                            {
                                                _inner.PRO_STATUS = value;
                                                if ((_trackingMask & ProdutoTrackingFields.PRO_STATUS) != 0UL)
                                                    _logger.DomainValueChanged("Produto", "PRO_STATUS", _trackingTraceId, _trackingOperation, _trackingRecordId, value);
                                            }
                                        }
                                    }
