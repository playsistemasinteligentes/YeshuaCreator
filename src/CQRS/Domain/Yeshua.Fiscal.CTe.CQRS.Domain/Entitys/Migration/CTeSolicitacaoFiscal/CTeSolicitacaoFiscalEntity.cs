...
_erroMensagem = new List<string>();
   ...
   if (Ambiente == null)
   this._erroMensagem.Add("Ambiente deve ser informado.");
   ...
   if (ProdutoFiscal == null)
   this._erroMensagem.Add("Produto Fiscal deve ser informado.");
   if (TipoCTe == null)
   this._erroMensagem.Add("Tipo CT-e deve ser informado.");
   if (TipoServico == null)
   this._erroMensagem.Add("Tipo Servico deve ser informado.");
   if (Modal == null)
   this._erroMensagem.Add("Modal deve ser informado.");
   if (Globalizado == null)
   this._erroMensagem.Add("Globalizado deve ser informado.");
   ...
   if (Status == null)
   this._erroMensagem.Add("Status da Solicitacao deve ser informado.");
