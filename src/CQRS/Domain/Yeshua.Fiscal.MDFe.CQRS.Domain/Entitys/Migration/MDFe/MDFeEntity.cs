...
_erroMensagem = new List<string>();
   ...
   if (Serie == null)
   this._erroMensagem.Add("Serie deve ser informado.");
   if (Numero == null)
   this._erroMensagem.Add("Numero deve ser informado.");
   ...
   if (Situacao == null)
   this._erroMensagem.Add("Situacao do MDF-e deve ser informado.");
