...
{
    public class SourceCodeInfraestructureWriteConcreteRepositoryCuston : SourceCodeBase
    {
        private readonly Entity _entity;

        public SourceCodeInfraestructureWriteConcreteRepositoryCuston(string filePath, Entity entity, bool isCuston)
