...
{
    public class SourceCodeAplicationRepositoryInterfacesWriteCuston : SourceCodeBase
    {
        private readonly Entity _entity;

        public SourceCodeAplicationRepositoryInterfacesWriteCuston(string filePath, Entity entity, bool isCuston)
