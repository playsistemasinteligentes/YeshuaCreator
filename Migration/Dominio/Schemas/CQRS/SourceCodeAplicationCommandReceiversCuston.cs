...
{
    public class SourceCodeAplicationCommandReceiversCuston : SourceCodeBase
    {
        private readonly Entity _entity;

        public SourceCodeAplicationCommandReceiversCuston(string filePath, Entity entity, bool isCuston)
