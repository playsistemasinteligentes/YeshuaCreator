...
{
    public class SourceCodeAplicationCommandCommandsCuston : SourceCodeBase
    {
        private readonly Entity _entity;

        public SourceCodeAplicationCommandCommandsCuston(string filePath, Entity entity, bool isCuston)
        ...
        protected override string GenerateCode()
        {
            ...
            foreach (var column in _entity.AddColumns)
            {
                ...
                if (string.IsNullOrWhiteSpace(column.Type) || string.IsNullOrWhiteSpace(column.Name))
