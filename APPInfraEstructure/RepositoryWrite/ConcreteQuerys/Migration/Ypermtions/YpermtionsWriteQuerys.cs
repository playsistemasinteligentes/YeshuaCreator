...
namespace Query.Write
{
    public class YpermtionsQueryWrite : QueryBase, IYpermtionsQueryWrite
    {
        ...
        {
            this.Query = $@" INSERT INTO Ypermtions (Id, Description, TenantID, Deleted, Changed, UserId) OUTPUT INSERTED.ID VALUES(@Id, @Description, @TenantID, @Deleted, @Changed, @UserId) ";
            this.Parameters = new
            {
                Id = Ypermtions.Id,
