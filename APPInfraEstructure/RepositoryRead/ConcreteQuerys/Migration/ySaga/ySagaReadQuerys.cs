...
namespace Query.Read 
{
    public class ySagaQueryRead : QueryBase, IySagaQueryRead
    {
        ...
        public ySagaQueryRead(ICurrentUser currentUser)
        {
        ...
        public QueryModel ySagaQuery(Command.Read.ySagaReadCommand Command , bool TakeOffTenantID = false)
        {
            ...
            this.Query = $@" select Id, SagaId, Type, Status, KeyCurrentStep, CreatedAt, CompletedAt, EntityType, EntityId, TenantID, Deleted, Changed, UserId from ySaga ";
