...
namespace Query.Read 
{
    public class yInboxQueryRead : QueryBase, IyInboxQueryRead
    {
        ...
        public QueryModel yInboxQuery(Command.Read.yInboxReadCommand Command , bool TakeOffTenantID = false)
        {
            ...
            this.Query = $@" select Id, MessageId, Type, EntityType, EntityId, Payload, Status, CreatedAt, ProcessedAt, RetryCount, LastError, SagaId, SagaStepId, TenantID, Deleted, Changed, UserId from yInbox ";
...
if (Command.UserId.HasValue) whereClauses.Add($"UserId = @UserId");
        ...
        public QueryModel yInboxSagaIdQuery(Command.Patterns.Command.SearchFKCommand Command , bool TakeOffTenantID = false)
        {
 ...
 whereClauses.Add($"Deleted = @Deleted");
        ...
        public QueryModel yInboxSagaStepIdQuery(Command.Patterns.Command.SearchFKCommand Command , bool TakeOffTenantID = false)
        {
...
if (!TakeOffTenantID)  whereClauses.Add($"TenantID = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ProcessedAt"] = value; //04
                      whereClauses.Add($" ProcessedAt = @ProcessedAt ");//04
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
...
if (!TakeOffTenantID)  whereClauses.Add($"TenantID = @TenantID");
 dict["Deleted"] = 0;
 whereClauses.Add($"Deleted = @Deleted");
                      dict["ProcessedAt"] = value; //06
                      whereClauses.Add($" ProcessedAt = @ProcessedAt ");//06
            if (whereClauses.Any()) 
            this.Query += $" WHERE ({string.Join(" AND ", whereClauses)})"; 
            this.Parameters = parameters;
            return new QueryModel(this.Query, parameters);
