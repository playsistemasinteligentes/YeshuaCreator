...
{
    public class YperfilPermissionActionsQueryRead : QueryBase, IYperfilPermissionActionsQueryRead
    {
        protected readonly ICurrentUser _correntUser;
        public YperfilPermissionActionsQueryRead(ICurrentUser correntUser)
        {
        ...
        public QueryModel YperfilPermissionActionsQuery(Command.Read.YperfilPermissionActionsReadCommand Command)
        {
            ...
            this.Query = $@" select PerfilId, permissionActionsId, Grant, Create, Read, Update, Delete, ValidUntil, TenantID, Deleted, Changed, UserId from YperfilPermissionActions ";
...
if (!string.IsNullOrEmpty(Command.permissionActionsId)) whereClauses.Add($"permissionActionsId like @permissionActionsId");
        ...
        {
            var sql = $"SELECT 1 FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")} PerfilId = @PerfilId";
            var parameters = new { PerfilId = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel ExistsBypermissionActionsIdQuery(string value)
        {
            var sql = $"SELECT 1 FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")} permissionActionsId = @permissionActionsId";
            var parameters = new { permissionActionsId = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel ExistsByGrantQuery(bool value)
        {
            var sql = $"SELECT 1 FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")} Grant = @Grant";
            var parameters = new { Grant = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel ExistsByCreateQuery(bool value)
        {
            var sql = $"SELECT 1 FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")} Create = @Create";
            var parameters = new { Create = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel ExistsByReadQuery(bool value)
        {
            var sql = $"SELECT 1 FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")} Read = @Read";
            var parameters = new { Read = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel ExistsByUpdateQuery(bool value)
        {
            var sql = $"SELECT 1 FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")} Update = @Update";
            var parameters = new { Update = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel ExistsByDeleteQuery(bool value)
        {
            var sql = $"SELECT 1 FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")} Delete = @Delete";
            var parameters = new { Delete = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel ExistsByValidUntilQuery(DateTime value)
        {
            var sql = $"SELECT 1 FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")} ValidUntil = @ValidUntil";
            var parameters = new { ValidUntil = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel ExistsByChangedQuery(DateTime value)
        {
            var sql = $"SELECT 1 FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")} Changed = @Changed";
            var parameters = new { Changed = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel ExistsByUserIdQuery(int value)
        {
            var sql = $"SELECT 1 FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")} UserId = @UserId";
            var parameters = new { UserId = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel FirstByPerfilIdQuery(int value)
        {
            var sql = $"SELECT * FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")}  PerfilId = @PerfilId";
            var parameters = new { PerfilId = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel FirstBypermissionActionsIdQuery(string value)
        {
            var sql = $"SELECT * FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")}  permissionActionsId = @permissionActionsId";
            var parameters = new { permissionActionsId = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel FirstByGrantQuery(bool value)
        {
            var sql = $"SELECT * FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")}  Grant = @Grant";
            var parameters = new { Grant = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel FirstByCreateQuery(bool value)
        {
            var sql = $"SELECT * FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")}  Create = @Create";
            var parameters = new { Create = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel FirstByReadQuery(bool value)
        {
            var sql = $"SELECT * FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")}  Read = @Read";
            var parameters = new { Read = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel FirstByUpdateQuery(bool value)
        {
            var sql = $"SELECT * FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")}  Update = @Update";
            var parameters = new { Update = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel FirstByDeleteQuery(bool value)
        {
            var sql = $"SELECT * FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")}  Delete = @Delete";
            var parameters = new { Delete = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel FirstByValidUntilQuery(DateTime value)
        {
            var sql = $"SELECT * FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")}  ValidUntil = @ValidUntil";
            var parameters = new { ValidUntil = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel FirstByChangedQuery(DateTime value)
        {
            var sql = $"SELECT * FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")}  Changed = @Changed";
            var parameters = new { Changed = value };
            return new QueryModel(sql, parameters);
        }
        public QueryModel FirstByUserIdQuery(int value)
        {
            var sql = $"SELECT * FROM YperfilPermissionActions WHERE {getBackEndFieldWitchWhere(" AND ")}  UserId = @UserId";
            var parameters = new { UserId = value };
            return new QueryModel(sql, parameters);
        }
