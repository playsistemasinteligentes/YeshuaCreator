...
searchFields = new[]
{
 ...
 new { id = "changed", label = "Changed", type = "DateTime", isFk = false ,endPontGetMetadata="", fksDisplayFields =  new string[]{}, options = new[] { new { value = 0, display = "" }}
 },
...
formFields = new[]
{
 ...
 new { id = "changed", label = "Changed", type = "DateTime", required = "False" , isFk = false,endPontGetMetadata="", fksDisplayFields =  new string[]{}, options = new[] { new { value = 0, display = "" }}
  },
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 tenantid = "/Especialidade/EspecialidadeReadFKTenantID",
                 userid = "/Especialidade/EspecialidadeReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 ...
                 tenantid = "/Profissional/ProfissionalReadFKTenantID",
                 userid = "/Profissional/ProfissionalReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 ...
                 tenantid = "/DisponibilidadeAgenda/DisponibilidadeAgendaReadFKTenantID",
                 userid = "/DisponibilidadeAgenda/DisponibilidadeAgendaReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 tenantid = "/GrupoServico/GrupoServicoReadFKTenantID",
                 userid = "/GrupoServico/GrupoServicoReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 ...
                 tenantid = "/Servico/ServicoReadFKTenantID",
                 userid = "/Servico/ServicoReadFKUserId",
...
new {value = 3,display = "Outros"},
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 tenantid = "/Paciente/PacienteReadFKTenantID",
                 userid = "/Paciente/PacienteReadFKUserId",
...
new {value = 2,display = "Pagamento"},
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 ...
                 tenantid = "/MovimentacaoFinanceira/MovimentacaoFinanceiraReadFKTenantID",
                 userid = "/MovimentacaoFinanceira/MovimentacaoFinanceiraReadFKUserId",
...
new {value = 4,display = "Eventos novos"},
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 ...
                 tenantid = "/Sesoes/SesoesReadFKTenantID",
                 userid = "/Sesoes/SesoesReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 tenantid = "/Clinica/ClinicaReadFKTenantID",
                 userid = "/Clinica/ClinicaReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 ...
                 userid = "/yConfigArcteture/yConfigArctetureReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 ...
                 userid = "/yConfigNotification/yConfigNotificationReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 tenantid = "/yPerfil/yPerfilReadFKTenantID",
                 userid = "/yPerfil/yPerfilReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "moduleid", label = "ID Modulo", type = "string", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayModule", fksDisplayFields =  new string[]{  }, options = new[] { new { value = 0, display = "" }}
  },
 new { id = "tenantid", label = "TenantID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayTenant", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
  },
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 ...
                 userid = "/yTenantModule/yTenantModuleReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "changed", label = "Changed", type = "DateTime", required = "False" , isFk = false,endPontGetMetadata="", fksDisplayFields =  new string[]{}, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 ...
                 tenantid = "/yUserModule/yUserModuleReadFKTenantID",
...
formFields = new[]
{
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 tenantid = "/yGrant/yGrantReadFKTenantID",
                 userid = "/yGrant/yGrantReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "grantid", label = "ID Permição", type = "string", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayGrant", fksDisplayFields =  new string[]{  }, options = new[] { new { value = 0, display = "" }}
  },
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 ...
                 tenantid = "/yPerfilGrant/yPerfilGrantReadFKTenantID",
                 userid = "/yPerfilGrant/yPerfilGrantReadFKUserId",
...
formFields = new[]
{
 ...
 new { id = "userid", label = "User ID", type = "int", required = "False" , isFk = true,endPontGetMetadata="/getMetaDatayUser", fksDisplayFields =  new string[]{ "nome" }, options = new[] { new { value = 0, display = "" }}
             ...
             endpoints = new
             {
                 ...
                 tenantid = "/yUserGrant/yUserGrantReadFKTenantID",
                 userid = "/yUserGrant/yUserGrantReadFKUserId",
