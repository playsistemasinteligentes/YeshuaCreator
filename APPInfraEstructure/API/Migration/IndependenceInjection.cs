namespace API.Migrations
{
    public static class IndependenceInjection
    {
        public static void MapIndependenceInjection(WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddTransient<Comandos.Receivers.Clinica.UpdateClinicaReceiver>();
            builder.Services.AddTransient<Comandos.Receivers.Clinica.DeleteClinicaReceiver>();
        }
    }
}
