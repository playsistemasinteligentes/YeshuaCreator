...
builder.Services.AddTransient<Read.Repository.YconfigArctetureReadRepository>();
    ...
    return new Read.Repository.YconfigArctetureReadRepositoryCacheDecorator(inner,cacheById,cacheAll    );
});
...
builder.Services.AddTransient<IRepository.Write.IYpermissionModulesWriteRepository, Input.Repository.YpermissionModules.YpermissionModulesWriteRepository>();
builder.Services.AddTransient<IRepository.Read.IYpermissionModulesReadRepository, Read.Repository.YpermissionModulesReadRepository>();
builder.Services.AddTransient<IQuery.Read.IYpermissionModulesQueryRead, Query.Read.YpermissionModulesQueryRead>();
builder.Services.AddTransient<IQuery.Write.IYpermissionModulesQueryWrite, Query.Write.YpermissionModulesQueryWrite>();
builder.Services.AddTransient<Command.Receivers.Write.InsertYpermissionModulesReceiver>();
builder.Services.AddTransient<Command.Receivers.Write.UpdateYpermissionModulesReceiver>();
builder.Services.AddTransient<Command.Receivers.Write.DeleteYpermissionModulesReceiver>();
builder.Services.AddTransient<Command.Receivers.Read.YpermissionModulesReadReceiver>();

builder.Services.AddTransient<IRepository.Write.IYtenantPermissionMudulesWriteRepository, Input.Repository.YtenantPermissionMudules.YtenantPermissionMudulesWriteRepository>();
builder.Services.AddTransient<IRepository.Read.IYtenantPermissionMudulesReadRepository, Read.Repository.YtenantPermissionMudulesReadRepository>();
builder.Services.AddTransient<IQuery.Read.IYtenantPermissionMudulesQueryRead, Query.Read.YtenantPermissionMudulesQueryRead>();
builder.Services.AddTransient<IQuery.Write.IYtenantPermissionMudulesQueryWrite, Query.Write.YtenantPermissionMudulesQueryWrite>();
builder.Services.AddTransient<Command.Receivers.Write.InsertYtenantPermissionMudulesReceiver>();
builder.Services.AddTransient<Command.Receivers.Write.UpdateYtenantPermissionMudulesReceiver>();
builder.Services.AddTransient<Command.Receivers.Write.DeleteYtenantPermissionMudulesReceiver>();
builder.Services.AddTransient<Command.Receivers.Read.YtenantPermissionMudulesReadReceiver>();
builder.Services.AddTransient<Command.Receivers.Read.YtenantPermissionMudulesReadFKpermissionModulesIdReceiver>();
builder.Services.AddTransient<Command.Receivers.Read.YtenantPermissionMudulesReadFKTenantIDReceiver>();

builder.Services.AddTransient<IRepository.Write.IYpermissionActionsWriteRepository, Input.Repository.YpermissionActions.YpermissionActionsWriteRepository>();
builder.Services.AddTransient<IRepository.Read.IYpermissionActionsReadRepository, Read.Repository.YpermissionActionsReadRepository>();
builder.Services.AddTransient<IQuery.Read.IYpermissionActionsQueryRead, Query.Read.YpermissionActionsQueryRead>();
builder.Services.AddTransient<IQuery.Write.IYpermissionActionsQueryWrite, Query.Write.YpermissionActionsQueryWrite>();
builder.Services.AddTransient<Command.Receivers.Write.InsertYpermissionActionsReceiver>();
builder.Services.AddTransient<Command.Receivers.Write.UpdateYpermissionActionsReceiver>();
builder.Services.AddTransient<Command.Receivers.Write.DeleteYpermissionActionsReceiver>();
builder.Services.AddTransient<Command.Receivers.Read.YpermissionActionsReadReceiver>();

builder.Services.AddTransient<IRepository.Write.IYperfilPermissionActionsWriteRepository, Input.Repository.YperfilPermissionActions.YperfilPermissionActionsWriteRepository>();
builder.Services.AddTransient<IRepository.Read.IYperfilPermissionActionsReadRepository, Read.Repository.YperfilPermissionActionsReadRepository>();
builder.Services.AddTransient<IQuery.Read.IYperfilPermissionActionsQueryRead, Query.Read.YperfilPermissionActionsQueryRead>();
builder.Services.AddTransient<IQuery.Write.IYperfilPermissionActionsQueryWrite, Query.Write.YperfilPermissionActionsQueryWrite>();
builder.Services.AddTransient<Command.Receivers.Write.InsertYperfilPermissionActionsReceiver>();
builder.Services.AddTransient<Command.Receivers.Write.UpdateYperfilPermissionActionsReceiver>();
builder.Services.AddTransient<Command.Receivers.Write.DeleteYperfilPermissionActionsReceiver>();
builder.Services.AddTransient<Command.Receivers.Read.YperfilPermissionActionsReadReceiver>();
builder.Services.AddTransient<Command.Receivers.Read.YperfilPermissionActionsReadFKPerfilIdReceiver>();
builder.Services.AddTransient<Command.Receivers.Read.YperfilPermissionActionsReadFKpermissionActionsIdReceiver>();

builder.Services.AddTransient<IRepository.Write.IYuserPermissionActionsWriteRepository, Input.Repository.YuserPermissionActions.YuserPermissionActionsWriteRepository>();
builder.Services.AddTransient<IRepository.Read.IYuserPermissionActionsReadRepository, Read.Repository.YuserPermissionActionsReadRepository>();
builder.Services.AddTransient<IQuery.Read.IYuserPermissionActionsQueryRead, Query.Read.YuserPermissionActionsQueryRead>();
builder.Services.AddTransient<IQuery.Write.IYuserPermissionActionsQueryWrite, Query.Write.YuserPermissionActionsQueryWrite>();
builder.Services.AddTransient<Command.Receivers.Write.InsertYuserPermissionActionsReceiver>();
builder.Services.AddTransient<Command.Receivers.Write.UpdateYuserPermissionActionsReceiver>();
builder.Services.AddTransient<Command.Receivers.Write.DeleteYuserPermissionActionsReceiver>();
builder.Services.AddTransient<Command.Receivers.Read.YuserPermissionActionsReadReceiver>();
builder.Services.AddTransient<Command.Receivers.Read.YuserPermissionActionsReadFKPerfilIdReceiver>();
builder.Services.AddTransient<Command.Receivers.Read.YuserPermissionActionsReadFKpermissionActionsIdReceiver>();
