...
{
    public class SourceCodeInfraestructureWriteQuerysCuston : SourceCodeBase
    {
        private readonly Entity _entity;

        public SourceCodeInfraestructureWriteQuerysCuston(string filePath, Entity entity, bool isCuston)
