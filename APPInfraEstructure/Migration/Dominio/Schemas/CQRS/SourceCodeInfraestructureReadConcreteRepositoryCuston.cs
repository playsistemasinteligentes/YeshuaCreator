...
{
    public class SourceCodeInfraestructureReadConcreteRepositoryCuston : SourceCodeBase
    {
        private readonly Entity _entity;

        public SourceCodeInfraestructureReadConcreteRepositoryCuston(string filePath, Entity entity, bool isCuston)
