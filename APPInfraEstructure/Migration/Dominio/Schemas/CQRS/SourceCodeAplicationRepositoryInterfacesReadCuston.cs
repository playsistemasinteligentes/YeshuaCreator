...
{
    public class SourceCodeAplicationRepositoryInterfacesReadCuston : SourceCodeBase
    {
        private readonly Entity _entity;

        public SourceCodeAplicationRepositoryInterfacesReadCuston(string filePath, Entity entity, bool isCuston)
